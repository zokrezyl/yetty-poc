...
class YWasm : public Card, public base::ObjectFactory<YWasm> {
public:
    using Ptr = std::shared_ptr<YWasm>;
    static constexpr uint32_t SHADER_GLYPH = 0x100003;  // Use ydraw shader
...
protected:
    YWasm(GpuMemoryManager::Ptr mgr, const GPUContext& gpu,
