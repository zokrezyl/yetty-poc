...
//=============================================================================
// ThorVG - Vector graphics card using ThorVG for SVG/Lottie parsing
//
// Thin wrapper around yetty::thorvg::ThorVgRenderer. The renderer converts
// vector content to YDraw SDF primitives; this card handles lifecycle.
//=============================================================================
class ThorVG : public Card,
               public base::ObjectFactory<ThorVG> {
public:
...
protected:
    ThorVG(GpuMemoryManager::Ptr mgr, const GPUContext& gpu,
