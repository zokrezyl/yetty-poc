...
private:
    ...
    Result<void> initShaderFonts() noexcept {
        ...
        auto shaderGlyphResult = ShaderFont::create(_shaderMgr, ShaderFont::Category::Glyph, shaderDir);
        ...
        auto cardFontResult = ShaderFont::create(_shaderMgr, ShaderFont::Category::Card, shaderDir);
        if (!cardFontResult) {
