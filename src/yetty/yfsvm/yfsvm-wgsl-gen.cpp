...
//
// Generates GPU interpreter from the same opcode definitions as C++.
// Single source of truth - add opcodes in yfsvm.h, they work everywhere.
...
std::string generateWGSL() {
    ...
    // Header
    out << R"(// yfsvm - GPU Bytecode Interpreter
...
// Bytecode is stored in cardStorage buffer, constants inline in the program.
    ...
    out << "// Constants\n";
    out << "const YFSVM_MAGIC: u32 = 0x" << std::hex << YFSVM_MAGIC << std::dec << "u;\n";
    out << "const YFSVM_VERSION: u32 = " << YFSVM_VERSION << "u;\n";
    out << "const YFSVM_MAX_REGISTERS: u32 = " << YFSVM_MAX_REGISTERS << "u;\n";
    out << "const YFSVM_MAX_FUNCTIONS: u32 = " << YFSVM_MAX_FUNCTIONS << "u;\n";
    out << "\n";

    // Opcode constants (generated from enum)
    out << "// Opcodes\n";
    out << "const OP_NOP: u32 = 0x" << std::hex << static_cast<int>(Opcode::NOP) << std::dec << "u;\n";
    out << "const OP_RET: u32 = 0x" << std::hex << static_cast<int>(Opcode::RET) << std::dec << "u;\n";
    out << "const OP_LOAD_C: u32 = 0x" << std::hex << static_cast<int>(Opcode::LOAD_C) << std::dec << "u;\n";
    out << "const OP_LOAD_X: u32 = 0x" << std::hex << static_cast<int>(Opcode::LOAD_X) << std::dec << "u;\n";
    out << "const OP_LOAD_T: u32 = 0x" << std::hex << static_cast<int>(Opcode::LOAD_T) << std::dec << "u;\n";
    out << "const OP_LOAD_S: u32 = 0x" << std::hex << static_cast<int>(Opcode::LOAD_S) << std::dec << "u;\n";
    out << "const OP_MOV: u32 = 0x" << std::hex << static_cast<int>(Opcode::MOV) << std::dec << "u;\n";
    out << "const OP_ADD: u32 = 0x" << std::hex << static_cast<int>(Opcode::ADD) << std::dec << "u;\n";
    out << "const OP_SUB: u32 = 0x" << std::hex << static_cast<int>(Opcode::SUB) << std::dec << "u;\n";
    out << "const OP_MUL: u32 = 0x" << std::hex << static_cast<int>(Opcode::MUL) << std::dec << "u;\n";
    out << "const OP_DIV: u32 = 0x" << std::hex << static_cast<int>(Opcode::DIV) << std::dec << "u;\n";
    out << "const OP_NEG: u32 = 0x" << std::hex << static_cast<int>(Opcode::NEG) << std::dec << "u;\n";
    out << "const OP_MOD: u32 = 0x" << std::hex << static_cast<int>(Opcode::MOD) << std::dec << "u;\n";
    out << "const OP_SIN: u32 = 0x" << std::hex << static_cast<int>(Opcode::SIN) << std::dec << "u;\n";
    out << "const OP_COS: u32 = 0x" << std::hex << static_cast<int>(Opcode::COS) << std::dec << "u;\n";
    out << "const OP_TAN: u32 = 0x" << std::hex << static_cast<int>(Opcode::TAN) << std::dec << "u;\n";
    out << "const OP_ASIN: u32 = 0x" << std::hex << static_cast<int>(Opcode::ASIN) << std::dec << "u;\n";
    out << "const OP_ACOS: u32 = 0x" << std::hex << static_cast<int>(Opcode::ACOS) << std::dec << "u;\n";
    out << "const OP_ATAN: u32 = 0x" << std::hex << static_cast<int>(Opcode::ATAN) << std::dec << "u;\n";
    out << "const OP_ATAN2: u32 = 0x" << std::hex << static_cast<int>(Opcode::ATAN2) << std::dec << "u;\n";
    out << "const OP_SINH: u32 = 0x" << std::hex << static_cast<int>(Opcode::SINH) << std::dec << "u;\n";
    out << "const OP_COSH: u32 = 0x" << std::hex << static_cast<int>(Opcode::COSH) << std::dec << "u;\n";
    out << "const OP_TANH: u32 = 0x" << std::hex << static_cast<int>(Opcode::TANH) << std::dec << "u;\n";
    out << "const OP_EXP: u32 = 0x" << std::hex << static_cast<int>(Opcode::EXP) << std::dec << "u;\n";
    out << "const OP_EXP2: u32 = 0x" << std::hex << static_cast<int>(Opcode::EXP2) << std::dec << "u;\n";
    out << "const OP_LOG: u32 = 0x" << std::hex << static_cast<int>(Opcode::LOG) << std::dec << "u;\n";
    out << "const OP_LOG2: u32 = 0x" << std::hex << static_cast<int>(Opcode::LOG2) << std::dec << "u;\n";
    out << "const OP_POW: u32 = 0x" << std::hex << static_cast<int>(Opcode::POW) << std::dec << "u;\n";
    out << "const OP_SQRT: u32 = 0x" << std::hex << static_cast<int>(Opcode::SQRT) << std::dec << "u;\n";
    out << "const OP_RSQRT: u32 = 0x" << std::hex << static_cast<int>(Opcode::RSQRT) << std::dec << "u;\n";
    out << "const OP_ABS: u32 = 0x" << std::hex << static_cast<int>(Opcode::ABS) << std::dec << "u;\n";
    out << "const OP_MIN: u32 = 0x" << std::hex << static_cast<int>(Opcode::MIN) << std::dec << "u;\n";
    out << "const OP_MAX: u32 = 0x" << std::hex << static_cast<int>(Opcode::MAX) << std::dec << "u;\n";
    out << "const OP_FLOOR: u32 = 0x" << std::hex << static_cast<int>(Opcode::FLOOR) << std::dec << "u;\n";
    out << "const OP_CEIL: u32 = 0x" << std::hex << static_cast<int>(Opcode::CEIL) << std::dec << "u;\n";
    out << "const OP_ROUND: u32 = 0x" << std::hex << static_cast<int>(Opcode::ROUND) << std::dec << "u;\n";
    out << "const OP_FRACT: u32 = 0x" << std::hex << static_cast<int>(Opcode::FRACT) << std::dec << "u;\n";
    out << "const OP_SIGN: u32 = 0x" << std::hex << static_cast<int>(Opcode::SIGN) << std::dec << "u;\n";
    out << "const OP_CLAMP01: u32 = 0x" << std::hex << static_cast<int>(Opcode::CLAMP01) << std::dec << "u;\n";
    out << "const OP_STEP: u32 = 0x" << std::hex << static_cast<int>(Opcode::STEP) << std::dec << "u;\n";
    out << "const OP_MIX: u32 = 0x" << std::hex << static_cast<int>(Opcode::MIX) << std::dec << "u;\n";
    out << "\n";

    // Instruction decode helpers
    out << R"(// Instruction decoding (matches C++ Instruction struct)
...
fn yfsvm_decode_imm12(instr: u32) -> u32 { return instr & 0xFFFu; }
    ...
    // Register file access (using array)
    out << R"(// Register read/write helpers
...
fn yfsvm_write_reg(regs: ptr<function, array<f32, 16>>, idx: u32, val: f32) {
    ...
    out << R"(// Execute yfsvm bytecode for a single function
...
fn yfsvm_execute(bytecodeOffset: u32, funcIndex: u32, x: f32, t: f32, samplers: array<f32, 8>) -> f32 {
    ...
    // Generate the switch statement for opcodes
    out << R"(        switch op {
            case OP_NOP: {}
