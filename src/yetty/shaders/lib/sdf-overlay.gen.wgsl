...
fn evalSDF_overlay(primOffset: u32, p: vec2<f32>) -> f32 {
    ...
    let gridOffsetPacked = bitcast<u32>(overlayStorage[primOffset + 0u]);
    ...
    let primType = bitcast<u32>(overlayStorage[primOffset + 1u]);
...
fn evalSDF_scrolling(primOffset: u32, p: vec2<f32>) -> f32 {
    ...
    let primType = bitcast<u32>(scrollingStorage[primOffset + 1u]);
