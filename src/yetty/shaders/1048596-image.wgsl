// Shader glyph: Image widget (codepoint 1048596 / U+100014)
...
fn shaderGlyph_1048596(localUV: vec2<f32>, time: f32, fg: u32, bg: u32, pixelPos: vec2<f32>, mousePos: vec2<f32>) -> vec3<f32> {
    // ==========================================================================
