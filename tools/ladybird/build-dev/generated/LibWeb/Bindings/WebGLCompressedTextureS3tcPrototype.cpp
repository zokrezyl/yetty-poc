...
GC_DEFINE_ALLOCATOR(WebGLCompressedTextureS3tcPrototype);

WebGLCompressedTextureS3tcPrototype::WebGLCompressedTextureS3tcPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

WebGLCompressedTextureS3tcPrototype::~WebGLCompressedTextureS3tcPrototype()
{
}

void WebGLCompressedTextureS3tcPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "WebGLCompressedTextureS3tc"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void WebGLCompressedTextureS3tcPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
