...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/CSS/CSSMarginRule.h>
...
GC_DEFINE_ALLOCATOR(CSSMarginRulePrototype);

CSSMarginRulePrototype::CSSMarginRulePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CSSMarginRulePrototype::~CSSMarginRulePrototype()
{
}

void CSSMarginRulePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSMarginRule"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSMarginRulePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSMarginRule*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSMarginRule>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSMarginRule");
    return static_cast<CSS::CSSMarginRule*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSMarginRulePrototype::name_getter)
{
    WebIDL::log_trace(vm, "CSSMarginRulePrototype::name_getter");
...
JS_DEFINE_NATIVE_FUNCTION(CSSMarginRulePrototype::style_getter)
{
    WebIDL::log_trace(vm, "CSSMarginRulePrototype::style_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(CSSMarginRulePrototype::style_setter)
{
    WebIDL::log_trace(vm, "CSSMarginRulePrototype::style_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
