...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGCircleElement.h>
...
GC_DEFINE_ALLOCATOR(SVGCircleElementPrototype);

SVGCircleElementPrototype::SVGCircleElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void SVGCircleElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGCircleElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGCircleElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGCircleElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGCircleElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGCircleElement");
    return static_cast<SVG::SVGCircleElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGCircleElementPrototype::cx_getter)
{
    WebIDL::log_trace(vm, "SVGCircleElementPrototype::cx_getter");
...
{
    WebIDL::log_trace(vm, "SVGCircleElementPrototype::cy_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "SVGCircleElementPrototype::r_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
