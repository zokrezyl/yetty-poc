...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGFEGaussianBlurElement.h>
...
GC_DEFINE_ALLOCATOR(SVGFEGaussianBlurElementPrototype);

SVGFEGaussianBlurElementPrototype::SVGFEGaussianBlurElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGFEGaussianBlurElementPrototype::~SVGFEGaussianBlurElementPrototype()
{
}

void SVGFEGaussianBlurElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_edge_mode_getter = JS::NativeFunction::create(realm, edge_mode_getter, 0, "edgeMode"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_edge_mode_setter;

    define_direct_accessor("edgeMode"_utf16_fly_string, native_edge_mode_getter, native_edge_mode_setter, default_attributes);
    ...
    define_direct_accessor("result"_utf16_fly_string, native_result_getter, native_result_setter, default_attributes);
        ...
        define_direct_property("setStdDeviation"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    auto constant_SVG_EDGEMODE_UNKNOWN_value = JS::Value(static_cast<WebIDL::UnsignedShort>(0));

    define_direct_property("SVG_EDGEMODE_UNKNOWN"_utf16_fly_string, constant_SVG_EDGEMODE_UNKNOWN_value, JS::Attribute::Enumerable);

    auto constant_SVG_EDGEMODE_DUPLICATE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(1));

    define_direct_property("SVG_EDGEMODE_DUPLICATE"_utf16_fly_string, constant_SVG_EDGEMODE_DUPLICATE_value, JS::Attribute::Enumerable);

    auto constant_SVG_EDGEMODE_WRAP_value = JS::Value(static_cast<WebIDL::UnsignedShort>(2));

    define_direct_property("SVG_EDGEMODE_WRAP"_utf16_fly_string, constant_SVG_EDGEMODE_WRAP_value, JS::Attribute::Enumerable);

    auto constant_SVG_EDGEMODE_NONE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(3));

    define_direct_property("SVG_EDGEMODE_NONE"_utf16_fly_string, constant_SVG_EDGEMODE_NONE_value, JS::Attribute::Enumerable);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGFEGaussianBlurElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGFEGaussianBlurElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGFEGaussianBlurElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGFEGaussianBlurElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGFEGaussianBlurElement");
    return static_cast<SVG::SVGFEGaussianBlurElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGFEGaussianBlurElementPrototype::in1_getter)
{
    WebIDL::log_trace(vm, "SVGFEGaussianBlurElementPrototype::in1_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEGaussianBlurElementPrototype::std_deviation_x_getter)
{
    WebIDL::log_trace(vm, "SVGFEGaussianBlurElementPrototype::std_deviation_x_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEGaussianBlurElementPrototype::std_deviation_y_getter)
{
    WebIDL::log_trace(vm, "SVGFEGaussianBlurElementPrototype::std_deviation_y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEGaussianBlurElementPrototype::edge_mode_getter)
{
    WebIDL::log_trace(vm, "SVGFEGaussianBlurElementPrototype::edge_mode_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->edge_mode(); }));

    return &const_cast<SVGAnimatedEnumeration&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(SVGFEGaussianBlurElementPrototype::x_getter)
{
    WebIDL::log_trace(vm, "SVGFEGaussianBlurElementPrototype::x_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEGaussianBlurElementPrototype::y_getter)
{
    WebIDL::log_trace(vm, "SVGFEGaussianBlurElementPrototype::y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEGaussianBlurElementPrototype::width_getter)
{
    WebIDL::log_trace(vm, "SVGFEGaussianBlurElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEGaussianBlurElementPrototype::height_getter)
{
    WebIDL::log_trace(vm, "SVGFEGaussianBlurElementPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEGaussianBlurElementPrototype::result_getter)
{
    WebIDL::log_trace(vm, "SVGFEGaussianBlurElementPrototype::result_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
