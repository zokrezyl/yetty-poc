...
class SVGElementPrototype : public JS::Object {
    ...
    GC_DECLARE_ALLOCATOR(SVGElementPrototype);
public:
    static void define_unforgeable_attributes(JS::Realm&, JS::Object&);

    explicit SVGElementPrototype(JS::Realm&);
...
private:
    ...
    JS_DECLARE_NATIVE_FUNCTION(owner_svg_element_getter);

    JS_DECLARE_NATIVE_FUNCTION(viewport_element_getter);
