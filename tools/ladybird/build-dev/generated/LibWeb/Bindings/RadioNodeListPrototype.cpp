...
#if __has_include(<LibWeb/Bindings/NodeListPrototype.h>)
...
GC_DEFINE_ALLOCATOR(RadioNodeListPrototype);

RadioNodeListPrototype::RadioNodeListPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

RadioNodeListPrototype::~RadioNodeListPrototype()
{
}

void RadioNodeListPrototype::initialize(JS::Realm& realm)
{
    ...
    set_prototype(&ensure_web_prototype<NodeListPrototype>(realm, "NodeList"_fly_string));
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "RadioNodeList"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void RadioNodeListPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::RadioNodeList*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::RadioNodeList>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "RadioNodeList");
    return static_cast<HTML::RadioNodeList*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(RadioNodeListPrototype::value_getter)
{
    WebIDL::log_trace(vm, "RadioNodeListPrototype::value_getter");
...
JS_DEFINE_NATIVE_FUNCTION(RadioNodeListPrototype::value_setter)
{
    WebIDL::log_trace(vm, "RadioNodeListPrototype::value_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
