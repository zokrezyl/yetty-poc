...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLUnknownElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLUnknownElementConstructor);

HTMLUnknownElementConstructor::HTMLUnknownElementConstructor(JS::Realm& realm)
    : NativeFunction("HTMLUnknownElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}
...
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "HTMLUnknownElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> HTMLUnknownElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "HTMLUnknownElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "HTMLUnknownElement");
}


void HTMLUnknownElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "HTMLUnknownElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<HTMLUnknownElementPrototype>(realm, "HTMLUnknownElement"_fly_string), 0);
