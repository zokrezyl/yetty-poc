...
GC_DEFINE_ALLOCATOR(HTMLHtmlElementPrototype);

HTMLHtmlElementPrototype::HTMLHtmlElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLHtmlElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_version_setter = JS::NativeFunction::create(realm, version_setter, 1, "version"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("version"_utf16_fly_string, native_version_getter, native_version_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLHtmlElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLHtmlElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLHtmlElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLHtmlElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLHtmlElement");
    return static_cast<HTML::HTMLHtmlElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLHtmlElementPrototype::version_getter)
{
    WebIDL::log_trace(vm, "HTMLHtmlElementPrototype::version_getter");
    ...
    auto contentAttributeValue = impl->attribute("version"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLHtmlElementPrototype::version_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("version"_fly_string, cpp_value);
