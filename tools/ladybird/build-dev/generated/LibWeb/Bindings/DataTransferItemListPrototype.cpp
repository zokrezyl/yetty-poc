...
GC_DEFINE_ALLOCATOR(DataTransferItemListPrototype);

DataTransferItemListPrototype::DataTransferItemListPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

DataTransferItemListPrototype::~DataTransferItemListPrototype()
{
}

void DataTransferItemListPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "DataTransferItemList"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void DataTransferItemListPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::DataTransferItemList*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::DataTransferItemList>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "DataTransferItemList");
    return static_cast<HTML::DataTransferItemList*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(DataTransferItemListPrototype::length_getter)
{
    WebIDL::log_trace(vm, "DataTransferItemListPrototype::length_getter");
...
JS_DEFINE_NATIVE_FUNCTION(DataTransferItemListPrototype::add0)
{
    WebIDL::log_trace(vm, "DataTransferItemListPrototype::add0");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->add(data, type); }));

    if (retval) {

    return &const_cast<DataTransferItem&>(*retval);
...
JS_DEFINE_NATIVE_FUNCTION(DataTransferItemListPrototype::add1)
{
    WebIDL::log_trace(vm, "DataTransferItemListPrototype::add1");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!arg0.is_object() || !is<File>(arg0.as_object()))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "File");

    auto& data = static_cast<File&>(arg0.as_object());

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->add(data); }));
...
JS_DEFINE_NATIVE_FUNCTION(DataTransferItemListPrototype::remove)
{
    WebIDL::log_trace(vm, "DataTransferItemListPrototype::remove");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->remove(index); }));

    return JS::js_undefined();

}

JS_DEFINE_NATIVE_FUNCTION(DataTransferItemListPrototype::clear)
{
    WebIDL::log_trace(vm, "DataTransferItemListPrototype::clear");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(DataTransferItemListPrototype::add)
{
    WebIDL::log_trace(vm, "DataTransferItemListPrototype::add");
