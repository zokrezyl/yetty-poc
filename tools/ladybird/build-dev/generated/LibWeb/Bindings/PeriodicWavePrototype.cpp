...
GC_DEFINE_ALLOCATOR(PeriodicWavePrototype);

PeriodicWavePrototype::PeriodicWavePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

PeriodicWavePrototype::~PeriodicWavePrototype()
{
}

void PeriodicWavePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "PeriodicWave"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void PeriodicWavePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
