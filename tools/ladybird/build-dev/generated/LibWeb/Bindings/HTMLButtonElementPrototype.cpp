...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLButtonElement.h>
...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/PopoverTargetAttributes.h>
...
GC_DEFINE_ALLOCATOR(HTMLButtonElementPrototype);

HTMLButtonElementPrototype::HTMLButtonElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLButtonElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_command_getter = JS::NativeFunction::create(realm, command_getter, 0, "command"_utf16_fly_string, &realm, "get"sv);

    auto native_command_setter = JS::NativeFunction::create(realm, command_setter, 1, "command"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("command"_utf16_fly_string, native_command_getter, native_command_setter, default_attributes);

    auto native_command_for_element_getter = JS::NativeFunction::create(realm, command_for_element_getter, 0, "commandForElement"_utf16_fly_string, &realm, "get"sv);

    auto native_command_for_element_setter = JS::NativeFunction::create(realm, command_for_element_setter, 1, "commandForElement"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("commandForElement"_utf16_fly_string, native_command_for_element_getter, native_command_for_element_setter, default_attributes);
    ...
    auto native_form_action_getter = JS::NativeFunction::create(realm, form_action_getter, 0, "formAction"_utf16_fly_string, &realm, "get"sv);

    auto native_form_action_setter = JS::NativeFunction::create(realm, form_action_setter, 1, "formAction"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("formAction"_utf16_fly_string, native_form_action_getter, native_form_action_setter, default_attributes);

    auto native_form_enctype_getter = JS::NativeFunction::create(realm, form_enctype_getter, 0, "formEnctype"_utf16_fly_string, &realm, "get"sv);

    auto native_form_enctype_setter = JS::NativeFunction::create(realm, form_enctype_setter, 1, "formEnctype"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("formEnctype"_utf16_fly_string, native_form_enctype_getter, native_form_enctype_setter, default_attributes);

    auto native_form_method_getter = JS::NativeFunction::create(realm, form_method_getter, 0, "formMethod"_utf16_fly_string, &realm, "get"sv);

    auto native_form_method_setter = JS::NativeFunction::create(realm, form_method_setter, 1, "formMethod"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("formMethod"_utf16_fly_string, native_form_method_getter, native_form_method_setter, default_attributes);

    auto native_form_no_validate_getter = JS::NativeFunction::create(realm, form_no_validate_getter, 0, "formNoValidate"_utf16_fly_string, &realm, "get"sv);

    auto native_form_no_validate_setter = JS::NativeFunction::create(realm, form_no_validate_setter, 1, "formNoValidate"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("formNoValidate"_utf16_fly_string, native_form_no_validate_getter, native_form_no_validate_setter, default_attributes);

    auto native_form_target_getter = JS::NativeFunction::create(realm, form_target_getter, 0, "formTarget"_utf16_fly_string, &realm, "get"sv);

    auto native_form_target_setter = JS::NativeFunction::create(realm, form_target_setter, 1, "formTarget"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("formTarget"_utf16_fly_string, native_form_target_getter, native_form_target_setter, default_attributes);
    ...
    auto native_popover_target_element_getter = JS::NativeFunction::create(realm, popover_target_element_getter, 0, "popoverTargetElement"_utf16_fly_string, &realm, "get"sv);

    auto native_popover_target_element_setter = JS::NativeFunction::create(realm, popover_target_element_setter, 1, "popoverTargetElement"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("popoverTargetElement"_utf16_fly_string, native_popover_target_element_getter, native_popover_target_element_setter, default_attributes);

    auto native_popover_target_action_getter = JS::NativeFunction::create(realm, popover_target_action_getter, 0, "popoverTargetAction"_utf16_fly_string, &realm, "get"sv);

    auto native_popover_target_action_setter = JS::NativeFunction::create(realm, popover_target_action_setter, 1, "popoverTargetAction"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("popoverTargetAction"_utf16_fly_string, native_popover_target_action_getter, native_popover_target_action_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLButtonElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLButtonElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLButtonElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLButtonElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLButtonElement");
    return static_cast<HTML::HTMLButtonElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::command_getter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::command_getter");
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->command(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::command_setter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::command_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_command(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::command_for_element_getter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::command_for_element_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    static auto content_attribute = "commandfor"_fly_string;

    auto retval = impl->get_the_attribute_associated_element(content_attribute, TRY(throw_dom_exception_if_needed(vm, [&] { return impl->command_for_element(); })));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::command_for_element_setter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::command_for_element_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_command_for_element(*cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::disabled_getter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::disabled_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::disabled_setter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::disabled_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::form_getter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::form_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::form_action_getter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::form_action_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->form_action(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::form_action_setter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::form_action_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_form_action(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::form_enctype_getter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::form_enctype_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("formenctype"_fly_string);
    ...
    Array valid_values { "application/x-www-form-urlencoded"_string, "multipart/form-data"_string, "text/plain"_string };
    ...
    if (!has_keyword && !did_set_to_missing_value)
        retval = "application/x-www-form-urlencoded"_string;
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::form_enctype_setter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::form_enctype_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("formenctype"_fly_string, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::form_method_getter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::form_method_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("formmethod"_fly_string);
    ...
    Array valid_values { "get"_string, "post"_string, "dialog"_string };
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::form_method_setter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::form_method_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("formmethod"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::form_no_validate_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval = impl->has_attribute("formnovalidate"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::form_no_validate_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value)
        impl->remove_attribute("formnovalidate"_fly_string);
    else
        impl->set_attribute_value("formnovalidate"_fly_string, String {});
...
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::form_target_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("formtarget"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::form_target_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("formtarget"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::name_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::name_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->type_for_bindings(); });
...
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::type_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_type_for_bindings(cpp_value); });
...
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::value_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("value"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::value_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("value"_fly_string, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::will_validate_getter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::will_validate_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::validity_getter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::validity_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::validation_message_getter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::validation_message_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::labels_getter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::labels_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::popover_target_element_getter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::popover_target_element_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    static auto content_attribute = "popovertarget"_fly_string;

    auto retval = impl->get_the_attribute_associated_element(content_attribute, TRY(throw_dom_exception_if_needed(vm, [&] { return impl->popover_target_element(); })));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::popover_target_element_setter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::popover_target_element_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value) {
        impl->set_popover_target_element({});
        impl->remove_attribute(content_attribute);
        return JS::js_undefined();
    }
    ...
    impl->set_popover_target_element(*cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::popover_target_action_getter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::popover_target_action_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("popovertargetaction"_fly_string);

    auto retval = contentAttributeValue.value_or(String {});

    auto did_set_to_missing_value = false;
    if (!contentAttributeValue.has_value()) {
        retval = "toggle"_string;
        did_set_to_missing_value = true;
    }

    Array valid_values { "toggle"_string, "show"_string, "hide"_string };
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::popover_target_action_setter)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::popover_target_action_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("popovertargetaction"_fly_string, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::check_validity)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::check_validity");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::report_validity)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::report_validity");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLButtonElementPrototype::set_custom_validity)
{
    WebIDL::log_trace(vm, "HTMLButtonElementPrototype::set_custom_validity");
    [[maybe_unused]] auto& realm = *vm.current_realm();
