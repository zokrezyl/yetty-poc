...
GC_DEFINE_ALLOCATOR(CSSCounterStyleRulePrototype);

CSSCounterStyleRulePrototype::CSSCounterStyleRulePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CSSCounterStyleRulePrototype::~CSSCounterStyleRulePrototype()
{
}

void CSSCounterStyleRulePrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_system_getter = JS::NativeFunction::create(realm, system_getter, 0, "system"_utf16_fly_string, &realm, "get"sv);

    auto native_system_setter = JS::NativeFunction::create(realm, system_setter, 1, "system"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("system"_utf16_fly_string, native_system_getter, native_system_setter, default_attributes);

    auto native_symbols_getter = JS::NativeFunction::create(realm, symbols_getter, 0, "symbols"_utf16_fly_string, &realm, "get"sv);

    auto native_symbols_setter = JS::NativeFunction::create(realm, symbols_setter, 1, "symbols"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("symbols"_utf16_fly_string, native_symbols_getter, native_symbols_setter, default_attributes);

    auto native_additive_symbols_getter = JS::NativeFunction::create(realm, additive_symbols_getter, 0, "additiveSymbols"_utf16_fly_string, &realm, "get"sv);

    auto native_additive_symbols_setter = JS::NativeFunction::create(realm, additive_symbols_setter, 1, "additiveSymbols"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("additiveSymbols"_utf16_fly_string, native_additive_symbols_getter, native_additive_symbols_setter, default_attributes);

    auto native_negative_getter = JS::NativeFunction::create(realm, negative_getter, 0, "negative"_utf16_fly_string, &realm, "get"sv);

    auto native_negative_setter = JS::NativeFunction::create(realm, negative_setter, 1, "negative"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("negative"_utf16_fly_string, native_negative_getter, native_negative_setter, default_attributes);

    auto native_prefix_getter = JS::NativeFunction::create(realm, prefix_getter, 0, "prefix"_utf16_fly_string, &realm, "get"sv);

    auto native_prefix_setter = JS::NativeFunction::create(realm, prefix_setter, 1, "prefix"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("prefix"_utf16_fly_string, native_prefix_getter, native_prefix_setter, default_attributes);

    auto native_suffix_getter = JS::NativeFunction::create(realm, suffix_getter, 0, "suffix"_utf16_fly_string, &realm, "get"sv);

    auto native_suffix_setter = JS::NativeFunction::create(realm, suffix_setter, 1, "suffix"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("suffix"_utf16_fly_string, native_suffix_getter, native_suffix_setter, default_attributes);

    auto native_range_getter = JS::NativeFunction::create(realm, range_getter, 0, "range"_utf16_fly_string, &realm, "get"sv);

    auto native_range_setter = JS::NativeFunction::create(realm, range_setter, 1, "range"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("range"_utf16_fly_string, native_range_getter, native_range_setter, default_attributes);

    auto native_pad_getter = JS::NativeFunction::create(realm, pad_getter, 0, "pad"_utf16_fly_string, &realm, "get"sv);

    auto native_pad_setter = JS::NativeFunction::create(realm, pad_setter, 1, "pad"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("pad"_utf16_fly_string, native_pad_getter, native_pad_setter, default_attributes);

    auto native_speak_as_getter = JS::NativeFunction::create(realm, speak_as_getter, 0, "speakAs"_utf16_fly_string, &realm, "get"sv);

    auto native_speak_as_setter = JS::NativeFunction::create(realm, speak_as_setter, 1, "speakAs"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("speakAs"_utf16_fly_string, native_speak_as_getter, native_speak_as_setter, default_attributes);

    auto native_fallback_getter = JS::NativeFunction::create(realm, fallback_getter, 0, "fallback"_utf16_fly_string, &realm, "get"sv);

    auto native_fallback_setter = JS::NativeFunction::create(realm, fallback_setter, 1, "fallback"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("fallback"_utf16_fly_string, native_fallback_getter, native_fallback_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSCounterStyleRule"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSCounterStyleRulePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSCounterStyleRule*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSCounterStyleRule>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSCounterStyleRule");
    return static_cast<CSS::CSSCounterStyleRule*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::name_getter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::name_getter");
...
JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::name_setter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::name_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::system_getter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::system_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->system(); }));

    return JS::PrimitiveString::create(vm, retval);

}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::system_setter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::system_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_system(cpp_value); }));

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::symbols_getter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::symbols_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->symbols(); }));

    return JS::PrimitiveString::create(vm, retval);

}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::symbols_setter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::symbols_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_symbols(cpp_value); }));

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::additive_symbols_getter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::additive_symbols_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->additive_symbols(); }));

    return JS::PrimitiveString::create(vm, retval);

}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::additive_symbols_setter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::additive_symbols_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_additive_symbols(cpp_value); }));

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::negative_getter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::negative_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->negative(); }));

    return JS::PrimitiveString::create(vm, retval);

}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::negative_setter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::negative_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_negative(cpp_value); }));

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::prefix_getter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::prefix_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::prefix_setter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::prefix_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_prefix(cpp_value); }));

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::suffix_getter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::suffix_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->suffix(); }));

    return JS::PrimitiveString::create(vm, retval);

}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::suffix_setter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::suffix_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_suffix(cpp_value); }));

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::range_getter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::range_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->range(); }));

    return JS::PrimitiveString::create(vm, retval);

}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::range_setter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::range_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_range(cpp_value); }));

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::pad_getter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::pad_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->pad(); }));

    return JS::PrimitiveString::create(vm, retval);

}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::pad_setter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::pad_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_pad(cpp_value); }));

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::speak_as_getter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::speak_as_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->speak_as(); }));

    return JS::PrimitiveString::create(vm, retval);

}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::speak_as_setter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::speak_as_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_speak_as(cpp_value); }));

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::fallback_getter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::fallback_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(CSSCounterStyleRulePrototype::fallback_setter)
{
    WebIDL::log_trace(vm, "CSSCounterStyleRulePrototype::fallback_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_fallback(cpp_value); }));
