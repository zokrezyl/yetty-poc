...
GC_DEFINE_ALLOCATOR(HTMLSelectedContentElementPrototype);

HTMLSelectedContentElementPrototype::HTMLSelectedContentElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

HTMLSelectedContentElementPrototype::~HTMLSelectedContentElementPrototype()
{
}

void HTMLSelectedContentElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLSelectedContentElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLSelectedContentElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
