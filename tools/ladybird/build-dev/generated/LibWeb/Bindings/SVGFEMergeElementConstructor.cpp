...
GC_DEFINE_ALLOCATOR(SVGFEMergeElementConstructor);

SVGFEMergeElementConstructor::SVGFEMergeElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGFEMergeElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGFEMergeElementConstructor::~SVGFEMergeElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGFEMergeElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGFEMergeElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGFEMergeElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGFEMergeElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGFEMergeElement");
}


void SVGFEMergeElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGFEMergeElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGFEMergeElementPrototype>(realm, "SVGFEMergeElement"_fly_string), 0);
