...
GC_DEFINE_ALLOCATOR(SVGSymbolElementPrototype);

SVGSymbolElementPrototype::SVGSymbolElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGSymbolElementPrototype::~SVGSymbolElementPrototype()
{
}

void SVGSymbolElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGSymbolElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGSymbolElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGSymbolElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGSymbolElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGSymbolElement");
    return static_cast<SVG::SVGSymbolElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGSymbolElementPrototype::view_box_getter)
{
    WebIDL::log_trace(vm, "SVGSymbolElementPrototype::view_box_getter");
