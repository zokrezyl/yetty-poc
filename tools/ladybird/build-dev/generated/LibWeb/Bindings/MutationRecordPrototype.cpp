...
GC_DEFINE_ALLOCATOR(MutationRecordPrototype);

MutationRecordPrototype::MutationRecordPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

MutationRecordPrototype::~MutationRecordPrototype()
{
}

void MutationRecordPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_added_nodes_getter = JS::NativeFunction::create(realm, added_nodes_getter, 0, "addedNodes"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_added_nodes_setter;

    define_direct_accessor("addedNodes"_utf16_fly_string, native_added_nodes_getter, native_added_nodes_setter, default_attributes);

    auto native_removed_nodes_getter = JS::NativeFunction::create(realm, removed_nodes_getter, 0, "removedNodes"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_removed_nodes_setter;

    define_direct_accessor("removedNodes"_utf16_fly_string, native_removed_nodes_getter, native_removed_nodes_setter, default_attributes);
    ...
    auto native_attribute_name_getter = JS::NativeFunction::create(realm, attribute_name_getter, 0, "attributeName"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_attribute_name_setter;

    define_direct_accessor("attributeName"_utf16_fly_string, native_attribute_name_getter, native_attribute_name_setter, default_attributes);

    auto native_attribute_namespace_getter = JS::NativeFunction::create(realm, attribute_namespace_getter, 0, "attributeNamespace"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_attribute_namespace_setter;

    define_direct_accessor("attributeNamespace"_utf16_fly_string, native_attribute_namespace_getter, native_attribute_namespace_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "MutationRecord"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<DOM::MutationRecord*> impl_from(JS::VM& vm)
{
    ...
    if (!is<DOM::MutationRecord>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "MutationRecord");
    return static_cast<DOM::MutationRecord*>(this_object);
}
...
JS_DEFINE_NATIVE_FUNCTION(MutationRecordPrototype::added_nodes_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->added_nodes(); }));
...
JS_DEFINE_NATIVE_FUNCTION(MutationRecordPrototype::removed_nodes_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->removed_nodes(); }));
...
JS_DEFINE_NATIVE_FUNCTION(MutationRecordPrototype::attribute_name_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->attribute_name(); }));
...
JS_DEFINE_NATIVE_FUNCTION(MutationRecordPrototype::attribute_namespace_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->attribute_namespace(); }));
