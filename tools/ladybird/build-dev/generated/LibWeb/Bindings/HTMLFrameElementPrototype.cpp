...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLFrameElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLFrameElementPrototype);

HTMLFrameElementPrototype::HTMLFrameElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLFrameElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_no_resize_getter = JS::NativeFunction::create(realm, no_resize_getter, 0, "noResize"_utf16_fly_string, &realm, "get"sv);

    auto native_no_resize_setter = JS::NativeFunction::create(realm, no_resize_setter, 1, "noResize"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("noResize"_utf16_fly_string, native_no_resize_getter, native_no_resize_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLFrameElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLFrameElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLFrameElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLFrameElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLFrameElement");
    return static_cast<HTML::HTMLFrameElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLFrameElementPrototype::name_getter)
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::name_getter");
...
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::name_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::scrolling_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::scrolling_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::src_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::src_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::frame_border_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::frame_border_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::long_desc_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::long_desc_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFrameElementPrototype::no_resize_getter)
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::no_resize_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval = impl->has_attribute("noresize"_fly_string);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFrameElementPrototype::no_resize_setter)
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::no_resize_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value)
        impl->remove_attribute("noresize"_fly_string);
    else
        impl->set_attribute_value("noresize"_fly_string, String {});
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFrameElementPrototype::content_document_getter)
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::content_document_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFrameElementPrototype::content_window_getter)
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::content_window_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFrameElementPrototype::margin_height_getter)
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::margin_height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFrameElementPrototype::margin_height_setter)
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::margin_height_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFrameElementPrototype::margin_width_getter)
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::margin_width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFrameElementPrototype::margin_width_setter)
{
    WebIDL::log_trace(vm, "HTMLFrameElementPrototype::margin_width_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
