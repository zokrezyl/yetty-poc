...
GC_DEFINE_ALLOCATOR(DelayNodePrototype);

DelayNodePrototype::DelayNodePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

DelayNodePrototype::~DelayNodePrototype()
{
}

void DelayNodePrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_delay_time_getter = JS::NativeFunction::create(realm, delay_time_getter, 0, "delayTime"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_delay_time_setter;

    define_direct_accessor("delayTime"_utf16_fly_string, native_delay_time_getter, native_delay_time_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "DelayNode"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void DelayNodePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<WebAudio::DelayNode*> impl_from(JS::VM& vm)
{
    ...
    if (!is<WebAudio::DelayNode>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "DelayNode");
    return static_cast<WebAudio::DelayNode*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(DelayNodePrototype::delay_time_getter)
{
    WebIDL::log_trace(vm, "DelayNodePrototype::delay_time_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->delay_time(); }));
