...
GC_DEFINE_ALLOCATOR(CDATASectionPrototype);

CDATASectionPrototype::CDATASectionPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CDATASectionPrototype::~CDATASectionPrototype()
{
}

void CDATASectionPrototype::initialize(JS::Realm& realm)
{
    ...
    set_prototype(&ensure_web_prototype<TextPrototype>(realm, "Text"_fly_string));


    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CDATASection"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CDATASectionPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
