...
#if __has_include(<LibWeb/Bindings/SVGTextContentElementPrototype.h>)
#    include <LibWeb/Bindings/SVGTextContentElementPrototype.h>
#endif


#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGTextPathElement.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGTextContentElement.h>
...
GC_DEFINE_ALLOCATOR(SVGTextPathElementPrototype);

SVGTextPathElementPrototype::SVGTextPathElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGTextPathElementPrototype::~SVGTextPathElementPrototype()
{
}

void SVGTextPathElementPrototype::initialize(JS::Realm& realm)
{
    ...
    set_prototype(&ensure_web_prototype<SVGTextContentElementPrototype>(realm, "SVGTextContentElement"_fly_string));


    define_direct_property("startOffset"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property("method"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property("spacing"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
    ...
    auto constant_TEXTPATH_METHODTYPE_UNKNOWN_value = JS::Value(static_cast<WebIDL::UnsignedShort>(0));

    define_direct_property("TEXTPATH_METHODTYPE_UNKNOWN"_utf16_fly_string, constant_TEXTPATH_METHODTYPE_UNKNOWN_value, JS::Attribute::Enumerable);

    auto constant_TEXTPATH_METHODTYPE_ALIGN_value = JS::Value(static_cast<WebIDL::UnsignedShort>(1));

    define_direct_property("TEXTPATH_METHODTYPE_ALIGN"_utf16_fly_string, constant_TEXTPATH_METHODTYPE_ALIGN_value, JS::Attribute::Enumerable);

    auto constant_TEXTPATH_METHODTYPE_STRETCH_value = JS::Value(static_cast<WebIDL::UnsignedShort>(2));

    define_direct_property("TEXTPATH_METHODTYPE_STRETCH"_utf16_fly_string, constant_TEXTPATH_METHODTYPE_STRETCH_value, JS::Attribute::Enumerable);

    auto constant_TEXTPATH_SPACINGTYPE_UNKNOWN_value = JS::Value(static_cast<WebIDL::UnsignedShort>(0));

    define_direct_property("TEXTPATH_SPACINGTYPE_UNKNOWN"_utf16_fly_string, constant_TEXTPATH_SPACINGTYPE_UNKNOWN_value, JS::Attribute::Enumerable);

    auto constant_TEXTPATH_SPACINGTYPE_AUTO_value = JS::Value(static_cast<WebIDL::UnsignedShort>(1));

    define_direct_property("TEXTPATH_SPACINGTYPE_AUTO"_utf16_fly_string, constant_TEXTPATH_SPACINGTYPE_AUTO_value, JS::Attribute::Enumerable);

    auto constant_TEXTPATH_SPACINGTYPE_EXACT_value = JS::Value(static_cast<WebIDL::UnsignedShort>(2));

    define_direct_property("TEXTPATH_SPACINGTYPE_EXACT"_utf16_fly_string, constant_TEXTPATH_SPACINGTYPE_EXACT_value, JS::Attribute::Enumerable);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGTextPathElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGTextPathElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGTextPathElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGTextPathElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGTextPathElement");
    return static_cast<SVG::SVGTextPathElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGTextPathElementPrototype::href_getter)
{
    WebIDL::log_trace(vm, "SVGTextPathElementPrototype::href_getter");
