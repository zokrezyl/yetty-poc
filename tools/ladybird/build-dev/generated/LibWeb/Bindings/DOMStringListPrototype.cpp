...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/DOMStringList.h>
...
GC_DEFINE_ALLOCATOR(DOMStringListPrototype);

DOMStringListPrototype::DOMStringListPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

DOMStringListPrototype::~DOMStringListPrototype()
{
}

void DOMStringListPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "DOMStringList"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void DOMStringListPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::DOMStringList*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::DOMStringList>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "DOMStringList");
    return static_cast<HTML::DOMStringList*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(DOMStringListPrototype::length_getter)
{
    WebIDL::log_trace(vm, "DOMStringListPrototype::length_getter");
...
JS_DEFINE_NATIVE_FUNCTION(DOMStringListPrototype::item)
{
    WebIDL::log_trace(vm, "DOMStringListPrototype::item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(DOMStringListPrototype::contains)
{
    WebIDL::log_trace(vm, "DOMStringListPrototype::contains");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->contains(string); }));
