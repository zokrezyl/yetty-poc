...
GC_DEFINE_ALLOCATOR(AnimationTimelinePrototype);

AnimationTimelinePrototype::AnimationTimelinePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

AnimationTimelinePrototype::~AnimationTimelinePrototype()
{
}

void AnimationTimelinePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_accessor("duration"_utf16_fly_string, native_duration_getter, native_duration_setter, default_attributes);
        ...
        define_direct_property("play"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "AnimationTimeline"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void AnimationTimelinePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<AnimationTimeline*> impl_from(JS::VM& vm)
{
    ...
    if (!is<AnimationTimeline>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "AnimationTimeline");
    return static_cast<AnimationTimeline*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(AnimationTimelinePrototype::current_time_getter)
{
    WebIDL::log_trace(vm, "AnimationTimelinePrototype::current_time_getter");
...
JS_DEFINE_NATIVE_FUNCTION(AnimationTimelinePrototype::duration_getter)
{
    WebIDL::log_trace(vm, "AnimationTimelinePrototype::duration_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->duration_for_bindings(); }));
