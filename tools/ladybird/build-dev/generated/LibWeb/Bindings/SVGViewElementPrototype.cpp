...
GC_DEFINE_ALLOCATOR(SVGViewElementPrototype);

SVGViewElementPrototype::SVGViewElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGViewElementPrototype::~SVGViewElementPrototype()
{
}

void SVGViewElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGViewElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGViewElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGViewElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGViewElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGViewElement");
    return static_cast<SVG::SVGViewElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGViewElementPrototype::view_box_getter)
{
    WebIDL::log_trace(vm, "SVGViewElementPrototype::view_box_getter");
