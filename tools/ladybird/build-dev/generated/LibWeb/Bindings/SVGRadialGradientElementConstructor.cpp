...
GC_DEFINE_ALLOCATOR(SVGRadialGradientElementConstructor);

SVGRadialGradientElementConstructor::SVGRadialGradientElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGRadialGradientElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGRadialGradientElementConstructor::~SVGRadialGradientElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGRadialGradientElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGRadialGradientElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGRadialGradientElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGRadialGradientElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGRadialGradientElement");
}


void SVGRadialGradientElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    set_prototype(&ensure_web_constructor<SVGGradientElementPrototype>(realm, "SVGGradientElement"_fly_string));

    define_direct_property(vm.names.length, JS::Value(0), JS::Attribute::Configurable);
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGRadialGradientElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGRadialGradientElementPrototype>(realm, "SVGRadialGradientElement"_fly_string), 0);
