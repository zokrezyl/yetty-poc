...
void HTMLSelectElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_selected_options_getter = JS::NativeFunction::create(realm, selected_options_getter, 0, "selectedOptions"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_selected_options_setter;

    define_direct_accessor("selectedOptions"_utf16_fly_string, native_selected_options_getter, native_selected_options_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLSelectElement"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLSelectElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLSelectElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLSelectElement");
    return static_cast<HTML::HTMLSelectElement*>(this_object);
}
...
JS_DEFINE_NATIVE_FUNCTION(HTMLSelectElementPrototype::options_getter)
{
    ...
    return &const_cast<HTMLOptionsCollection&>(*retval);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLSelectElementPrototype::selected_options_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->selected_options(); }));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLSelectElementPrototype::item)
{
    ...
    return &const_cast<HTMLOptionElement&>(*retval);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLSelectElementPrototype::remove0)
{
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->remove(); });
