...
GC_DEFINE_ALLOCATOR(HTMLLIElementPrototype);

HTMLLIElementPrototype::HTMLLIElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLLIElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLLIElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLLIElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLLIElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLLIElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLLIElement");
    return static_cast<HTML::HTMLLIElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLLIElementPrototype::value_getter)
{
    WebIDL::log_trace(vm, "HTMLLIElementPrototype::value_getter");
...
JS_DEFINE_NATIVE_FUNCTION(HTMLLIElementPrototype::value_setter)
{
    WebIDL::log_trace(vm, "HTMLLIElementPrototype::value_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLLIElementPrototype::type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLLIElementPrototype::type_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
