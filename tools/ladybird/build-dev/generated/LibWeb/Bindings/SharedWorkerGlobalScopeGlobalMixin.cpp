...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/SharedWorkerGlobalScope.h>
...
SharedWorkerGlobalScopeGlobalMixin::SharedWorkerGlobalScopeGlobalMixin() = default;
SharedWorkerGlobalScopeGlobalMixin::~SharedWorkerGlobalScopeGlobalMixin() = default;

void SharedWorkerGlobalScopeGlobalMixin::initialize(JS::Realm& realm, JS::Object& object)
{
    ...
    object.set_prototype(&ensure_web_prototype<SharedWorkerGlobalScopePrototype>(realm, "SharedWorkerGlobalScope"_fly_string));
    ...
    object.define_direct_accessor("onconnect"_utf16_fly_string, native_onconnect_getter, native_onconnect_setter, default_attributes);

    object.define_native_function(realm, "close"_utf16_fly_string, close, 0, default_attributes);

    object.define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SharedWorkerGlobalScope"_string), JS::Attribute::Configurable);

}

void SharedWorkerGlobalScopeGlobalMixin::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::SharedWorkerGlobalScope*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::SharedWorkerGlobalScope>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SharedWorkerGlobalScope");
    return static_cast<HTML::SharedWorkerGlobalScope*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SharedWorkerGlobalScopeGlobalMixin::name_getter)
{
    WebIDL::log_trace(vm, "SharedWorkerGlobalScopeGlobalMixin::name_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SharedWorkerGlobalScopeGlobalMixin::name_setter)
{
    WebIDL::log_trace(vm, "SharedWorkerGlobalScopeGlobalMixin::name_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(impl->create_data_property_or_throw("name"_utf16_fly_string, value));

    // 2. Return undefined.
    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(SharedWorkerGlobalScopeGlobalMixin::onconnect_getter)
{
    WebIDL::log_trace(vm, "SharedWorkerGlobalScopeGlobalMixin::onconnect_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SharedWorkerGlobalScopeGlobalMixin::onconnect_setter)
{
    WebIDL::log_trace(vm, "SharedWorkerGlobalScopeGlobalMixin::onconnect_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SharedWorkerGlobalScopeGlobalMixin::close)
{
    WebIDL::log_trace(vm, "SharedWorkerGlobalScopeGlobalMixin::close");
    [[maybe_unused]] auto& realm = *vm.current_realm();
