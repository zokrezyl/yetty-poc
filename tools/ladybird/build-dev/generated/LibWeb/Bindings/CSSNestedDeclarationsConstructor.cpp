...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/CSS/CSSNestedDeclarations.h>
...
GC_DEFINE_ALLOCATOR(CSSNestedDeclarationsConstructor);

CSSNestedDeclarationsConstructor::CSSNestedDeclarationsConstructor(JS::Realm& realm)
    : NativeFunction("CSSNestedDeclarations"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

CSSNestedDeclarationsConstructor::~CSSNestedDeclarationsConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> CSSNestedDeclarationsConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "CSSNestedDeclarations");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> CSSNestedDeclarationsConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "CSSNestedDeclarationsConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "CSSNestedDeclarations");
}


void CSSNestedDeclarationsConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "CSSNestedDeclarations"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<CSSNestedDeclarationsPrototype>(realm, "CSSNestedDeclarations"_fly_string), 0);
