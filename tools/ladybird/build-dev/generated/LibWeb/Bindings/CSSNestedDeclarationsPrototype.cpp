...
GC_DEFINE_ALLOCATOR(CSSNestedDeclarationsPrototype);

CSSNestedDeclarationsPrototype::CSSNestedDeclarationsPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CSSNestedDeclarationsPrototype::~CSSNestedDeclarationsPrototype()
{
}

void CSSNestedDeclarationsPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSNestedDeclarations"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSNestedDeclarationsPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSNestedDeclarations*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSNestedDeclarations>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSNestedDeclarations");
    return static_cast<CSS::CSSNestedDeclarations*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSNestedDeclarationsPrototype::style_getter)
{
    WebIDL::log_trace(vm, "CSSNestedDeclarationsPrototype::style_getter");
...
JS_DEFINE_NATIVE_FUNCTION(CSSNestedDeclarationsPrototype::style_setter)
{
    WebIDL::log_trace(vm, "CSSNestedDeclarationsPrototype::style_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
