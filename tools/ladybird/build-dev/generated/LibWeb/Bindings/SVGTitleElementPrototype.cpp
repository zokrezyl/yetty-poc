...
GC_DEFINE_ALLOCATOR(SVGTitleElementPrototype);

SVGTitleElementPrototype::SVGTitleElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGTitleElementPrototype::~SVGTitleElementPrototype()
{
}

void SVGTitleElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGTitleElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGTitleElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
