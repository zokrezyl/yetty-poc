...
GC_DEFINE_ALLOCATOR(NodeFilterConstructor);

NodeFilterConstructor::NodeFilterConstructor(JS::Realm& realm)
    : NativeFunction("NodeFilter"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

NodeFilterConstructor::~NodeFilterConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> NodeFilterConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "NodeFilter");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> NodeFilterConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "NodeFilterConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "NodeFilter");
}


void NodeFilterConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "NodeFilter"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<NodeFilterPrototype>(realm, "NodeFilter"_fly_string), 0);


    auto constant_FILTER_ACCEPT_value = JS::Value(static_cast<WebIDL::UnsignedShort>(1));

    define_direct_property("FILTER_ACCEPT"_utf16_fly_string, constant_FILTER_ACCEPT_value, JS::Attribute::Enumerable);

    auto constant_FILTER_REJECT_value = JS::Value(static_cast<WebIDL::UnsignedShort>(2));

    define_direct_property("FILTER_REJECT"_utf16_fly_string, constant_FILTER_REJECT_value, JS::Attribute::Enumerable);

    auto constant_FILTER_SKIP_value = JS::Value(static_cast<WebIDL::UnsignedShort>(3));

    define_direct_property("FILTER_SKIP"_utf16_fly_string, constant_FILTER_SKIP_value, JS::Attribute::Enumerable);

    auto constant_SHOW_ALL_value = JS::Value(static_cast<WebIDL::UnsignedLong>(0xFFFFFFFF));

    define_direct_property("SHOW_ALL"_utf16_fly_string, constant_SHOW_ALL_value, JS::Attribute::Enumerable);

    auto constant_SHOW_ELEMENT_value = JS::Value(static_cast<WebIDL::UnsignedLong>(0x1));

    define_direct_property("SHOW_ELEMENT"_utf16_fly_string, constant_SHOW_ELEMENT_value, JS::Attribute::Enumerable);

    auto constant_SHOW_ATTRIBUTE_value = JS::Value(static_cast<WebIDL::UnsignedLong>(0x2));

    define_direct_property("SHOW_ATTRIBUTE"_utf16_fly_string, constant_SHOW_ATTRIBUTE_value, JS::Attribute::Enumerable);

    auto constant_SHOW_TEXT_value = JS::Value(static_cast<WebIDL::UnsignedLong>(0x4));

    define_direct_property("SHOW_TEXT"_utf16_fly_string, constant_SHOW_TEXT_value, JS::Attribute::Enumerable);

    auto constant_SHOW_CDATA_SECTION_value = JS::Value(static_cast<WebIDL::UnsignedLong>(0x8));

    define_direct_property("SHOW_CDATA_SECTION"_utf16_fly_string, constant_SHOW_CDATA_SECTION_value, JS::Attribute::Enumerable);

    auto constant_SHOW_ENTITY_REFERENCE_value = JS::Value(static_cast<WebIDL::UnsignedLong>(0x10));

    define_direct_property("SHOW_ENTITY_REFERENCE"_utf16_fly_string, constant_SHOW_ENTITY_REFERENCE_value, JS::Attribute::Enumerable);

    auto constant_SHOW_ENTITY_value = JS::Value(static_cast<WebIDL::UnsignedLong>(0x20));

    define_direct_property("SHOW_ENTITY"_utf16_fly_string, constant_SHOW_ENTITY_value, JS::Attribute::Enumerable);

    auto constant_SHOW_PROCESSING_INSTRUCTION_value = JS::Value(static_cast<WebIDL::UnsignedLong>(0x40));

    define_direct_property("SHOW_PROCESSING_INSTRUCTION"_utf16_fly_string, constant_SHOW_PROCESSING_INSTRUCTION_value, JS::Attribute::Enumerable);

    auto constant_SHOW_COMMENT_value = JS::Value(static_cast<WebIDL::UnsignedLong>(0x80));

    define_direct_property("SHOW_COMMENT"_utf16_fly_string, constant_SHOW_COMMENT_value, JS::Attribute::Enumerable);

    auto constant_SHOW_DOCUMENT_value = JS::Value(static_cast<WebIDL::UnsignedLong>(0x100));

    define_direct_property("SHOW_DOCUMENT"_utf16_fly_string, constant_SHOW_DOCUMENT_value, JS::Attribute::Enumerable);

    auto constant_SHOW_DOCUMENT_TYPE_value = JS::Value(static_cast<WebIDL::UnsignedLong>(0x200));

    define_direct_property("SHOW_DOCUMENT_TYPE"_utf16_fly_string, constant_SHOW_DOCUMENT_TYPE_value, JS::Attribute::Enumerable);

    auto constant_SHOW_DOCUMENT_FRAGMENT_value = JS::Value(static_cast<WebIDL::UnsignedLong>(0x400));

    define_direct_property("SHOW_DOCUMENT_FRAGMENT"_utf16_fly_string, constant_SHOW_DOCUMENT_FRAGMENT_value, JS::Attribute::Enumerable);

    auto constant_SHOW_NOTATION_value = JS::Value(static_cast<WebIDL::UnsignedLong>(0x800));

    define_direct_property("SHOW_NOTATION"_utf16_fly_string, constant_SHOW_NOTATION_value, JS::Attribute::Enumerable);
