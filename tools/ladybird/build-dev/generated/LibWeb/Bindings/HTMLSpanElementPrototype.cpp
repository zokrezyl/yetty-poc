...
GC_DEFINE_ALLOCATOR(HTMLSpanElementPrototype);

HTMLSpanElementPrototype::HTMLSpanElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLSpanElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLSpanElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLSpanElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
