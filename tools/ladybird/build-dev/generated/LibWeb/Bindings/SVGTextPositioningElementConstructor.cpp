...
GC_DEFINE_ALLOCATOR(SVGTextPositioningElementConstructor);

SVGTextPositioningElementConstructor::SVGTextPositioningElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGTextPositioningElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGTextPositioningElementConstructor::~SVGTextPositioningElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGTextPositioningElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGTextPositioningElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGTextPositioningElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGTextPositioningElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGTextPositioningElement");
}


void SVGTextPositioningElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGTextPositioningElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGTextPositioningElementPrototype>(realm, "SVGTextPositioningElement"_fly_string), 0);
