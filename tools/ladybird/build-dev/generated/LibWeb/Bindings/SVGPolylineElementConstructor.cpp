...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGPolylineElement.h>
...
GC_DEFINE_ALLOCATOR(SVGPolylineElementConstructor);

SVGPolylineElementConstructor::SVGPolylineElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGPolylineElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}
...
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGPolylineElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGPolylineElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGPolylineElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGPolylineElement");
}


void SVGPolylineElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    set_prototype(&ensure_web_constructor<SVGGeometryElementPrototype>(realm, "SVGGeometryElement"_fly_string));

    define_direct_property(vm.names.length, JS::Value(0), JS::Attribute::Configurable);
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGPolylineElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGPolylineElementPrototype>(realm, "SVGPolylineElement"_fly_string), 0);
