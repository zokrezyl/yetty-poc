...
GC_DEFINE_ALLOCATOR(SVGFEFuncBElementPrototype);

SVGFEFuncBElementPrototype::SVGFEFuncBElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGFEFuncBElementPrototype::~SVGFEFuncBElementPrototype()
{
}

void SVGFEFuncBElementPrototype::initialize(JS::Realm& realm)
{
    ...
    set_prototype(&ensure_web_prototype<SVGComponentTransferFunctionElementPrototype>(realm, "SVGComponentTransferFunctionElement"_fly_string));


    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGFEFuncBElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGFEFuncBElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
