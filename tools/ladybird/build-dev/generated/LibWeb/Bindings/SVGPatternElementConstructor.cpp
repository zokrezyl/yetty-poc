...
GC_DEFINE_ALLOCATOR(SVGPatternElementConstructor);

SVGPatternElementConstructor::SVGPatternElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGPatternElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGPatternElementConstructor::~SVGPatternElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGPatternElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGPatternElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGPatternElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGPatternElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGPatternElement");
}


void SVGPatternElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGPatternElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGPatternElementPrototype>(realm, "SVGPatternElement"_fly_string), 0);
