...
GC_DEFINE_ALLOCATOR(CanvasRenderingContext2DPrototype);

CanvasRenderingContext2DPrototype::CanvasRenderingContext2DPrototype([[maybe_unused]] JS::Realm& realm)
...
void CanvasRenderingContext2DPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_accessor("imageSmoothingQuality"_utf16_fly_string, native_image_smoothing_quality_getter, native_image_smoothing_quality_setter, default_attributes);
        ...
        define_direct_property("drawFocusIfNeeded"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CanvasRenderingContext2D"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::CanvasRenderingContext2D*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::CanvasRenderingContext2D>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CanvasRenderingContext2D");
    return static_cast<HTML::CanvasRenderingContext2D*>(this_object);
}
