...
GC_DEFINE_ALLOCATOR(CSSRuleListPrototype);

CSSRuleListPrototype::CSSRuleListPrototype([[maybe_unused]] JS::Realm& realm)
...
void CSSRuleListPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSRuleList"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSRuleListPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSRuleList*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSRuleList>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSRuleList");
    return static_cast<CSS::CSSRuleList*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSRuleListPrototype::length_getter)
{
    WebIDL::log_trace(vm, "CSSRuleListPrototype::length_getter");
...
{
    WebIDL::log_trace(vm, "CSSRuleListPrototype::item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
