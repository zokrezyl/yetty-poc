...
GC_DEFINE_ALLOCATOR(SVGLinearGradientElementConstructor);

SVGLinearGradientElementConstructor::SVGLinearGradientElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGLinearGradientElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGLinearGradientElementConstructor::~SVGLinearGradientElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGLinearGradientElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGLinearGradientElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGLinearGradientElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGLinearGradientElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGLinearGradientElement");
}


void SVGLinearGradientElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGLinearGradientElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGLinearGradientElementPrototype>(realm, "SVGLinearGradientElement"_fly_string), 0);
