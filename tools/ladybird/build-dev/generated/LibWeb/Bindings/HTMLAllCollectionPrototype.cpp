...
GC_DEFINE_ALLOCATOR(HTMLAllCollectionPrototype);

HTMLAllCollectionPrototype::HTMLAllCollectionPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

HTMLAllCollectionPrototype::~HTMLAllCollectionPrototype()
{
}

void HTMLAllCollectionPrototype::initialize(JS::Realm& realm)
{
    ...
    define_native_function(realm, "namedItem"_utf16_fly_string, named_item, 1, default_attributes);

    define_native_function(realm, "item"_utf16_fly_string, item, 0, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLAllCollection"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLAllCollectionPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLAllCollection*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLAllCollection>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLAllCollection");
    return static_cast<HTML::HTMLAllCollection*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLAllCollectionPrototype::length_getter)
{
    WebIDL::log_trace(vm, "HTMLAllCollectionPrototype::length_getter");
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAllCollectionPrototype::named_item)
{
    WebIDL::log_trace(vm, "HTMLAllCollectionPrototype::named_item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->named_item(name); }));

    return retval.visit(

        [&vm, &realm]([[maybe_unused]] GC::Root<HTMLCollection> const& visited_union_value0) -> JS::Value {
            // These may be unused.
            (void)vm;
            (void)realm;

    return &const_cast<HTMLCollection&>(*visited_union_value0);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAllCollectionPrototype::item)
{
    WebIDL::log_trace(vm, "HTMLAllCollectionPrototype::item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    Optional<FlyString> name_or_index;

    if (!arg0.is_undefined()) {
        if (!false || !arg0.is_null())
            name_or_index = TRY(WebIDL::to_string(vm, arg0));
    }

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->item(name_or_index); }));
