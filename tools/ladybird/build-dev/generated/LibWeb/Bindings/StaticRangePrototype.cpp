...
GC_DEFINE_ALLOCATOR(StaticRangePrototype);

StaticRangePrototype::StaticRangePrototype([[maybe_unused]] JS::Realm& realm)
...
void StaticRangePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "StaticRange"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void StaticRangePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
