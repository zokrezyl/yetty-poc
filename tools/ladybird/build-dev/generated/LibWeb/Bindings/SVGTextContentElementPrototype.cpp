...
GC_DEFINE_ALLOCATOR(SVGTextContentElementPrototype);

SVGTextContentElementPrototype::SVGTextContentElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void SVGTextContentElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property("textLength"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property("lengthAdjust"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
        define_direct_property("getComputedTextLength"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
        define_direct_property("getSubStringLength"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
        define_direct_property("getEndPositionOfChar"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
        define_direct_property("getExtentOfChar"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
        define_direct_property("getRotationOfChar"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
        define_direct_property("getCharNumAtPosition"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
        define_direct_property("selectSubString"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    auto constant_LENGTHADJUST_UNKNOWN_value = JS::Value(static_cast<WebIDL::UnsignedShort>(0));

    define_direct_property("LENGTHADJUST_UNKNOWN"_utf16_fly_string, constant_LENGTHADJUST_UNKNOWN_value, JS::Attribute::Enumerable);

    auto constant_LENGTHADJUST_SPACING_value = JS::Value(static_cast<WebIDL::UnsignedShort>(1));

    define_direct_property("LENGTHADJUST_SPACING"_utf16_fly_string, constant_LENGTHADJUST_SPACING_value, JS::Attribute::Enumerable);

    auto constant_LENGTHADJUST_SPACINGANDGLYPHS_value = JS::Value(static_cast<WebIDL::UnsignedShort>(2));

    define_direct_property("LENGTHADJUST_SPACINGANDGLYPHS"_utf16_fly_string, constant_LENGTHADJUST_SPACINGANDGLYPHS_value, JS::Attribute::Enumerable);

    define_native_function(realm, "getNumberOfChars"_utf16_fly_string, get_number_of_chars, 0, default_attributes);

    define_native_function(realm, "getStartPositionOfChar"_utf16_fly_string, get_start_position_of_char, 1, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGTextContentElement"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGTextContentElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGTextContentElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGTextContentElement");
    return static_cast<SVG::SVGTextContentElement*>(this_object);
}
...
JS_DEFINE_NATIVE_FUNCTION(SVGTextContentElementPrototype::get_number_of_chars)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->get_number_of_chars(); }));
...
JS_DEFINE_NATIVE_FUNCTION(SVGTextContentElementPrototype::get_start_position_of_char)
{
    ...
    WebIDL::UnsignedLong charnum;

    charnum = TRY(WebIDL::convert_to_int<WebIDL::UnsignedLong>(vm, arg0, WebIDL::EnforceRange::No, WebIDL::Clamp::No));

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->get_start_position_of_char(charnum); }));
