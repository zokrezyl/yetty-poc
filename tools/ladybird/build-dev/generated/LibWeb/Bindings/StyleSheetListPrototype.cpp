...
GC_DEFINE_ALLOCATOR(StyleSheetListPrototype);

StyleSheetListPrototype::StyleSheetListPrototype([[maybe_unused]] JS::Realm& realm)
...
void StyleSheetListPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "StyleSheetList"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void StyleSheetListPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::StyleSheetList*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::StyleSheetList>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "StyleSheetList");
    return static_cast<CSS::StyleSheetList*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(StyleSheetListPrototype::length_getter)
{
    WebIDL::log_trace(vm, "StyleSheetListPrototype::length_getter");
...
{
    WebIDL::log_trace(vm, "StyleSheetListPrototype::item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
