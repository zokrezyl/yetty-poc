...
GC_DEFINE_ALLOCATOR(ServiceWorkerContainerConstructor);

ServiceWorkerContainerConstructor::ServiceWorkerContainerConstructor(JS::Realm& realm)
    : NativeFunction("ServiceWorkerContainer"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

ServiceWorkerContainerConstructor::~ServiceWorkerContainerConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> ServiceWorkerContainerConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "ServiceWorkerContainer");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> ServiceWorkerContainerConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "ServiceWorkerContainerConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "ServiceWorkerContainer");
}


void ServiceWorkerContainerConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "ServiceWorkerContainer"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<ServiceWorkerContainerPrototype>(realm, "ServiceWorkerContainer"_fly_string), 0);
