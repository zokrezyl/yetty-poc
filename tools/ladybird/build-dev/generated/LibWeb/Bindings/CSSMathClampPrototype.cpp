...
GC_DEFINE_ALLOCATOR(CSSMathClampPrototype);

CSSMathClampPrototype::CSSMathClampPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CSSMathClampPrototype::~CSSMathClampPrototype()
{
}

void CSSMathClampPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSMathClamp"_string), JS::Attribute::Configurable);
