...
GC_DEFINE_ALLOCATOR(SVGLengthListPrototype);

SVGLengthListPrototype::SVGLengthListPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

SVGLengthListPrototype::~SVGLengthListPrototype()
{
}

void SVGLengthListPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGLengthList"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGLengthListPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGLengthList*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGLengthList>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGLengthList");
    return static_cast<SVG::SVGLengthList*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGLengthListPrototype::length_getter)
{
    WebIDL::log_trace(vm, "SVGLengthListPrototype::length_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SVGLengthListPrototype::number_of_items_getter)
{
    WebIDL::log_trace(vm, "SVGLengthListPrototype::number_of_items_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGLengthListPrototype::clear)
{
    WebIDL::log_trace(vm, "SVGLengthListPrototype::clear");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGLengthListPrototype::initialize_)
{
    WebIDL::log_trace(vm, "SVGLengthListPrototype::initialize_");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!arg0.is_object() || !is<SVGLength>(arg0.as_object()))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGLength");

    auto& new_item = static_cast<SVGLength&>(arg0.as_object());
...
JS_DEFINE_NATIVE_FUNCTION(SVGLengthListPrototype::get_item)
{
    WebIDL::log_trace(vm, "SVGLengthListPrototype::get_item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGLengthListPrototype::insert_item_before)
{
    WebIDL::log_trace(vm, "SVGLengthListPrototype::insert_item_before");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGLengthListPrototype::replace_item)
{
    WebIDL::log_trace(vm, "SVGLengthListPrototype::replace_item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGLengthListPrototype::remove_item)
{
    WebIDL::log_trace(vm, "SVGLengthListPrototype::remove_item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGLengthListPrototype::append_item)
{
    WebIDL::log_trace(vm, "SVGLengthListPrototype::append_item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
