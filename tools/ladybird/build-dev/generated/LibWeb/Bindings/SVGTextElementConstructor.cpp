...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGTextElement.h>
...
GC_DEFINE_ALLOCATOR(SVGTextElementConstructor);

SVGTextElementConstructor::SVGTextElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGTextElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGTextElementConstructor::~SVGTextElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGTextElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGTextElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGTextElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGTextElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGTextElement");
}


void SVGTextElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGTextElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGTextElementPrototype>(realm, "SVGTextElement"_fly_string), 0);
