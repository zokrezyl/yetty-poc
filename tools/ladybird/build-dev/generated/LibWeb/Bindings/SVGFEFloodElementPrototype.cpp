...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGFEFloodElement.h>
...
GC_DEFINE_ALLOCATOR(SVGFEFloodElementPrototype);

SVGFEFloodElementPrototype::SVGFEFloodElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGFEFloodElementPrototype::~SVGFEFloodElementPrototype()
{
}

void SVGFEFloodElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGFEFloodElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGFEFloodElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGFEFloodElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGFEFloodElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGFEFloodElement");
    return static_cast<SVG::SVGFEFloodElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGFEFloodElementPrototype::x_getter)
{
    WebIDL::log_trace(vm, "SVGFEFloodElementPrototype::x_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEFloodElementPrototype::y_getter)
{
    WebIDL::log_trace(vm, "SVGFEFloodElementPrototype::y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEFloodElementPrototype::width_getter)
{
    WebIDL::log_trace(vm, "SVGFEFloodElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEFloodElementPrototype::height_getter)
{
    WebIDL::log_trace(vm, "SVGFEFloodElementPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEFloodElementPrototype::result_getter)
{
    WebIDL::log_trace(vm, "SVGFEFloodElementPrototype::result_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
