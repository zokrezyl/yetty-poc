...
GC_DEFINE_ALLOCATOR(HTMLUnknownElementPrototype);

HTMLUnknownElementPrototype::HTMLUnknownElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLUnknownElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLUnknownElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLUnknownElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
