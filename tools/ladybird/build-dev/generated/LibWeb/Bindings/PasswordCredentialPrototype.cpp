...
GC_DEFINE_ALLOCATOR(PasswordCredentialPrototype);

PasswordCredentialPrototype::PasswordCredentialPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

PasswordCredentialPrototype::~PasswordCredentialPrototype()
{
}

void PasswordCredentialPrototype::initialize(JS::Realm& realm)
{
    ...
    set_prototype(&ensure_web_prototype<CredentialPrototype>(realm, "Credential"_fly_string));
    ...
    auto native_icon_url_getter = JS::NativeFunction::create(realm, icon_url_getter, 0, "iconURL"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_icon_url_setter;

    define_direct_accessor("iconURL"_utf16_fly_string, native_icon_url_getter, native_icon_url_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "PasswordCredential"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<PasswordCredential*> impl_from(JS::VM& vm)
{
...
JS_DEFINE_NATIVE_FUNCTION(PasswordCredentialPrototype::icon_url_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->icon_url(); }));
