...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGComponentTransferFunctionElement.h>
...
GC_DEFINE_ALLOCATOR(SVGComponentTransferFunctionElementPrototype);

SVGComponentTransferFunctionElementPrototype::SVGComponentTransferFunctionElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGComponentTransferFunctionElementPrototype::~SVGComponentTransferFunctionElementPrototype()
{
}

void SVGComponentTransferFunctionElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_table_values_getter = JS::NativeFunction::create(realm, table_values_getter, 0, "tableValues"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_table_values_setter;

    define_direct_accessor("tableValues"_utf16_fly_string, native_table_values_getter, native_table_values_setter, default_attributes);

    auto native_slope_getter = JS::NativeFunction::create(realm, slope_getter, 0, "slope"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_slope_setter;

    define_direct_accessor("slope"_utf16_fly_string, native_slope_getter, native_slope_setter, default_attributes);

    auto native_intercept_getter = JS::NativeFunction::create(realm, intercept_getter, 0, "intercept"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_intercept_setter;

    define_direct_accessor("intercept"_utf16_fly_string, native_intercept_getter, native_intercept_setter, default_attributes);

    auto native_amplitude_getter = JS::NativeFunction::create(realm, amplitude_getter, 0, "amplitude"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_amplitude_setter;

    define_direct_accessor("amplitude"_utf16_fly_string, native_amplitude_getter, native_amplitude_setter, default_attributes);

    auto native_exponent_getter = JS::NativeFunction::create(realm, exponent_getter, 0, "exponent"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_exponent_setter;

    define_direct_accessor("exponent"_utf16_fly_string, native_exponent_getter, native_exponent_setter, default_attributes);

    auto native_offset_getter = JS::NativeFunction::create(realm, offset_getter, 0, "offset"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_offset_setter;

    define_direct_accessor("offset"_utf16_fly_string, native_offset_getter, native_offset_setter, default_attributes);

    auto constant_SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN_value = JS::Value(static_cast<WebIDL::UnsignedShort>(0));

    define_direct_property("SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN"_utf16_fly_string, constant_SVG_FECOMPONENTTRANSFER_TYPE_UNKNOWN_value, JS::Attribute::Enumerable);

    auto constant_SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY_value = JS::Value(static_cast<WebIDL::UnsignedShort>(1));

    define_direct_property("SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY"_utf16_fly_string, constant_SVG_FECOMPONENTTRANSFER_TYPE_IDENTITY_value, JS::Attribute::Enumerable);

    auto constant_SVG_FECOMPONENTTRANSFER_TYPE_TABLE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(2));

    define_direct_property("SVG_FECOMPONENTTRANSFER_TYPE_TABLE"_utf16_fly_string, constant_SVG_FECOMPONENTTRANSFER_TYPE_TABLE_value, JS::Attribute::Enumerable);

    auto constant_SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(3));

    define_direct_property("SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE"_utf16_fly_string, constant_SVG_FECOMPONENTTRANSFER_TYPE_DISCRETE_value, JS::Attribute::Enumerable);

    auto constant_SVG_FECOMPONENTTRANSFER_TYPE_LINEAR_value = JS::Value(static_cast<WebIDL::UnsignedShort>(4));

    define_direct_property("SVG_FECOMPONENTTRANSFER_TYPE_LINEAR"_utf16_fly_string, constant_SVG_FECOMPONENTTRANSFER_TYPE_LINEAR_value, JS::Attribute::Enumerable);

    auto constant_SVG_FECOMPONENTTRANSFER_TYPE_GAMMA_value = JS::Value(static_cast<WebIDL::UnsignedShort>(5));

    define_direct_property("SVG_FECOMPONENTTRANSFER_TYPE_GAMMA"_utf16_fly_string, constant_SVG_FECOMPONENTTRANSFER_TYPE_GAMMA_value, JS::Attribute::Enumerable);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGComponentTransferFunctionElement"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGComponentTransferFunctionElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGComponentTransferFunctionElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGComponentTransferFunctionElement");
    return static_cast<SVG::SVGComponentTransferFunctionElement*>(this_object);
}
...
JS_DEFINE_NATIVE_FUNCTION(SVGComponentTransferFunctionElementPrototype::table_values_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->table_values(); }));

    return &const_cast<SVGAnimatedNumberList&>(*retval);
...
JS_DEFINE_NATIVE_FUNCTION(SVGComponentTransferFunctionElementPrototype::slope_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->slope(); }));
...
JS_DEFINE_NATIVE_FUNCTION(SVGComponentTransferFunctionElementPrototype::intercept_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->intercept(); }));
...
JS_DEFINE_NATIVE_FUNCTION(SVGComponentTransferFunctionElementPrototype::amplitude_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->amplitude(); }));
...
JS_DEFINE_NATIVE_FUNCTION(SVGComponentTransferFunctionElementPrototype::exponent_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->exponent(); }));
...
JS_DEFINE_NATIVE_FUNCTION(SVGComponentTransferFunctionElementPrototype::offset_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->offset(); }));
