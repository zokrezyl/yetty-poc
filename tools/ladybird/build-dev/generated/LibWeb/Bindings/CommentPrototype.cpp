...
GC_DEFINE_ALLOCATOR(CommentPrototype);

CommentPrototype::CommentPrototype([[maybe_unused]] JS::Realm& realm)
...
void CommentPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "Comment"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CommentPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
