...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/CSS/CSSLayerStatementRule.h>
...
GC_DEFINE_ALLOCATOR(CSSLayerStatementRulePrototype);

CSSLayerStatementRulePrototype::CSSLayerStatementRulePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CSSLayerStatementRulePrototype::~CSSLayerStatementRulePrototype()
{
}

void CSSLayerStatementRulePrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_name_list_getter = JS::NativeFunction::create(realm, name_list_getter, 0, "nameList"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_name_list_setter;

    define_direct_accessor("nameList"_utf16_fly_string, native_name_list_getter, native_name_list_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSLayerStatementRule"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSLayerStatementRulePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSLayerStatementRule*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSLayerStatementRule>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSLayerStatementRule");
    return static_cast<CSS::CSSLayerStatementRule*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSLayerStatementRulePrototype::name_list_getter)
{
    WebIDL::log_trace(vm, "CSSLayerStatementRulePrototype::name_list_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->name_list(); }));
