...
#if __has_include(<LibWeb/Bindings/SVGComponentTransferFunctionElementPrototype.h>)
#    include <LibWeb/Bindings/SVGComponentTransferFunctionElementPrototype.h>
#endif


#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGFEFuncBElement.h>
...
GC_DEFINE_ALLOCATOR(SVGFEFuncBElementConstructor);

SVGFEFuncBElementConstructor::SVGFEFuncBElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGFEFuncBElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGFEFuncBElementConstructor::~SVGFEFuncBElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGFEFuncBElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGFEFuncBElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGFEFuncBElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGFEFuncBElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGFEFuncBElement");
}


void SVGFEFuncBElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    set_prototype(&ensure_web_constructor<SVGComponentTransferFunctionElementPrototype>(realm, "SVGComponentTransferFunctionElement"_fly_string));

    define_direct_property(vm.names.length, JS::Value(0), JS::Attribute::Configurable);
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGFEFuncBElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGFEFuncBElementPrototype>(realm, "SVGFEFuncBElement"_fly_string), 0);
