...
GC_DEFINE_ALLOCATOR(HTMLOptGroupElementPrototype);

HTMLOptGroupElementPrototype::HTMLOptGroupElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLOptGroupElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLOptGroupElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLOptGroupElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLOptGroupElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLOptGroupElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLOptGroupElement");
    return static_cast<HTML::HTMLOptGroupElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLOptGroupElementPrototype::disabled_getter)
{
    WebIDL::log_trace(vm, "HTMLOptGroupElementPrototype::disabled_getter");
...
{
    WebIDL::log_trace(vm, "HTMLOptGroupElementPrototype::disabled_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLOptGroupElementPrototype::label_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLOptGroupElementPrototype::label_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
