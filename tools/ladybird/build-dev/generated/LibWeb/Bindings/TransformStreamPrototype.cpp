...
GC_DEFINE_ALLOCATOR(TransformStreamPrototype);

TransformStreamPrototype::TransformStreamPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

TransformStreamPrototype::~TransformStreamPrototype()
{
}

void TransformStreamPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "TransformStream"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<Streams::TransformStream*> impl_from(JS::VM& vm)
{
    ...
    if (!is<Streams::TransformStream>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "TransformStream");
    return static_cast<Streams::TransformStream*>(this_object);
}
