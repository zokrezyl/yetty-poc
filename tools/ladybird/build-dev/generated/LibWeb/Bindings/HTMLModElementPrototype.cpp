...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLModElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLModElementPrototype);

HTMLModElementPrototype::HTMLModElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLModElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_cite_getter = JS::NativeFunction::create(realm, cite_getter, 0, "cite"_utf16_fly_string, &realm, "get"sv);

    auto native_cite_setter = JS::NativeFunction::create(realm, cite_setter, 1, "cite"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("cite"_utf16_fly_string, native_cite_getter, native_cite_setter, default_attributes);

    auto native_date_time_getter = JS::NativeFunction::create(realm, date_time_getter, 0, "dateTime"_utf16_fly_string, &realm, "get"sv);

    auto native_date_time_setter = JS::NativeFunction::create(realm, date_time_setter, 1, "dateTime"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("dateTime"_utf16_fly_string, native_date_time_getter, native_date_time_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLModElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLModElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLModElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLModElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLModElement");
    return static_cast<HTML::HTMLModElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLModElementPrototype::cite_getter)
{
    WebIDL::log_trace(vm, "HTMLModElementPrototype::cite_getter");
    ...
    auto content_attribute_value = impl->attribute("cite"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLModElementPrototype::cite_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("cite"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLModElementPrototype::date_time_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("datetime"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLModElementPrototype::date_time_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("datetime"_fly_string, cpp_value);
