...
GC_DEFINE_ALLOCATOR(HTMLHeadingElementPrototype);

HTMLHeadingElementPrototype::HTMLHeadingElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLHeadingElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLHeadingElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLHeadingElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLHeadingElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLHeadingElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLHeadingElement");
    return static_cast<HTML::HTMLHeadingElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLHeadingElementPrototype::align_getter)
{
    WebIDL::log_trace(vm, "HTMLHeadingElementPrototype::align_getter");
...
{
    WebIDL::log_trace(vm, "HTMLHeadingElementPrototype::align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
