...
GC_DEFINE_ALLOCATOR(DocumentTimelinePrototype);

DocumentTimelinePrototype::DocumentTimelinePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

DocumentTimelinePrototype::~DocumentTimelinePrototype()
{
}

void DocumentTimelinePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "DocumentTimeline"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void DocumentTimelinePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
