...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLHRElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLHRElementPrototype);

HTMLHRElementPrototype::HTMLHRElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLHRElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_color_getter = JS::NativeFunction::create(realm, color_getter, 0, "color"_utf16_fly_string, &realm, "get"sv);

    auto native_color_setter = JS::NativeFunction::create(realm, color_setter, 1, "color"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("color"_utf16_fly_string, native_color_getter, native_color_setter, default_attributes);

    auto native_no_shade_getter = JS::NativeFunction::create(realm, no_shade_getter, 0, "noShade"_utf16_fly_string, &realm, "get"sv);

    auto native_no_shade_setter = JS::NativeFunction::create(realm, no_shade_setter, 1, "noShade"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("noShade"_utf16_fly_string, native_no_shade_getter, native_no_shade_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLHRElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLHRElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLHRElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLHRElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLHRElement");
    return static_cast<HTML::HTMLHRElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLHRElementPrototype::align_getter)
{
    WebIDL::log_trace(vm, "HTMLHRElementPrototype::align_getter");
...
{
    WebIDL::log_trace(vm, "HTMLHRElementPrototype::align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLHRElementPrototype::color_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("color"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLHRElementPrototype::color_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("color"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLHRElementPrototype::no_shade_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval = impl->has_attribute("noshade"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLHRElementPrototype::no_shade_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value)
        impl->remove_attribute("noshade"_fly_string);
    else
        impl->set_attribute_value("noshade"_fly_string, String {});
...
{
    WebIDL::log_trace(vm, "HTMLHRElementPrototype::size_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("size"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLHRElementPrototype::size_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("size"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLHRElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLHRElementPrototype::width_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
