...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGFEOffsetElement.h>
...
GC_DEFINE_ALLOCATOR(SVGFEOffsetElementPrototype);

SVGFEOffsetElementPrototype::SVGFEOffsetElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGFEOffsetElementPrototype::~SVGFEOffsetElementPrototype()
{
}

void SVGFEOffsetElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGFEOffsetElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGFEOffsetElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGFEOffsetElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGFEOffsetElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGFEOffsetElement");
    return static_cast<SVG::SVGFEOffsetElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGFEOffsetElementPrototype::in1_getter)
{
    WebIDL::log_trace(vm, "SVGFEOffsetElementPrototype::in1_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEOffsetElementPrototype::dx_getter)
{
    WebIDL::log_trace(vm, "SVGFEOffsetElementPrototype::dx_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEOffsetElementPrototype::dy_getter)
{
    WebIDL::log_trace(vm, "SVGFEOffsetElementPrototype::dy_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEOffsetElementPrototype::x_getter)
{
    WebIDL::log_trace(vm, "SVGFEOffsetElementPrototype::x_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEOffsetElementPrototype::y_getter)
{
    WebIDL::log_trace(vm, "SVGFEOffsetElementPrototype::y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEOffsetElementPrototype::width_getter)
{
    WebIDL::log_trace(vm, "SVGFEOffsetElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEOffsetElementPrototype::height_getter)
{
    WebIDL::log_trace(vm, "SVGFEOffsetElementPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEOffsetElementPrototype::result_getter)
{
    WebIDL::log_trace(vm, "SVGFEOffsetElementPrototype::result_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
