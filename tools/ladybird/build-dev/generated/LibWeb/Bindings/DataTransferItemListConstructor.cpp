...
GC_DEFINE_ALLOCATOR(DataTransferItemListConstructor);

DataTransferItemListConstructor::DataTransferItemListConstructor(JS::Realm& realm)
    : NativeFunction("DataTransferItemList"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

DataTransferItemListConstructor::~DataTransferItemListConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> DataTransferItemListConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "DataTransferItemList");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> DataTransferItemListConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "DataTransferItemListConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "DataTransferItemList");
}


void DataTransferItemListConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "DataTransferItemList"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<DataTransferItemListPrototype>(realm, "DataTransferItemList"_fly_string), 0);
