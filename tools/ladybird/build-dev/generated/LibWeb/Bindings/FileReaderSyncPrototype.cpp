...
GC_DEFINE_ALLOCATOR(FileReaderSyncPrototype);

FileReaderSyncPrototype::FileReaderSyncPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

FileReaderSyncPrototype::~FileReaderSyncPrototype()
{
}

void FileReaderSyncPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "FileReaderSync"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void FileReaderSyncPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<FileAPI::FileReaderSync*> impl_from(JS::VM& vm)
{
    ...
    if (!is<FileAPI::FileReaderSync>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "FileReaderSync");
    return static_cast<FileAPI::FileReaderSync*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(FileReaderSyncPrototype::read_as_array_buffer)
{
    WebIDL::log_trace(vm, "FileReaderSyncPrototype::read_as_array_buffer");
...
JS_DEFINE_NATIVE_FUNCTION(FileReaderSyncPrototype::read_as_text)
{
    WebIDL::log_trace(vm, "FileReaderSyncPrototype::read_as_text");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(FileReaderSyncPrototype::read_as_binary_string)
{
    WebIDL::log_trace(vm, "FileReaderSyncPrototype::read_as_binary_string");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(FileReaderSyncPrototype::read_as_data_url)
{
    WebIDL::log_trace(vm, "FileReaderSyncPrototype::read_as_data_url");
    [[maybe_unused]] auto& realm = *vm.current_realm();
