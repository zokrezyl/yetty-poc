...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGRadialGradientElement.h>
...
GC_DEFINE_ALLOCATOR(SVGRadialGradientElementPrototype);

SVGRadialGradientElementPrototype::SVGRadialGradientElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGRadialGradientElementPrototype::~SVGRadialGradientElementPrototype()
{
}

void SVGRadialGradientElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_cx_getter = JS::NativeFunction::create(realm, cx_getter, 0, "cx"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_cx_setter;

    define_direct_accessor("cx"_utf16_fly_string, native_cx_getter, native_cx_setter, default_attributes);

    auto native_cy_getter = JS::NativeFunction::create(realm, cy_getter, 0, "cy"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_cy_setter;

    define_direct_accessor("cy"_utf16_fly_string, native_cy_getter, native_cy_setter, default_attributes);

    auto native_r_getter = JS::NativeFunction::create(realm, r_getter, 0, "r"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_r_setter;

    define_direct_accessor("r"_utf16_fly_string, native_r_getter, native_r_setter, default_attributes);

    auto native_fx_getter = JS::NativeFunction::create(realm, fx_getter, 0, "fx"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_fx_setter;

    define_direct_accessor("fx"_utf16_fly_string, native_fx_getter, native_fx_setter, default_attributes);

    auto native_fy_getter = JS::NativeFunction::create(realm, fy_getter, 0, "fy"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_fy_setter;

    define_direct_accessor("fy"_utf16_fly_string, native_fy_getter, native_fy_setter, default_attributes);

    auto native_fr_getter = JS::NativeFunction::create(realm, fr_getter, 0, "fr"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_fr_setter;

    define_direct_accessor("fr"_utf16_fly_string, native_fr_getter, native_fr_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGRadialGradientElement"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGRadialGradientElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGRadialGradientElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGRadialGradientElement");
    return static_cast<SVG::SVGRadialGradientElement*>(this_object);
}
...
JS_DEFINE_NATIVE_FUNCTION(SVGRadialGradientElementPrototype::cx_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->cx(); }));
...
JS_DEFINE_NATIVE_FUNCTION(SVGRadialGradientElementPrototype::cy_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->cy(); }));
...
JS_DEFINE_NATIVE_FUNCTION(SVGRadialGradientElementPrototype::r_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->r(); }));
...
JS_DEFINE_NATIVE_FUNCTION(SVGRadialGradientElementPrototype::fx_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->fx(); }));
...
JS_DEFINE_NATIVE_FUNCTION(SVGRadialGradientElementPrototype::fy_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->fy(); }));
...
JS_DEFINE_NATIVE_FUNCTION(SVGRadialGradientElementPrototype::fr_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->fr(); }));
