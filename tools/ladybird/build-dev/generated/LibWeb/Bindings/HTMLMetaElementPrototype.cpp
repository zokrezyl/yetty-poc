...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLMetaElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLMetaElementPrototype);

HTMLMetaElementPrototype::HTMLMetaElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLMetaElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_http_equiv_getter = JS::NativeFunction::create(realm, http_equiv_getter, 0, "httpEquiv"_utf16_fly_string, &realm, "get"sv);

    auto native_http_equiv_setter = JS::NativeFunction::create(realm, http_equiv_setter, 1, "httpEquiv"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("httpEquiv"_utf16_fly_string, native_http_equiv_getter, native_http_equiv_setter, default_attributes);

    auto native_content_getter = JS::NativeFunction::create(realm, content_getter, 0, "content"_utf16_fly_string, &realm, "get"sv);

    auto native_content_setter = JS::NativeFunction::create(realm, content_setter, 1, "content"_utf16_fly_string, &realm, "set"sv);
    ...
    auto native_scheme_getter = JS::NativeFunction::create(realm, scheme_getter, 0, "scheme"_utf16_fly_string, &realm, "get"sv);

    auto native_scheme_setter = JS::NativeFunction::create(realm, scheme_setter, 1, "scheme"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("scheme"_utf16_fly_string, native_scheme_getter, native_scheme_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLMetaElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLMetaElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLMetaElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLMetaElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLMetaElement");
    return static_cast<HTML::HTMLMetaElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLMetaElementPrototype::name_getter)
{
    WebIDL::log_trace(vm, "HTMLMetaElementPrototype::name_getter");
...
{
    WebIDL::log_trace(vm, "HTMLMetaElementPrototype::name_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLMetaElementPrototype::http_equiv_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("http-equiv"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLMetaElementPrototype::http_equiv_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("http-equiv"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLMetaElementPrototype::content_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("content"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLMetaElementPrototype::content_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("content"_fly_string, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMetaElementPrototype::media_getter)
{
    WebIDL::log_trace(vm, "HTMLMetaElementPrototype::media_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("media"_fly_string);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMetaElementPrototype::media_setter)
{
    WebIDL::log_trace(vm, "HTMLMetaElementPrototype::media_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("media"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLMetaElementPrototype::scheme_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("scheme"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLMetaElementPrototype::scheme_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("scheme"_fly_string, cpp_value);
