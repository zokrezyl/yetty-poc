...
GC_DEFINE_ALLOCATOR(CSSNamespaceRulePrototype);

CSSNamespaceRulePrototype::CSSNamespaceRulePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CSSNamespaceRulePrototype::~CSSNamespaceRulePrototype()
{
}

void CSSNamespaceRulePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSNamespaceRule"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSNamespaceRulePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSNamespaceRule*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSNamespaceRule>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSNamespaceRule");
    return static_cast<CSS::CSSNamespaceRule*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSNamespaceRulePrototype::namespace_uri_getter)
{
    WebIDL::log_trace(vm, "CSSNamespaceRulePrototype::namespace_uri_getter");
...
JS_DEFINE_NATIVE_FUNCTION(CSSNamespaceRulePrototype::prefix_getter)
{
    WebIDL::log_trace(vm, "CSSNamespaceRulePrototype::prefix_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
