...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/CSS/CSSConditionRule.h>
...
GC_DEFINE_ALLOCATOR(CSSConditionRulePrototype);

CSSConditionRulePrototype::CSSConditionRulePrototype([[maybe_unused]] JS::Realm& realm)
...
void CSSConditionRulePrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_condition_text_getter = JS::NativeFunction::create(realm, condition_text_getter, 0, "conditionText"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_condition_text_setter;

    define_direct_accessor("conditionText"_utf16_fly_string, native_condition_text_getter, native_condition_text_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSConditionRule"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSConditionRulePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSConditionRule*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSConditionRule>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSConditionRule");
    return static_cast<CSS::CSSConditionRule*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSConditionRulePrototype::condition_text_getter)
{
    WebIDL::log_trace(vm, "CSSConditionRulePrototype::condition_text_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->condition_text(); }));
