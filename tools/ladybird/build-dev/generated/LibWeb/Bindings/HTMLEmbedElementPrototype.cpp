...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLEmbedElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLEmbedElementPrototype);

HTMLEmbedElementPrototype::HTMLEmbedElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLEmbedElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_accessor("name"_utf16_fly_string, native_name_getter, native_name_setter, default_attributes);
        ...
        define_direct_property("getSVGDocument"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLEmbedElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLEmbedElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLEmbedElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLEmbedElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLEmbedElement");
    return static_cast<HTML::HTMLEmbedElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLEmbedElementPrototype::src_getter)
{
    WebIDL::log_trace(vm, "HTMLEmbedElementPrototype::src_getter");
...
{
    WebIDL::log_trace(vm, "HTMLEmbedElementPrototype::src_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLEmbedElementPrototype::type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLEmbedElementPrototype::type_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLEmbedElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLEmbedElementPrototype::width_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLEmbedElementPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLEmbedElementPrototype::height_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLEmbedElementPrototype::align_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLEmbedElementPrototype::align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLEmbedElementPrototype::name_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLEmbedElementPrototype::name_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
