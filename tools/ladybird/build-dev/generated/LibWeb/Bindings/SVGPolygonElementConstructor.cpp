...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGPolygonElement.h>
...
GC_DEFINE_ALLOCATOR(SVGPolygonElementConstructor);

SVGPolygonElementConstructor::SVGPolygonElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGPolygonElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}
...
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGPolygonElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGPolygonElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGPolygonElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGPolygonElement");
}


void SVGPolygonElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGPolygonElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGPolygonElementPrototype>(realm, "SVGPolygonElement"_fly_string), 0);
