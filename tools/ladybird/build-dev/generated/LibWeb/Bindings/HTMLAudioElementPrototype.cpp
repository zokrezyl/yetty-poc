...
GC_DEFINE_ALLOCATOR(HTMLAudioElementPrototype);

HTMLAudioElementPrototype::HTMLAudioElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLAudioElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLAudioElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLAudioElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
