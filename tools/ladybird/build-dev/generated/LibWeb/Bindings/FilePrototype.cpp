...
GC_DEFINE_ALLOCATOR(FilePrototype);

FilePrototype::FilePrototype([[maybe_unused]] JS::Realm& realm)
...
void FilePrototype::initialize(JS::Realm& realm)
{
    ...
    set_prototype(&ensure_web_prototype<BlobPrototype>(realm, "Blob"_fly_string));
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "File"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void FilePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<FileAPI::File*> impl_from(JS::VM& vm)
{
    ...
    if (!is<FileAPI::File>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "File");
    return static_cast<FileAPI::File*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(FilePrototype::name_getter)
{
    WebIDL::log_trace(vm, "FilePrototype::name_getter");
...
JS_DEFINE_NATIVE_FUNCTION(FilePrototype::last_modified_getter)
{
    WebIDL::log_trace(vm, "FilePrototype::last_modified_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
