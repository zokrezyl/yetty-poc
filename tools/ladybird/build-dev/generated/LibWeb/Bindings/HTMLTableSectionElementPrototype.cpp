...
GC_DEFINE_ALLOCATOR(HTMLTableSectionElementPrototype);

HTMLTableSectionElementPrototype::HTMLTableSectionElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLTableSectionElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLTableSectionElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLTableSectionElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLTableSectionElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLTableSectionElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLTableSectionElement");
    return static_cast<HTML::HTMLTableSectionElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLTableSectionElementPrototype::rows_getter)
{
    WebIDL::log_trace(vm, "HTMLTableSectionElementPrototype::rows_getter");
...
{
    WebIDL::log_trace(vm, "HTMLTableSectionElementPrototype::align_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableSectionElementPrototype::align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableSectionElementPrototype::ch_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableSectionElementPrototype::ch_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableSectionElementPrototype::ch_off_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableSectionElementPrototype::ch_off_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableSectionElementPrototype::v_align_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableSectionElementPrototype::v_align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableSectionElementPrototype::insert_row");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableSectionElementPrototype::delete_row");
    [[maybe_unused]] auto& realm = *vm.current_realm();
