...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGEllipseElement.h>
...
GC_DEFINE_ALLOCATOR(SVGEllipseElementPrototype);

SVGEllipseElementPrototype::SVGEllipseElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void SVGEllipseElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGEllipseElement"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGEllipseElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGEllipseElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGEllipseElement");
    return static_cast<SVG::SVGEllipseElement*>(this_object);
}
