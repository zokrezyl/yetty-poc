...
GC_DEFINE_ALLOCATOR(SVGImageElementPrototype);

SVGImageElementPrototype::SVGImageElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGImageElementPrototype::~SVGImageElementPrototype()
{
}

void SVGImageElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGImageElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGImageElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGImageElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGImageElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGImageElement");
    return static_cast<SVG::SVGImageElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGImageElementPrototype::x_getter)
{
    WebIDL::log_trace(vm, "SVGImageElementPrototype::x_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SVGImageElementPrototype::y_getter)
{
    WebIDL::log_trace(vm, "SVGImageElementPrototype::y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGImageElementPrototype::width_getter)
{
    WebIDL::log_trace(vm, "SVGImageElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGImageElementPrototype::height_getter)
{
    WebIDL::log_trace(vm, "SVGImageElementPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGImageElementPrototype::cross_origin_getter)
{
    WebIDL::log_trace(vm, "SVGImageElementPrototype::cross_origin_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGImageElementPrototype::cross_origin_setter)
{
    WebIDL::log_trace(vm, "SVGImageElementPrototype::cross_origin_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGImageElementPrototype::href_getter)
{
    WebIDL::log_trace(vm, "SVGImageElementPrototype::href_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
