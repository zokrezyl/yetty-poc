...
GC_DEFINE_ALLOCATOR(WritableStreamDefaultWriterPrototype);

WritableStreamDefaultWriterPrototype::WritableStreamDefaultWriterPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

WritableStreamDefaultWriterPrototype::~WritableStreamDefaultWriterPrototype()
{
}

void WritableStreamDefaultWriterPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "WritableStreamDefaultWriter"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<Streams::WritableStreamDefaultWriter*> impl_from(JS::VM& vm)
{
    ...
    if (!is<Streams::WritableStreamDefaultWriter>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "WritableStreamDefaultWriter");
    return static_cast<Streams::WritableStreamDefaultWriter*>(this_object);
}
...
JS_DEFINE_NATIVE_FUNCTION(WritableStreamDefaultWriterPrototype::write)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->write(chunk); }));
