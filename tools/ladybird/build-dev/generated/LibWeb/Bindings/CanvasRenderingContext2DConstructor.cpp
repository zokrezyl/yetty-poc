...
GC_DEFINE_ALLOCATOR(CanvasRenderingContext2DConstructor);

CanvasRenderingContext2DConstructor::CanvasRenderingContext2DConstructor(JS::Realm& realm)
    : NativeFunction("CanvasRenderingContext2D"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}
...
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "CanvasRenderingContext2D");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> CanvasRenderingContext2DConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "CanvasRenderingContext2DConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "CanvasRenderingContext2D");
}


void CanvasRenderingContext2DConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "CanvasRenderingContext2D"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<CanvasRenderingContext2DPrototype>(realm, "CanvasRenderingContext2D"_fly_string), 0);
