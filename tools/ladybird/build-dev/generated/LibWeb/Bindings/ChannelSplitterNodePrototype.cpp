...
GC_DEFINE_ALLOCATOR(ChannelSplitterNodePrototype);

ChannelSplitterNodePrototype::ChannelSplitterNodePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

ChannelSplitterNodePrototype::~ChannelSplitterNodePrototype()
{
}

void ChannelSplitterNodePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "ChannelSplitterNode"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void ChannelSplitterNodePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
