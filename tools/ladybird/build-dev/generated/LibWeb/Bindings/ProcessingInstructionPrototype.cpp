...
GC_DEFINE_ALLOCATOR(ProcessingInstructionPrototype);

ProcessingInstructionPrototype::ProcessingInstructionPrototype([[maybe_unused]] JS::Realm& realm)
...
void ProcessingInstructionPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "ProcessingInstruction"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void ProcessingInstructionPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<DOM::ProcessingInstruction*> impl_from(JS::VM& vm)
{
    ...
    if (!is<DOM::ProcessingInstruction>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "ProcessingInstruction");
    return static_cast<DOM::ProcessingInstruction*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(ProcessingInstructionPrototype::target_getter)
{
    WebIDL::log_trace(vm, "ProcessingInstructionPrototype::target_getter");
