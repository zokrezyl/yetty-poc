...
GC_DEFINE_ALLOCATOR(HTMLOptionElementPrototype);

HTMLOptionElementPrototype::HTMLOptionElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLOptionElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_label_getter = JS::NativeFunction::create(realm, label_getter, 0, "label"_utf16_fly_string, &realm, "get"sv);

    auto native_label_setter = JS::NativeFunction::create(realm, label_setter, 1, "label"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("label"_utf16_fly_string, native_label_getter, native_label_setter, default_attributes);

    auto native_default_selected_getter = JS::NativeFunction::create(realm, default_selected_getter, 0, "defaultSelected"_utf16_fly_string, &realm, "get"sv);

    auto native_default_selected_setter = JS::NativeFunction::create(realm, default_selected_setter, 1, "defaultSelected"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("defaultSelected"_utf16_fly_string, native_default_selected_getter, native_default_selected_setter, default_attributes);

    auto native_selected_getter = JS::NativeFunction::create(realm, selected_getter, 0, "selected"_utf16_fly_string, &realm, "get"sv);

    auto native_selected_setter = JS::NativeFunction::create(realm, selected_setter, 1, "selected"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("selected"_utf16_fly_string, native_selected_getter, native_selected_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLOptionElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLOptionElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLOptionElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLOptionElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLOptionElement");
    return static_cast<HTML::HTMLOptionElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLOptionElementPrototype::disabled_getter)
{
    WebIDL::log_trace(vm, "HTMLOptionElementPrototype::disabled_getter");
...
{
    WebIDL::log_trace(vm, "HTMLOptionElementPrototype::disabled_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOptionElementPrototype::form_getter)
{
    WebIDL::log_trace(vm, "HTMLOptionElementPrototype::form_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOptionElementPrototype::label_getter)
{
    WebIDL::log_trace(vm, "HTMLOptionElementPrototype::label_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->label(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOptionElementPrototype::label_setter)
{
    WebIDL::log_trace(vm, "HTMLOptionElementPrototype::label_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_label(cpp_value); });
...
{
    WebIDL::log_trace(vm, "HTMLOptionElementPrototype::default_selected_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval = impl->has_attribute("selected"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLOptionElementPrototype::default_selected_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value)
        impl->remove_attribute("selected"_fly_string);
    else
        impl->set_attribute_value("selected"_fly_string, String {});
...
{
    WebIDL::log_trace(vm, "HTMLOptionElementPrototype::selected_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->selected(); }));
...
{
    WebIDL::log_trace(vm, "HTMLOptionElementPrototype::selected_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_selected(cpp_value); }));
...
{
    WebIDL::log_trace(vm, "HTMLOptionElementPrototype::value_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLOptionElementPrototype::value_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLOptionElementPrototype::text_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLOptionElementPrototype::text_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLOptionElementPrototype::index_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
