...
GC_DEFINE_ALLOCATOR(CSSFontFaceRulePrototype);

CSSFontFaceRulePrototype::CSSFontFaceRulePrototype([[maybe_unused]] JS::Realm& realm)
...
void CSSFontFaceRulePrototype::initialize(JS::Realm& realm)
{
    ...
    GC::Ptr<JS::NativeFunction> native_style_setter;

    define_direct_accessor("style"_utf16_fly_string, native_style_getter, native_style_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSFontFaceRule"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSFontFaceRulePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSFontFaceRule*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSFontFaceRule>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSFontFaceRule");
    return static_cast<CSS::CSSFontFaceRule*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSFontFaceRulePrototype::style_getter)
{
    WebIDL::log_trace(vm, "CSSFontFaceRulePrototype::style_getter");
    ...
    return &const_cast<CSSStyleDeclaration&>(*retval);
