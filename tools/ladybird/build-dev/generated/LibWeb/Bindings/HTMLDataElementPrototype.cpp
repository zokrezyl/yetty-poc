...
GC_DEFINE_ALLOCATOR(HTMLDataElementPrototype);

HTMLDataElementPrototype::HTMLDataElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLDataElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLDataElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLDataElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLDataElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLDataElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLDataElement");
    return static_cast<HTML::HTMLDataElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLDataElementPrototype::value_getter)
{
    WebIDL::log_trace(vm, "HTMLDataElementPrototype::value_getter");
...
{
    WebIDL::log_trace(vm, "HTMLDataElementPrototype::value_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
