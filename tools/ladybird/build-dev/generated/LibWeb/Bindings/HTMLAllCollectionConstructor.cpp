...
GC_DEFINE_ALLOCATOR(HTMLAllCollectionConstructor);

HTMLAllCollectionConstructor::HTMLAllCollectionConstructor(JS::Realm& realm)
    : NativeFunction("HTMLAllCollection"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

HTMLAllCollectionConstructor::~HTMLAllCollectionConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> HTMLAllCollectionConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "HTMLAllCollection");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> HTMLAllCollectionConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "HTMLAllCollectionConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "HTMLAllCollection");
}


void HTMLAllCollectionConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "HTMLAllCollection"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<HTMLAllCollectionPrototype>(realm, "HTMLAllCollection"_fly_string), 0);
