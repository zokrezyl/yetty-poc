...
GC_DEFINE_ALLOCATOR(SVGPolygonElementPrototype);

SVGPolygonElementPrototype::SVGPolygonElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void SVGPolygonElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGPolygonElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGPolygonElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
