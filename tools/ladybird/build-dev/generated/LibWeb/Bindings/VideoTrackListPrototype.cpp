...
GC_DEFINE_ALLOCATOR(VideoTrackListPrototype);

VideoTrackListPrototype::VideoTrackListPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

VideoTrackListPrototype::~VideoTrackListPrototype()
{
}

void VideoTrackListPrototype::initialize(JS::Realm& realm)
{
    ...
    GC::Ptr<JS::NativeFunction> native_selected_index_setter;
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "VideoTrackList"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void VideoTrackListPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::VideoTrackList*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::VideoTrackList>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "VideoTrackList");
    return static_cast<HTML::VideoTrackList*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(VideoTrackListPrototype::length_getter)
{
    WebIDL::log_trace(vm, "VideoTrackListPrototype::length_getter");
...
JS_DEFINE_NATIVE_FUNCTION(VideoTrackListPrototype::selected_index_getter)
{
    WebIDL::log_trace(vm, "VideoTrackListPrototype::selected_index_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(VideoTrackListPrototype::onchange_getter)
{
    WebIDL::log_trace(vm, "VideoTrackListPrototype::onchange_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(VideoTrackListPrototype::onchange_setter)
{
    WebIDL::log_trace(vm, "VideoTrackListPrototype::onchange_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(VideoTrackListPrototype::onaddtrack_getter)
{
    WebIDL::log_trace(vm, "VideoTrackListPrototype::onaddtrack_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(VideoTrackListPrototype::onaddtrack_setter)
{
    WebIDL::log_trace(vm, "VideoTrackListPrototype::onaddtrack_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(VideoTrackListPrototype::onremovetrack_getter)
{
    WebIDL::log_trace(vm, "VideoTrackListPrototype::onremovetrack_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(VideoTrackListPrototype::onremovetrack_setter)
{
    WebIDL::log_trace(vm, "VideoTrackListPrototype::onremovetrack_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(VideoTrackListPrototype::get_track_by_id)
{
    WebIDL::log_trace(vm, "VideoTrackListPrototype::get_track_by_id");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    return &const_cast<VideoTrack&>(*retval);
