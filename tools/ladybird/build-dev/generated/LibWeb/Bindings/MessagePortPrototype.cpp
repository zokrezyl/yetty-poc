...
GC_DEFINE_ALLOCATOR(MessagePortPrototype);

MessagePortPrototype::MessagePortPrototype([[maybe_unused]] JS::Realm& realm)
...
void MessagePortPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "MessagePort"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void MessagePortPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::MessagePort*> impl_from(JS::VM& vm)
{
...
{
    WebIDL::log_trace(vm, "MessagePortPrototype::onmessage_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "MessagePortPrototype::onmessageerror_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "MessagePortPrototype::onmessageerror_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(MessagePortPrototype::post_message0)
{
    WebIDL::log_trace(vm, "MessagePortPrototype::post_message0");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(MessagePortPrototype::post_message1)
{
    WebIDL::log_trace(vm, "MessagePortPrototype::post_message1");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "MessagePortPrototype::start");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    auto* impl = TRY(impl_from(vm));

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->start(); }));
...
{
    WebIDL::log_trace(vm, "MessagePortPrototype::close");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "MessagePortPrototype::post_message");
