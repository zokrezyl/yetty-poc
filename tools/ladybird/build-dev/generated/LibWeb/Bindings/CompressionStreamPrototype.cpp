...
GC_DEFINE_ALLOCATOR(CompressionStreamPrototype);

CompressionStreamPrototype::CompressionStreamPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

CompressionStreamPrototype::~CompressionStreamPrototype()
{
}

void CompressionStreamPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CompressionStream"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CompressionStreamPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<Compression::CompressionStream*> impl_from(JS::VM& vm)
{
    ...
    if (!is<Compression::CompressionStream>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CompressionStream");
    return static_cast<Compression::CompressionStream*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CompressionStreamPrototype::readable_getter)
{
    WebIDL::log_trace(vm, "CompressionStreamPrototype::readable_getter");
...
JS_DEFINE_NATIVE_FUNCTION(CompressionStreamPrototype::writable_getter)
{
    WebIDL::log_trace(vm, "CompressionStreamPrototype::writable_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
