...
GC_DEFINE_ALLOCATOR(SVGTextContentElementConstructor);

SVGTextContentElementConstructor::SVGTextContentElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGTextContentElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}
...
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGTextContentElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGTextContentElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGTextContentElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGTextContentElement");
}


void SVGTextContentElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    set_prototype(&ensure_web_constructor<SVGGraphicsElementPrototype>(realm, "SVGGraphicsElement"_fly_string));

    define_direct_property(vm.names.length, JS::Value(0), JS::Attribute::Configurable);
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGTextContentElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGTextContentElementPrototype>(realm, "SVGTextContentElement"_fly_string), 0);
