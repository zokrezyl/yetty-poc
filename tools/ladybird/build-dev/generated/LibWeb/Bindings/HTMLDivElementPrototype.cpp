...
GC_DEFINE_ALLOCATOR(HTMLDivElementPrototype);

HTMLDivElementPrototype::HTMLDivElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLDivElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLDivElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLDivElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLDivElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLDivElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLDivElement");
    return static_cast<HTML::HTMLDivElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLDivElementPrototype::align_getter)
{
    WebIDL::log_trace(vm, "HTMLDivElementPrototype::align_getter");
...
{
    WebIDL::log_trace(vm, "HTMLDivElementPrototype::align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
