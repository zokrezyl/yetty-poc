...
GC_DEFINE_ALLOCATOR(HTMLDirectoryElementPrototype);

HTMLDirectoryElementPrototype::HTMLDirectoryElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLDirectoryElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLDirectoryElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLDirectoryElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLDirectoryElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLDirectoryElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLDirectoryElement");
    return static_cast<HTML::HTMLDirectoryElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLDirectoryElementPrototype::compact_getter)
{
    WebIDL::log_trace(vm, "HTMLDirectoryElementPrototype::compact_getter");
...
{
    WebIDL::log_trace(vm, "HTMLDirectoryElementPrototype::compact_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
