...
GC_DEFINE_ALLOCATOR(DOMMatrixReadOnlyConstructor);

DOMMatrixReadOnlyConstructor::DOMMatrixReadOnlyConstructor(JS::Realm& realm)
    : NativeFunction("DOMMatrixReadOnly"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

DOMMatrixReadOnlyConstructor::~DOMMatrixReadOnlyConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> DOMMatrixReadOnlyConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "DOMMatrixReadOnly");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> DOMMatrixReadOnlyConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "DOMMatrixReadOnlyConstructor::construct");
...
void DOMMatrixReadOnlyConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "DOMMatrixReadOnly"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<DOMMatrixReadOnlyPrototype>(realm, "DOMMatrixReadOnly"_fly_string), 0);
...
JS_DEFINE_NATIVE_FUNCTION(DOMMatrixReadOnlyConstructor::from_matrix)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return Geometry::DOMMatrixReadOnly::from_matrix(vm, other); }));

    return &const_cast<DOMMatrixReadOnly&>(*retval);
...
JS_DEFINE_NATIVE_FUNCTION(DOMMatrixReadOnlyConstructor::from_float32_array)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return Geometry::DOMMatrixReadOnly::from_float32_array(vm, array32); }));
...
JS_DEFINE_NATIVE_FUNCTION(DOMMatrixReadOnlyConstructor::from_float64_array)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return Geometry::DOMMatrixReadOnly::from_float64_array(vm, array64); }));
