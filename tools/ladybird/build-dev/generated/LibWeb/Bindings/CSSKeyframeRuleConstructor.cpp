...
GC_DEFINE_ALLOCATOR(CSSKeyframeRuleConstructor);

CSSKeyframeRuleConstructor::CSSKeyframeRuleConstructor(JS::Realm& realm)
    : NativeFunction("CSSKeyframeRule"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

CSSKeyframeRuleConstructor::~CSSKeyframeRuleConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> CSSKeyframeRuleConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "CSSKeyframeRule");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> CSSKeyframeRuleConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "CSSKeyframeRuleConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "CSSKeyframeRule");
}


void CSSKeyframeRuleConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "CSSKeyframeRule"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<CSSKeyframeRulePrototype>(realm, "CSSKeyframeRule"_fly_string), 0);
