...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGFEFuncRElement.h>
...
GC_DEFINE_ALLOCATOR(SVGFEFuncRElementConstructor);

SVGFEFuncRElementConstructor::SVGFEFuncRElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGFEFuncRElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGFEFuncRElementConstructor::~SVGFEFuncRElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGFEFuncRElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGFEFuncRElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGFEFuncRElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGFEFuncRElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGFEFuncRElement");
}


void SVGFEFuncRElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGFEFuncRElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGFEFuncRElementPrototype>(realm, "SVGFEFuncRElement"_fly_string), 0);
