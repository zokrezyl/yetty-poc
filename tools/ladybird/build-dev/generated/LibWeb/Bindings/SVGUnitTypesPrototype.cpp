...
GC_DEFINE_ALLOCATOR(SVGUnitTypesPrototype);

SVGUnitTypesPrototype::SVGUnitTypesPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

SVGUnitTypesPrototype::~SVGUnitTypesPrototype()
{
}

void SVGUnitTypesPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGUnitTypes"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGUnitTypesPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
