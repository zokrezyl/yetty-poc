...
GC_DEFINE_ALLOCATOR(SVGAnimatedLengthPrototype);

SVGAnimatedLengthPrototype::SVGAnimatedLengthPrototype([[maybe_unused]] JS::Realm& realm)
...
void SVGAnimatedLengthPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGAnimatedLength"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGAnimatedLengthPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGAnimatedLength*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGAnimatedLength>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGAnimatedLength");
    return static_cast<SVG::SVGAnimatedLength*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGAnimatedLengthPrototype::base_val_getter)
{
    WebIDL::log_trace(vm, "SVGAnimatedLengthPrototype::base_val_getter");
...
{
    WebIDL::log_trace(vm, "SVGAnimatedLengthPrototype::anim_val_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
