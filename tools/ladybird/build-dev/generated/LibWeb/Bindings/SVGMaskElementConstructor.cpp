...
GC_DEFINE_ALLOCATOR(SVGMaskElementConstructor);

SVGMaskElementConstructor::SVGMaskElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGMaskElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGMaskElementConstructor::~SVGMaskElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGMaskElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGMaskElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGMaskElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGMaskElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGMaskElement");
}


void SVGMaskElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGMaskElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGMaskElementPrototype>(realm, "SVGMaskElement"_fly_string), 0);
