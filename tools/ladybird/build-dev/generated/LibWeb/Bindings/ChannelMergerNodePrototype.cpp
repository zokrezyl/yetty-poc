...
GC_DEFINE_ALLOCATOR(ChannelMergerNodePrototype);

ChannelMergerNodePrototype::ChannelMergerNodePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

ChannelMergerNodePrototype::~ChannelMergerNodePrototype()
{
}

void ChannelMergerNodePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "ChannelMergerNode"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void ChannelMergerNodePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
