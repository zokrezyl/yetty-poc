...
GC_DEFINE_ALLOCATOR(SVGMetadataElementPrototype);

SVGMetadataElementPrototype::SVGMetadataElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGMetadataElementPrototype::~SVGMetadataElementPrototype()
{
}

void SVGMetadataElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGMetadataElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGMetadataElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
