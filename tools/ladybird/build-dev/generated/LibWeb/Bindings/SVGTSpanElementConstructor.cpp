...
#if __has_include(<LibWeb/Bindings/SVGTextPositioningElementPrototype.h>)
#    include <LibWeb/Bindings/SVGTextPositioningElementPrototype.h>
#endif


#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGTSpanElement.h>
...
GC_DEFINE_ALLOCATOR(SVGTSpanElementConstructor);

SVGTSpanElementConstructor::SVGTSpanElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGTSpanElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGTSpanElementConstructor::~SVGTSpanElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGTSpanElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGTSpanElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGTSpanElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGTSpanElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGTSpanElement");
}


void SVGTSpanElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    set_prototype(&ensure_web_constructor<SVGTextPositioningElementPrototype>(realm, "SVGTextPositioningElement"_fly_string));

    define_direct_property(vm.names.length, JS::Value(0), JS::Attribute::Configurable);
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGTSpanElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGTSpanElementPrototype>(realm, "SVGTSpanElement"_fly_string), 0);
