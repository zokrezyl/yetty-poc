...
GC_DEFINE_ALLOCATOR(MediaQueryListEventPrototype);

MediaQueryListEventPrototype::MediaQueryListEventPrototype([[maybe_unused]] JS::Realm& realm)
...
void MediaQueryListEventPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "MediaQueryListEvent"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void MediaQueryListEventPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::MediaQueryListEvent*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::MediaQueryListEvent>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "MediaQueryListEvent");
    return static_cast<CSS::MediaQueryListEvent*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(MediaQueryListEventPrototype::media_getter)
{
    WebIDL::log_trace(vm, "MediaQueryListEventPrototype::media_getter");
...
{
    WebIDL::log_trace(vm, "MediaQueryListEventPrototype::matches_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
