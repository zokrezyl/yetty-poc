...
GC_DEFINE_ALLOCATOR(CSSLayerStatementRuleConstructor);

CSSLayerStatementRuleConstructor::CSSLayerStatementRuleConstructor(JS::Realm& realm)
    : NativeFunction("CSSLayerStatementRule"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

CSSLayerStatementRuleConstructor::~CSSLayerStatementRuleConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> CSSLayerStatementRuleConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "CSSLayerStatementRule");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> CSSLayerStatementRuleConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "CSSLayerStatementRuleConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "CSSLayerStatementRule");
}


void CSSLayerStatementRuleConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "CSSLayerStatementRule"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<CSSLayerStatementRulePrototype>(realm, "CSSLayerStatementRule"_fly_string), 0);
