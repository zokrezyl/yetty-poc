...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGScriptElement.h>
...
GC_DEFINE_ALLOCATOR(SVGScriptElementPrototype);

SVGScriptElementPrototype::SVGScriptElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGScriptElementPrototype::~SVGScriptElementPrototype()
{
}

void SVGScriptElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGScriptElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGScriptElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGScriptElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGScriptElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGScriptElement");
    return static_cast<SVG::SVGScriptElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGScriptElementPrototype::type_getter)
{
    WebIDL::log_trace(vm, "SVGScriptElementPrototype::type_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SVGScriptElementPrototype::type_setter)
{
    WebIDL::log_trace(vm, "SVGScriptElementPrototype::type_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGScriptElementPrototype::cross_origin_getter)
{
    WebIDL::log_trace(vm, "SVGScriptElementPrototype::cross_origin_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGScriptElementPrototype::cross_origin_setter)
{
    WebIDL::log_trace(vm, "SVGScriptElementPrototype::cross_origin_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGScriptElementPrototype::href_getter)
{
    WebIDL::log_trace(vm, "SVGScriptElementPrototype::href_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
