...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/CSS/CSSMediaRule.h>
...
GC_DEFINE_ALLOCATOR(CSSMediaRulePrototype);

CSSMediaRulePrototype::CSSMediaRulePrototype([[maybe_unused]] JS::Realm& realm)
...
void CSSMediaRulePrototype::initialize(JS::Realm& realm)
{
    ...
    set_prototype(&ensure_web_prototype<CSSConditionRulePrototype>(realm, "CSSConditionRule"_fly_string));
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSMediaRule"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSMediaRulePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSMediaRule*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSMediaRule>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSMediaRule");
    return static_cast<CSS::CSSMediaRule*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSMediaRulePrototype::media_getter)
{
    WebIDL::log_trace(vm, "CSSMediaRulePrototype::media_getter");
...
JS_DEFINE_NATIVE_FUNCTION(CSSMediaRulePrototype::media_setter)
{
    WebIDL::log_trace(vm, "CSSMediaRulePrototype::media_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(CSSMediaRulePrototype::matches_getter)
{
    WebIDL::log_trace(vm, "CSSMediaRulePrototype::matches_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
