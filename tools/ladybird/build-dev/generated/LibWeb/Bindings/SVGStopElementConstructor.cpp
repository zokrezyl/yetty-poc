...
GC_DEFINE_ALLOCATOR(SVGStopElementConstructor);

SVGStopElementConstructor::SVGStopElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGStopElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGStopElementConstructor::~SVGStopElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGStopElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGStopElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGStopElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGStopElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGStopElement");
}


void SVGStopElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGStopElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGStopElementPrototype>(realm, "SVGStopElement"_fly_string), 0);
