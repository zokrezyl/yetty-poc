...
GC_DEFINE_ALLOCATOR(TablePrototype);

TablePrototype::TablePrototype([[maybe_unused]] JS::Realm& realm)
...
void TablePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "WebAssembly.Table"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<Table*> impl_from(JS::VM& vm)
{
...
JS_DEFINE_NATIVE_FUNCTION(TablePrototype::grow)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->grow(delta, value); }));
...
JS_DEFINE_NATIVE_FUNCTION(TablePrototype::get)
{
    ...
    index = TRY(WebIDL::convert_to_int<WebIDL::UnsignedLong>(vm, arg0, WebIDL::EnforceRange::Yes, WebIDL::Clamp::No));

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->get(index); }));
...
JS_DEFINE_NATIVE_FUNCTION(TablePrototype::set)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set(index, value); }));
