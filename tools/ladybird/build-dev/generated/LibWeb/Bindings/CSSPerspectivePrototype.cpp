...
GC_DEFINE_ALLOCATOR(CSSPerspectivePrototype);

CSSPerspectivePrototype::CSSPerspectivePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CSSPerspectivePrototype::~CSSPerspectivePrototype()
{
}

void CSSPerspectivePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSPerspective"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSPerspectivePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSPerspective*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSPerspective>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSPerspective");
    return static_cast<CSS::CSSPerspective*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSPerspectivePrototype::length_getter)
{
    WebIDL::log_trace(vm, "CSSPerspectivePrototype::length_getter");
    ...
    return JS::PrimitiveString::create(vm, visited_union_value0);
        ...
        [&vm, &realm]([[maybe_unused]] GC::Root<CSSKeywordValue> const& visited_union_value0) -> JS::Value {
            // These may be unused.
            (void)vm;
            (void)realm;

    return &const_cast<CSSKeywordValue&>(*visited_union_value0);
...
JS_DEFINE_NATIVE_FUNCTION(CSSPerspectivePrototype::length_setter)
{
    WebIDL::log_trace(vm, "CSSPerspectivePrototype::length_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto value_to_variant = [&vm, &realm](JS::Value value) -> JS::ThrowCompletionOr<Variant<GC::Root<CSSNumericValue>, String, GC::Root<CSSKeywordValue>>> {
        ...
        if (value.is_object()) {
            ...
            if (is<PlatformObject>(value_object)) {
                ...
                if (auto* value_result = as_if<CSSKeywordValue>(value_object))
                    return GC::make_root(*value_result);
    ...
    Variant<GC::Root<CSSNumericValue>, String, GC::Root<CSSKeywordValue>> cpp_value = TRY(value_to_variant(value));

    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_length(cpp_value); }));
