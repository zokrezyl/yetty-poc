...
GC_DEFINE_ALLOCATOR(CSSUnparsedValuePrototype);

CSSUnparsedValuePrototype::CSSUnparsedValuePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CSSUnparsedValuePrototype::~CSSUnparsedValuePrototype()
{
}

void CSSUnparsedValuePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSUnparsedValue"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSUnparsedValuePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSUnparsedValue*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSUnparsedValue>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSUnparsedValue");
    return static_cast<CSS::CSSUnparsedValue*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSUnparsedValuePrototype::length_getter)
{
    WebIDL::log_trace(vm, "CSSUnparsedValuePrototype::length_getter");
