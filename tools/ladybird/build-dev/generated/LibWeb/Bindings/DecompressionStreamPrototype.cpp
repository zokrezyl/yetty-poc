...
GC_DEFINE_ALLOCATOR(DecompressionStreamPrototype);

DecompressionStreamPrototype::DecompressionStreamPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

DecompressionStreamPrototype::~DecompressionStreamPrototype()
{
}

void DecompressionStreamPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "DecompressionStream"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void DecompressionStreamPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<Compression::DecompressionStream*> impl_from(JS::VM& vm)
{
    ...
    if (!is<Compression::DecompressionStream>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "DecompressionStream");
    return static_cast<Compression::DecompressionStream*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(DecompressionStreamPrototype::readable_getter)
{
    WebIDL::log_trace(vm, "DecompressionStreamPrototype::readable_getter");
...
JS_DEFINE_NATIVE_FUNCTION(DecompressionStreamPrototype::writable_getter)
{
    WebIDL::log_trace(vm, "DecompressionStreamPrototype::writable_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
