...
GC_DEFINE_ALLOCATOR(HTMLLegendElementPrototype);

HTMLLegendElementPrototype::HTMLLegendElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLLegendElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLLegendElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLLegendElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLLegendElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLLegendElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLLegendElement");
    return static_cast<HTML::HTMLLegendElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLLegendElementPrototype::form_getter)
{
    WebIDL::log_trace(vm, "HTMLLegendElementPrototype::form_getter");
...
{
    WebIDL::log_trace(vm, "HTMLLegendElementPrototype::align_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLLegendElementPrototype::align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
