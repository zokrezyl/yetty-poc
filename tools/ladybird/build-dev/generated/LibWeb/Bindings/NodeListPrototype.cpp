...
GC_DEFINE_ALLOCATOR(NodeListPrototype);

NodeListPrototype::NodeListPrototype([[maybe_unused]] JS::Realm& realm)
...
void NodeListPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "NodeList"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void NodeListPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<DOM::NodeList*> impl_from(JS::VM& vm)
{
    ...
    if (!is<DOM::NodeList>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "NodeList");
    return static_cast<DOM::NodeList*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(NodeListPrototype::length_getter)
{
    WebIDL::log_trace(vm, "NodeListPrototype::length_getter");
...
{
    WebIDL::log_trace(vm, "NodeListPrototype::item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
