...
GC_DEFINE_ALLOCATOR(CSSTranslatePrototype);

CSSTranslatePrototype::CSSTranslatePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CSSTranslatePrototype::~CSSTranslatePrototype()
{
}

void CSSTranslatePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSTranslate"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSTranslatePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSTranslate*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSTranslate>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSTranslate");
    return static_cast<CSS::CSSTranslate*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSTranslatePrototype::x_getter)
{
    WebIDL::log_trace(vm, "CSSTranslatePrototype::x_getter");
...
JS_DEFINE_NATIVE_FUNCTION(CSSTranslatePrototype::x_setter)
{
    WebIDL::log_trace(vm, "CSSTranslatePrototype::x_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(CSSTranslatePrototype::y_getter)
{
    WebIDL::log_trace(vm, "CSSTranslatePrototype::y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(CSSTranslatePrototype::y_setter)
{
    WebIDL::log_trace(vm, "CSSTranslatePrototype::y_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(CSSTranslatePrototype::z_getter)
{
    WebIDL::log_trace(vm, "CSSTranslatePrototype::z_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(CSSTranslatePrototype::z_setter)
{
    WebIDL::log_trace(vm, "CSSTranslatePrototype::z_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
