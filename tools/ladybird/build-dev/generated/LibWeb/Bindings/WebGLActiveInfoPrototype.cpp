...
GC_DEFINE_ALLOCATOR(WebGLActiveInfoPrototype);

WebGLActiveInfoPrototype::WebGLActiveInfoPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

WebGLActiveInfoPrototype::~WebGLActiveInfoPrototype()
{
}

void WebGLActiveInfoPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "WebGLActiveInfo"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void WebGLActiveInfoPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<WebGL::WebGLActiveInfo*> impl_from(JS::VM& vm)
{
    ...
    if (!is<WebGL::WebGLActiveInfo>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "WebGLActiveInfo");
    return static_cast<WebGL::WebGLActiveInfo*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(WebGLActiveInfoPrototype::size_getter)
{
    WebIDL::log_trace(vm, "WebGLActiveInfoPrototype::size_getter");
...
JS_DEFINE_NATIVE_FUNCTION(WebGLActiveInfoPrototype::type_getter)
{
    WebIDL::log_trace(vm, "WebGLActiveInfoPrototype::type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(WebGLActiveInfoPrototype::name_getter)
{
    WebIDL::log_trace(vm, "WebGLActiveInfoPrototype::name_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
