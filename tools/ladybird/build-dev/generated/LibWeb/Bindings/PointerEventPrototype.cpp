...
GC_DEFINE_ALLOCATOR(PointerEventPrototype);

PointerEventPrototype::PointerEventPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

PointerEventPrototype::~PointerEventPrototype()
{
}

void PointerEventPrototype::initialize(JS::Realm& realm)
{
    ...
    set_prototype(&ensure_web_prototype<MouseEventPrototype>(realm, "MouseEvent"_fly_string));


    auto native_pointer_id_getter = JS::NativeFunction::create(realm, pointer_id_getter, 0, "pointerId"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_pointer_id_setter;

    define_direct_accessor("pointerId"_utf16_fly_string, native_pointer_id_getter, native_pointer_id_setter, default_attributes);
    ...
    auto native_pressure_getter = JS::NativeFunction::create(realm, pressure_getter, 0, "pressure"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_pressure_setter;

    define_direct_accessor("pressure"_utf16_fly_string, native_pressure_getter, native_pressure_setter, default_attributes);

    auto native_tangential_pressure_getter = JS::NativeFunction::create(realm, tangential_pressure_getter, 0, "tangentialPressure"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_tangential_pressure_setter;

    define_direct_accessor("tangentialPressure"_utf16_fly_string, native_tangential_pressure_getter, native_tangential_pressure_setter, default_attributes);

    auto native_tilt_x_getter = JS::NativeFunction::create(realm, tilt_x_getter, 0, "tiltX"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_tilt_x_setter;

    define_direct_accessor("tiltX"_utf16_fly_string, native_tilt_x_getter, native_tilt_x_setter, default_attributes);

    auto native_tilt_y_getter = JS::NativeFunction::create(realm, tilt_y_getter, 0, "tiltY"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_tilt_y_setter;

    define_direct_accessor("tiltY"_utf16_fly_string, native_tilt_y_getter, native_tilt_y_setter, default_attributes);

    auto native_twist_getter = JS::NativeFunction::create(realm, twist_getter, 0, "twist"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_twist_setter;

    define_direct_accessor("twist"_utf16_fly_string, native_twist_getter, native_twist_setter, default_attributes);

    auto native_altitude_angle_getter = JS::NativeFunction::create(realm, altitude_angle_getter, 0, "altitudeAngle"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_altitude_angle_setter;

    define_direct_accessor("altitudeAngle"_utf16_fly_string, native_altitude_angle_getter, native_altitude_angle_setter, default_attributes);

    auto native_azimuth_angle_getter = JS::NativeFunction::create(realm, azimuth_angle_getter, 0, "azimuthAngle"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_azimuth_angle_setter;

    define_direct_accessor("azimuthAngle"_utf16_fly_string, native_azimuth_angle_getter, native_azimuth_angle_setter, default_attributes);

    auto native_pointer_type_getter = JS::NativeFunction::create(realm, pointer_type_getter, 0, "pointerType"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_pointer_type_setter;

    define_direct_accessor("pointerType"_utf16_fly_string, native_pointer_type_getter, native_pointer_type_setter, default_attributes);

    auto native_is_primary_getter = JS::NativeFunction::create(realm, is_primary_getter, 0, "isPrimary"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_is_primary_setter;

    define_direct_accessor("isPrimary"_utf16_fly_string, native_is_primary_getter, native_is_primary_setter, default_attributes);

    auto native_persistent_device_id_getter = JS::NativeFunction::create(realm, persistent_device_id_getter, 0, "persistentDeviceId"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_persistent_device_id_setter;

    define_direct_accessor("persistentDeviceId"_utf16_fly_string, native_persistent_device_id_getter, native_persistent_device_id_setter, default_attributes);

    if (HTML::is_secure_context(Bindings::principal_host_defined_environment_settings_object(realm))) {
    define_native_function(realm, "getCoalescedEvents"_utf16_fly_string, get_coalesced_events, 0, default_attributes);

    }
    define_native_function(realm, "getPredictedEvents"_utf16_fly_string, get_predicted_events, 0, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "PointerEvent"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void PointerEventPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<UIEvents::PointerEvent*> impl_from(JS::VM& vm)
{
    ...
    if (!is<UIEvents::PointerEvent>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "PointerEvent");
    return static_cast<UIEvents::PointerEvent*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(PointerEventPrototype::pointer_id_getter)
{
    WebIDL::log_trace(vm, "PointerEventPrototype::pointer_id_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->pointer_id(); }));

    return JS::Value(static_cast<WebIDL::Long>(retval));

}

JS_DEFINE_NATIVE_FUNCTION(PointerEventPrototype::width_getter)
{
    WebIDL::log_trace(vm, "PointerEventPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(PointerEventPrototype::height_getter)
{
    WebIDL::log_trace(vm, "PointerEventPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(PointerEventPrototype::pressure_getter)
{
    WebIDL::log_trace(vm, "PointerEventPrototype::pressure_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->pressure(); }));

    return JS::Value(retval);

}

JS_DEFINE_NATIVE_FUNCTION(PointerEventPrototype::tangential_pressure_getter)
{
    WebIDL::log_trace(vm, "PointerEventPrototype::tangential_pressure_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->tangential_pressure(); }));

    return JS::Value(retval);

}

JS_DEFINE_NATIVE_FUNCTION(PointerEventPrototype::tilt_x_getter)
{
    WebIDL::log_trace(vm, "PointerEventPrototype::tilt_x_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->tilt_x(); }));

    return JS::Value(static_cast<WebIDL::Long>(retval));

}

JS_DEFINE_NATIVE_FUNCTION(PointerEventPrototype::tilt_y_getter)
{
    WebIDL::log_trace(vm, "PointerEventPrototype::tilt_y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->tilt_y(); }));

    return JS::Value(static_cast<WebIDL::Long>(retval));

}

JS_DEFINE_NATIVE_FUNCTION(PointerEventPrototype::twist_getter)
{
    WebIDL::log_trace(vm, "PointerEventPrototype::twist_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->twist(); }));

    return JS::Value(static_cast<WebIDL::Long>(retval));

}

JS_DEFINE_NATIVE_FUNCTION(PointerEventPrototype::altitude_angle_getter)
{
    WebIDL::log_trace(vm, "PointerEventPrototype::altitude_angle_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->altitude_angle(); }));

    return JS::Value(retval);

}

JS_DEFINE_NATIVE_FUNCTION(PointerEventPrototype::azimuth_angle_getter)
{
    WebIDL::log_trace(vm, "PointerEventPrototype::azimuth_angle_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->azimuth_angle(); }));

    return JS::Value(retval);

}

JS_DEFINE_NATIVE_FUNCTION(PointerEventPrototype::pointer_type_getter)
{
    WebIDL::log_trace(vm, "PointerEventPrototype::pointer_type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->pointer_type(); }));

    return JS::PrimitiveString::create(vm, retval);

}

JS_DEFINE_NATIVE_FUNCTION(PointerEventPrototype::is_primary_getter)
{
    WebIDL::log_trace(vm, "PointerEventPrototype::is_primary_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->is_primary(); }));

    return JS::Value(retval);

}

JS_DEFINE_NATIVE_FUNCTION(PointerEventPrototype::persistent_device_id_getter)
{
    WebIDL::log_trace(vm, "PointerEventPrototype::persistent_device_id_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->persistent_device_id(); }));

    return JS::Value(static_cast<WebIDL::Long>(retval));

}

JS_DEFINE_NATIVE_FUNCTION(PointerEventPrototype::get_coalesced_events)
{
    WebIDL::log_trace(vm, "PointerEventPrototype::get_coalesced_events");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    auto* impl = TRY(impl_from(vm));

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->get_coalesced_events(); }));
...
JS_DEFINE_NATIVE_FUNCTION(PointerEventPrototype::get_predicted_events)
{
    WebIDL::log_trace(vm, "PointerEventPrototype::get_predicted_events");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    auto* impl = TRY(impl_from(vm));

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->get_predicted_events(); }));
