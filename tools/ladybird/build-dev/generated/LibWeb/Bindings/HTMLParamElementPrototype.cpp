...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLParamElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLParamElementPrototype);

HTMLParamElementPrototype::HTMLParamElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLParamElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_value_type_getter = JS::NativeFunction::create(realm, value_type_getter, 0, "valueType"_utf16_fly_string, &realm, "get"sv);

    auto native_value_type_setter = JS::NativeFunction::create(realm, value_type_setter, 1, "valueType"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("valueType"_utf16_fly_string, native_value_type_getter, native_value_type_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLParamElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLParamElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLParamElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLParamElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLParamElement");
    return static_cast<HTML::HTMLParamElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLParamElementPrototype::name_getter)
{
    WebIDL::log_trace(vm, "HTMLParamElementPrototype::name_getter");
...
{
    WebIDL::log_trace(vm, "HTMLParamElementPrototype::name_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLParamElementPrototype::value_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLParamElementPrototype::value_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLParamElementPrototype::type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLParamElementPrototype::type_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLParamElementPrototype::value_type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("valuetype"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLParamElementPrototype::value_type_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("valuetype"_fly_string, cpp_value);
