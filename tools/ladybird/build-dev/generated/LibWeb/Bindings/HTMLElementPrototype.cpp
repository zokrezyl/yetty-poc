...
GC_DEFINE_ALLOCATOR(HTMLElementPrototype);

HTMLElementPrototype::HTMLElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_translate_getter = JS::NativeFunction::create(realm, translate_getter, 0, "translate"_utf16_fly_string, &realm, "get"sv);

    auto native_translate_setter = JS::NativeFunction::create(realm, translate_setter, 1, "translate"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("translate"_utf16_fly_string, native_translate_getter, native_translate_setter, default_attributes);
    ...
    auto native_hidden_setter = JS::NativeFunction::create(realm, hidden_setter, 1, "hidden"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("hidden"_utf16_fly_string, native_hidden_getter, native_hidden_setter, default_attributes);

    auto native_inert_getter = JS::NativeFunction::create(realm, inert_getter, 0, "inert"_utf16_fly_string, &realm, "get"sv);

    auto native_inert_setter = JS::NativeFunction::create(realm, inert_setter, 1, "inert"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("inert"_utf16_fly_string, native_inert_getter, native_inert_setter, default_attributes);

    auto native_access_key_getter = JS::NativeFunction::create(realm, access_key_getter, 0, "accessKey"_utf16_fly_string, &realm, "get"sv);

    auto native_access_key_setter = JS::NativeFunction::create(realm, access_key_setter, 1, "accessKey"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("accessKey"_utf16_fly_string, native_access_key_getter, native_access_key_setter, default_attributes);

    auto native_access_key_label_getter = JS::NativeFunction::create(realm, access_key_label_getter, 0, "accessKeyLabel"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_access_key_label_setter;

    define_direct_accessor("accessKeyLabel"_utf16_fly_string, native_access_key_label_getter, native_access_key_label_setter, default_attributes);

    auto native_draggable_getter = JS::NativeFunction::create(realm, draggable_getter, 0, "draggable"_utf16_fly_string, &realm, "get"sv);

    auto native_draggable_setter = JS::NativeFunction::create(realm, draggable_setter, 1, "draggable"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("draggable"_utf16_fly_string, native_draggable_getter, native_draggable_setter, default_attributes);

    auto native_spellcheck_getter = JS::NativeFunction::create(realm, spellcheck_getter, 0, "spellcheck"_utf16_fly_string, &realm, "get"sv);

    auto native_spellcheck_setter = JS::NativeFunction::create(realm, spellcheck_setter, 1, "spellcheck"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("spellcheck"_utf16_fly_string, native_spellcheck_getter, native_spellcheck_setter, default_attributes);

    auto native_writing_suggestions_getter = JS::NativeFunction::create(realm, writing_suggestions_getter, 0, "writingSuggestions"_utf16_fly_string, &realm, "get"sv);

    auto native_writing_suggestions_setter = JS::NativeFunction::create(realm, writing_suggestions_setter, 1, "writingSuggestions"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("writingSuggestions"_utf16_fly_string, native_writing_suggestions_getter, native_writing_suggestions_setter, default_attributes);

    auto native_autocapitalize_getter = JS::NativeFunction::create(realm, autocapitalize_getter, 0, "autocapitalize"_utf16_fly_string, &realm, "get"sv);

    auto native_autocapitalize_setter = JS::NativeFunction::create(realm, autocapitalize_setter, 1, "autocapitalize"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("autocapitalize"_utf16_fly_string, native_autocapitalize_getter, native_autocapitalize_setter, default_attributes);

    auto native_autocorrect_getter = JS::NativeFunction::create(realm, autocorrect_getter, 0, "autocorrect"_utf16_fly_string, &realm, "get"sv);

    auto native_autocorrect_setter = JS::NativeFunction::create(realm, autocorrect_setter, 1, "autocorrect"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("autocorrect"_utf16_fly_string, native_autocorrect_getter, native_autocorrect_setter, default_attributes);
    ...
    auto native_outer_text_getter = JS::NativeFunction::create(realm, outer_text_getter, 0, "outerText"_utf16_fly_string, &realm, "get"sv);

    auto native_outer_text_setter = JS::NativeFunction::create(realm, outer_text_setter, 1, "outerText"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("outerText"_utf16_fly_string, native_outer_text_getter, native_outer_text_setter, default_attributes);

    auto native_popover_getter = JS::NativeFunction::create(realm, popover_getter, 0, "popover"_utf16_fly_string, &realm, "get"sv);

    auto native_popover_setter = JS::NativeFunction::create(realm, popover_setter, 1, "popover"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("popover"_utf16_fly_string, native_popover_getter, native_popover_setter, default_attributes);

    auto native_heading_offset_getter = JS::NativeFunction::create(realm, heading_offset_getter, 0, "headingOffset"_utf16_fly_string, &realm, "get"sv);

    auto native_heading_offset_setter = JS::NativeFunction::create(realm, heading_offset_setter, 1, "headingOffset"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("headingOffset"_utf16_fly_string, native_heading_offset_getter, native_heading_offset_setter, default_attributes);

    auto native_heading_reset_getter = JS::NativeFunction::create(realm, heading_reset_getter, 0, "headingReset"_utf16_fly_string, &realm, "get"sv);

    auto native_heading_reset_setter = JS::NativeFunction::create(realm, heading_reset_setter, 1, "headingReset"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("headingReset"_utf16_fly_string, native_heading_reset_getter, native_heading_reset_setter, default_attributes);

    auto native_scroll_parent_getter = JS::NativeFunction::create(realm, scroll_parent_getter, 0, "scrollParent"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_scroll_parent_setter;

    define_direct_accessor("scrollParent"_utf16_fly_string, native_scroll_parent_getter, native_scroll_parent_setter, default_attributes);

    auto native_offset_parent_getter = JS::NativeFunction::create(realm, offset_parent_getter, 0, "offsetParent"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_offset_parent_setter;

    define_direct_accessor("offsetParent"_utf16_fly_string, native_offset_parent_getter, native_offset_parent_setter, default_attributes);
    ...
    auto native_offset_width_getter = JS::NativeFunction::create(realm, offset_width_getter, 0, "offsetWidth"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_offset_width_setter;

    define_direct_accessor("offsetWidth"_utf16_fly_string, native_offset_width_getter, native_offset_width_setter, default_attributes);

    auto native_offset_height_getter = JS::NativeFunction::create(realm, offset_height_getter, 0, "offsetHeight"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_offset_height_setter;

    define_direct_accessor("offsetHeight"_utf16_fly_string, native_offset_height_getter, native_offset_height_setter, default_attributes);
    ...
    auto native_content_editable_getter = JS::NativeFunction::create(realm, content_editable_getter, 0, "contentEditable"_utf16_fly_string, &realm, "get"sv);

    auto native_content_editable_setter = JS::NativeFunction::create(realm, content_editable_setter, 1, "contentEditable"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("contentEditable"_utf16_fly_string, native_content_editable_getter, native_content_editable_setter, default_attributes);

    auto native_enter_key_hint_getter = JS::NativeFunction::create(realm, enter_key_hint_getter, 0, "enterKeyHint"_utf16_fly_string, &realm, "get"sv);

    auto native_enter_key_hint_setter = JS::NativeFunction::create(realm, enter_key_hint_setter, 1, "enterKeyHint"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("enterKeyHint"_utf16_fly_string, native_enter_key_hint_getter, native_enter_key_hint_setter, default_attributes);

    auto native_is_content_editable_getter = JS::NativeFunction::create(realm, is_content_editable_getter, 0, "isContentEditable"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_is_content_editable_setter;

    define_direct_accessor("isContentEditable"_utf16_fly_string, native_is_content_editable_getter, native_is_content_editable_setter, default_attributes);

    auto native_input_mode_getter = JS::NativeFunction::create(realm, input_mode_getter, 0, "inputMode"_utf16_fly_string, &realm, "get"sv);

    auto native_input_mode_setter = JS::NativeFunction::create(realm, input_mode_setter, 1, "inputMode"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("inputMode"_utf16_fly_string, native_input_mode_getter, native_input_mode_setter, default_attributes);

    define_native_function(realm, "click"_utf16_fly_string, click, 0, default_attributes);

    define_native_function(realm, "attachInternals"_utf16_fly_string, attach_internals, 0, default_attributes);

    define_native_function(realm, "showPopover"_utf16_fly_string, show_popover, 0, default_attributes);

    define_native_function(realm, "hidePopover"_utf16_fly_string, hide_popover, 0, default_attributes);

    define_native_function(realm, "togglePopover"_utf16_fly_string, toggle_popover, 0, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLElement"_string), JS::Attribute::Configurable);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::title_getter)
{
    ...
    auto contentAttributeValue = impl->attribute("title"_fly_string);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::title_setter)
{
    ...
    impl->set_attribute_value("title"_fly_string, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::lang_getter)
{
    ...
    auto contentAttributeValue = impl->attribute("lang"_fly_string);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::lang_setter)
{
    ...
    impl->set_attribute_value("lang"_fly_string, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::translate_getter)
{
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->translate(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::translate_setter)
{
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_translate(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::hidden_getter)
{
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->hidden(); });
    ...
    return retval.visit(
        ...
        [&vm, &realm]([[maybe_unused]] bool const& visited_union_value0) -> JS::Value {
            // These may be unused.
            (void)vm;
            (void)realm;
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::hidden_setter)
{
    ...
    auto value_to_variant = [&vm, &realm](JS::Value value) -> JS::ThrowCompletionOr<Variant<bool, double, String>> {
        ...
        if (value.is_boolean())
            return Variant<bool, double, String> { value.as_bool() };
    ...
    Variant<bool, double, String> cpp_value = TRY(value_to_variant(value));

    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_hidden(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::inert_getter)
{
    ...
    auto retval = impl->has_attribute("inert"_fly_string);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::inert_setter)
{
    ...
    if (!cpp_value)
        impl->remove_attribute("inert"_fly_string);
    else
        impl->set_attribute_value("inert"_fly_string, String {});
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::access_key_getter)
{
    ...
    auto contentAttributeValue = impl->attribute("accesskey"_fly_string);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::access_key_setter)
{
    ...
    impl->set_attribute_value("accesskey"_fly_string, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::access_key_label_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->access_key_label(); }));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::draggable_getter)
{
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->draggable(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::draggable_setter)
{
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_draggable(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::spellcheck_getter)
{
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->spellcheck(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::spellcheck_setter)
{
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_spellcheck(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::writing_suggestions_getter)
{
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->writing_suggestions(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::writing_suggestions_setter)
{
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_writing_suggestions(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::autocapitalize_getter)
{
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->autocapitalize(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::autocapitalize_setter)
{
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_autocapitalize(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::autocorrect_getter)
{
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->autocorrect(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::autocorrect_setter)
{
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_autocorrect(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::outer_text_getter)
{
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->outer_text(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::outer_text_setter)
{
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_outer_text(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::popover_getter)
{
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->popover(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::popover_setter)
{
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_popover(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::heading_offset_getter)
{
    ...
    u32 retval = 0;
    auto content_attribute_value = impl->get_attribute("headingoffset"_fly_string);
    u32 minimum = 0;
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::heading_offset_setter)
{
    ...
    if (cpp_value >= minimum && cpp_value <= 2147483647)
        new_value = cpp_value;
    impl->set_attribute_value("headingoffset"_fly_string, String::number(new_value));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::heading_reset_getter)
{
    ...
    auto retval = impl->has_attribute("headingreset"_fly_string);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::heading_reset_setter)
{
    ...
    if (!cpp_value)
        impl->remove_attribute("headingreset"_fly_string);
    else
        impl->set_attribute_value("headingreset"_fly_string, String {});
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::scroll_parent_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->scroll_parent(); }));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::offset_parent_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->offset_parent(); }));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::offset_width_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->offset_width(); }));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::offset_height_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->offset_height(); }));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::content_editable_getter)
{
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->content_editable(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::content_editable_setter)
{
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_content_editable(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::enter_key_hint_getter)
{
    ...
    auto contentAttributeValue = impl->attribute("enterkeyhint"_fly_string);
    ...
    Array valid_values { "enter"_string, "done"_string, "go"_string, "next"_string, "previous"_string, "search"_string, "send"_string };
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::enter_key_hint_setter)
{
    ...
    impl->set_attribute_value("enterkeyhint"_fly_string, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::is_content_editable_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->is_content_editable(); }));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::input_mode_getter)
{
    ...
    auto contentAttributeValue = impl->attribute("inputmode"_fly_string);
    ...
    Array valid_values { "none"_string, "text"_string, "tel"_string, "url"_string, "email"_string, "numeric"_string, "decimal"_string, "search"_string };
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::input_mode_setter)
{
    ...
    impl->set_attribute_value("inputmode"_fly_string, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::click)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->click(); }));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::attach_internals)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->attach_internals(); }));

    return &const_cast<ElementInternals&>(*retval);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::show_popover)
{
    ...
    auto source_property_value_0 = JS::js_undefined();
    if (arg0.is_object())
        source_property_value_0 = TRY(arg0.as_object().get("source"_utf16_fly_string));

    if (!source_property_value_0.is_undefined()) {

    GC::Ptr<HTMLElement> source_value_0;
    if (!source_property_value_0.is_undefined()) {
        if (!source_property_value_0.is_object() || !is<HTMLElement>(source_property_value_0.as_object()))
            return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLElement");

        source_value_0 = static_cast<HTMLElement&>(source_property_value_0.as_object());
    }

    options.source = source_value_0;

    }

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->show_popover_for_bindings(options); }));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::hide_popover)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->hide_popover_for_bindings(); }));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLElementPrototype::toggle_popover)
{
    ...
    auto arg0_to_dictionary = [&vm, &realm](JS::Value arg0) -> JS::ThrowCompletionOr<TogglePopoverOptions> {
    ...
    TogglePopoverOptions dictionary_union_type {};

    auto force_property_value_0 = JS::js_undefined();
    if (arg0.is_object())
        force_property_value_0 = TRY(arg0.as_object().get("force"_utf16_fly_string));

    if (!force_property_value_0.is_undefined()) {

    Optional<bool> force_value_0;

    if (!force_property_value_0.is_undefined())

    force_value_0 = force_property_value_0.to_boolean();

    dictionary_union_type.force = force_value_0;

    }

    auto source_property_value_1 = JS::js_undefined();
    if (arg0.is_object())
        source_property_value_1 = TRY(arg0.as_object().get("source"_utf16_fly_string));

    if (!source_property_value_1.is_undefined()) {

    GC::Ptr<HTMLElement> source_value_1;
    if (!source_property_value_1.is_undefined()) {
        if (!source_property_value_1.is_object() || !is<HTMLElement>(source_property_value_1.as_object()))
            return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLElement");

        source_value_1 = static_cast<HTMLElement&>(source_property_value_1.as_object());
    }

    dictionary_union_type.source = source_value_1;
    ...
    auto arg0_to_variant = [&vm, &realm, &arg0_to_dictionary](JS::Value arg0) -> JS::ThrowCompletionOr<Variant<TogglePopoverOptions, bool>> {
        // These might be unused.
        (void)vm;
        (void)realm;

        if (arg0.is_nullish())
            return Variant<TogglePopoverOptions, bool> { TRY(arg0_to_dictionary(arg0)) };
    ...
    Variant<TogglePopoverOptions, bool> options = arg0.is_undefined() ? TRY(arg0_to_dictionary(arg0)) : TRY(arg0_to_variant(arg0));

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->toggle_popover(options); }));
