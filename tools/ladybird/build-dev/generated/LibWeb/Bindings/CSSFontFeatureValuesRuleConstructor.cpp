...
GC_DEFINE_ALLOCATOR(CSSFontFeatureValuesRuleConstructor);

CSSFontFeatureValuesRuleConstructor::CSSFontFeatureValuesRuleConstructor(JS::Realm& realm)
    : NativeFunction("CSSFontFeatureValuesRule"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

CSSFontFeatureValuesRuleConstructor::~CSSFontFeatureValuesRuleConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> CSSFontFeatureValuesRuleConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "CSSFontFeatureValuesRule");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> CSSFontFeatureValuesRuleConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "CSSFontFeatureValuesRuleConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "CSSFontFeatureValuesRule");
}


void CSSFontFeatureValuesRuleConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    set_prototype(&ensure_web_constructor<CSSRulePrototype>(realm, "CSSRule"_fly_string));

    define_direct_property(vm.names.length, JS::Value(0), JS::Attribute::Configurable);
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "CSSFontFeatureValuesRule"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<CSSFontFeatureValuesRulePrototype>(realm, "CSSFontFeatureValuesRule"_fly_string), 0);
