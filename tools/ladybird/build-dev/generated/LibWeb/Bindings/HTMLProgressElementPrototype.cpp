...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLProgressElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLProgressElementPrototype);

HTMLProgressElementPrototype::HTMLProgressElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLProgressElementPrototype::initialize(JS::Realm& realm)
{
    ...
    GC::Ptr<JS::NativeFunction> native_position_setter;
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLProgressElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLProgressElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLProgressElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLProgressElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLProgressElement");
    return static_cast<HTML::HTMLProgressElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLProgressElementPrototype::value_getter)
{
    WebIDL::log_trace(vm, "HTMLProgressElementPrototype::value_getter");
...
{
    WebIDL::log_trace(vm, "HTMLProgressElementPrototype::value_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLProgressElementPrototype::max_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLProgressElementPrototype::max_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLProgressElementPrototype::position_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLProgressElementPrototype::labels_getter)
{
    WebIDL::log_trace(vm, "HTMLProgressElementPrototype::labels_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
