...
GC_DEFINE_ALLOCATOR(SVGStyleElementConstructor);

SVGStyleElementConstructor::SVGStyleElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGStyleElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGStyleElementConstructor::~SVGStyleElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGStyleElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGStyleElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGStyleElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGStyleElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGStyleElement");
}


void SVGStyleElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGStyleElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGStyleElementPrototype>(realm, "SVGStyleElement"_fly_string), 0);
