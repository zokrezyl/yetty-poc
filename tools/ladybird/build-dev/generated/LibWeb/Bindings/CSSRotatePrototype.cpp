...
GC_DEFINE_ALLOCATOR(CSSRotatePrototype);

CSSRotatePrototype::CSSRotatePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CSSRotatePrototype::~CSSRotatePrototype()
{
}

void CSSRotatePrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_angle_setter = JS::NativeFunction::create(realm, angle_setter, 1, "angle"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("angle"_utf16_fly_string, native_angle_getter, native_angle_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSRotate"_string), JS::Attribute::Configurable);
...
JS_DEFINE_NATIVE_FUNCTION(CSSRotatePrototype::angle_setter)
{
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_angle(cpp_value); }));
