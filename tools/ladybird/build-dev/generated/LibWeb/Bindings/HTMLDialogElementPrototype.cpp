...
GC_DEFINE_ALLOCATOR(HTMLDialogElementPrototype);

HTMLDialogElementPrototype::HTMLDialogElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLDialogElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_closed_by_getter = JS::NativeFunction::create(realm, closed_by_getter, 0, "closedBy"_utf16_fly_string, &realm, "get"sv);

    auto native_closed_by_setter = JS::NativeFunction::create(realm, closed_by_setter, 1, "closedBy"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("closedBy"_utf16_fly_string, native_closed_by_getter, native_closed_by_setter, default_attributes);

    define_native_function(realm, "show"_utf16_fly_string, show, 0, default_attributes);

    define_native_function(realm, "showModal"_utf16_fly_string, show_modal, 0, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLDialogElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLDialogElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLDialogElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLDialogElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLDialogElement");
    return static_cast<HTML::HTMLDialogElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLDialogElementPrototype::open_getter)
{
    WebIDL::log_trace(vm, "HTMLDialogElementPrototype::open_getter");
...
{
    WebIDL::log_trace(vm, "HTMLDialogElementPrototype::open_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLDialogElementPrototype::return_value_getter)
{
    WebIDL::log_trace(vm, "HTMLDialogElementPrototype::return_value_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLDialogElementPrototype::return_value_setter)
{
    WebIDL::log_trace(vm, "HTMLDialogElementPrototype::return_value_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLDialogElementPrototype::closed_by_getter)
{
    WebIDL::log_trace(vm, "HTMLDialogElementPrototype::closed_by_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("closedby"_fly_string);
    ...
    Array valid_values { "any"_string, "closerequest"_string, "none"_string };
...
JS_DEFINE_NATIVE_FUNCTION(HTMLDialogElementPrototype::closed_by_setter)
{
    WebIDL::log_trace(vm, "HTMLDialogElementPrototype::closed_by_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("closedby"_fly_string, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLDialogElementPrototype::show)
{
    WebIDL::log_trace(vm, "HTMLDialogElementPrototype::show");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->show(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLDialogElementPrototype::show_modal)
{
    WebIDL::log_trace(vm, "HTMLDialogElementPrototype::show_modal");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->show_modal(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLDialogElementPrototype::close)
{
    WebIDL::log_trace(vm, "HTMLDialogElementPrototype::close");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!arg0.is_undefined()) {
        if (!false || !arg0.is_null())
            return_value = TRY(WebIDL::to_string(vm, arg0));
    }

    auto& reactions_stack = HTML::relevant_similar_origin_window_agent(*impl).custom_element_reactions_stack;
    reactions_stack.element_queue_stack.append({});

    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->close(return_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLDialogElementPrototype::request_close)
{
    WebIDL::log_trace(vm, "HTMLDialogElementPrototype::request_close");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->request_close(return_value); });
