...
GC_DEFINE_ALLOCATOR(DocumentFragmentPrototype);

DocumentFragmentPrototype::DocumentFragmentPrototype([[maybe_unused]] JS::Realm& realm)
...
void DocumentFragmentPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "DocumentFragment"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<DOM::DocumentFragment*> impl_from(JS::VM& vm)
{
    ...
    if (!is<DOM::DocumentFragment>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "DocumentFragment");
    return static_cast<DOM::DocumentFragment*>(this_object);
}
