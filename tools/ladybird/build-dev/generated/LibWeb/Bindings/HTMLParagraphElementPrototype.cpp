...
GC_DEFINE_ALLOCATOR(HTMLParagraphElementPrototype);

HTMLParagraphElementPrototype::HTMLParagraphElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLParagraphElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLParagraphElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLParagraphElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLParagraphElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLParagraphElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLParagraphElement");
    return static_cast<HTML::HTMLParagraphElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLParagraphElementPrototype::align_getter)
{
    WebIDL::log_trace(vm, "HTMLParagraphElementPrototype::align_getter");
...
{
    WebIDL::log_trace(vm, "HTMLParagraphElementPrototype::align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
