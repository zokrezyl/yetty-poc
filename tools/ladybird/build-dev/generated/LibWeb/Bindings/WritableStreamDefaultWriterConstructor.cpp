...
GC_DEFINE_ALLOCATOR(WritableStreamDefaultWriterConstructor);

WritableStreamDefaultWriterConstructor::WritableStreamDefaultWriterConstructor(JS::Realm& realm)
    : NativeFunction("WritableStreamDefaultWriter"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

WritableStreamDefaultWriterConstructor::~WritableStreamDefaultWriterConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> WritableStreamDefaultWriterConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "WritableStreamDefaultWriter");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> WritableStreamDefaultWriterConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "WritableStreamDefaultWriterConstructor::construct");
    ...
    auto& stream = static_cast<WritableStream&>(arg0.as_object());
...
void WritableStreamDefaultWriterConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "WritableStreamDefaultWriter"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<WritableStreamDefaultWriterPrototype>(realm, "WritableStreamDefaultWriter"_fly_string), 0);
