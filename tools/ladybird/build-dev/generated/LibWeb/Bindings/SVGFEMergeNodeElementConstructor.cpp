...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGFEMergeNodeElement.h>
...
GC_DEFINE_ALLOCATOR(SVGFEMergeNodeElementConstructor);

SVGFEMergeNodeElementConstructor::SVGFEMergeNodeElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGFEMergeNodeElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGFEMergeNodeElementConstructor::~SVGFEMergeNodeElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGFEMergeNodeElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGFEMergeNodeElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGFEMergeNodeElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGFEMergeNodeElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGFEMergeNodeElement");
}


void SVGFEMergeNodeElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGFEMergeNodeElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGFEMergeNodeElementPrototype>(realm, "SVGFEMergeNodeElement"_fly_string), 0);
