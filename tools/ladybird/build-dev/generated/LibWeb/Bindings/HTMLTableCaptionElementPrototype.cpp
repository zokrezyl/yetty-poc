...
GC_DEFINE_ALLOCATOR(HTMLTableCaptionElementPrototype);

HTMLTableCaptionElementPrototype::HTMLTableCaptionElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLTableCaptionElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLTableCaptionElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLTableCaptionElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLTableCaptionElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLTableCaptionElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLTableCaptionElement");
    return static_cast<HTML::HTMLTableCaptionElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLTableCaptionElementPrototype::align_getter)
{
    WebIDL::log_trace(vm, "HTMLTableCaptionElementPrototype::align_getter");
...
{
    WebIDL::log_trace(vm, "HTMLTableCaptionElementPrototype::align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
