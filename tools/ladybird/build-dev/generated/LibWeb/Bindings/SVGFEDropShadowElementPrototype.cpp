...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGFEDropShadowElement.h>
...
GC_DEFINE_ALLOCATOR(SVGFEDropShadowElementPrototype);

SVGFEDropShadowElementPrototype::SVGFEDropShadowElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGFEDropShadowElementPrototype::~SVGFEDropShadowElementPrototype()
{
}

void SVGFEDropShadowElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_dx_getter = JS::NativeFunction::create(realm, dx_getter, 0, "dx"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_dx_setter;

    define_direct_accessor("dx"_utf16_fly_string, native_dx_getter, native_dx_setter, default_attributes);

    auto native_dy_getter = JS::NativeFunction::create(realm, dy_getter, 0, "dy"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_dy_setter;

    define_direct_accessor("dy"_utf16_fly_string, native_dy_getter, native_dy_setter, default_attributes);

    auto native_std_deviation_x_getter = JS::NativeFunction::create(realm, std_deviation_x_getter, 0, "stdDeviationX"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_std_deviation_x_setter;

    define_direct_accessor("stdDeviationX"_utf16_fly_string, native_std_deviation_x_getter, native_std_deviation_x_setter, default_attributes);

    auto native_std_deviation_y_getter = JS::NativeFunction::create(realm, std_deviation_y_getter, 0, "stdDeviationY"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_std_deviation_y_setter;

    define_direct_accessor("stdDeviationY"_utf16_fly_string, native_std_deviation_y_getter, native_std_deviation_y_setter, default_attributes);
    ...
    define_native_function(realm, "setStdDeviation"_utf16_fly_string, set_std_deviation, 2, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGFEDropShadowElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGFEDropShadowElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGFEDropShadowElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGFEDropShadowElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGFEDropShadowElement");
    return static_cast<SVG::SVGFEDropShadowElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGFEDropShadowElementPrototype::in1_getter)
{
    WebIDL::log_trace(vm, "SVGFEDropShadowElementPrototype::in1_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEDropShadowElementPrototype::dx_getter)
{
    WebIDL::log_trace(vm, "SVGFEDropShadowElementPrototype::dx_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->dx(); }));

    return &const_cast<SVGAnimatedNumber&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(SVGFEDropShadowElementPrototype::dy_getter)
{
    WebIDL::log_trace(vm, "SVGFEDropShadowElementPrototype::dy_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->dy(); }));

    return &const_cast<SVGAnimatedNumber&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(SVGFEDropShadowElementPrototype::std_deviation_x_getter)
{
    WebIDL::log_trace(vm, "SVGFEDropShadowElementPrototype::std_deviation_x_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->std_deviation_x(); }));

    return &const_cast<SVGAnimatedNumber&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(SVGFEDropShadowElementPrototype::std_deviation_y_getter)
{
    WebIDL::log_trace(vm, "SVGFEDropShadowElementPrototype::std_deviation_y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->std_deviation_y(); }));

    return &const_cast<SVGAnimatedNumber&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(SVGFEDropShadowElementPrototype::x_getter)
{
    WebIDL::log_trace(vm, "SVGFEDropShadowElementPrototype::x_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEDropShadowElementPrototype::y_getter)
{
    WebIDL::log_trace(vm, "SVGFEDropShadowElementPrototype::y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEDropShadowElementPrototype::width_getter)
{
    WebIDL::log_trace(vm, "SVGFEDropShadowElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEDropShadowElementPrototype::height_getter)
{
    WebIDL::log_trace(vm, "SVGFEDropShadowElementPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEDropShadowElementPrototype::result_getter)
{
    WebIDL::log_trace(vm, "SVGFEDropShadowElementPrototype::result_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEDropShadowElementPrototype::set_std_deviation)
{
    WebIDL::log_trace(vm, "SVGFEDropShadowElementPrototype::set_std_deviation");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    auto* impl = TRY(impl_from(vm));

    if (vm.argument_count() < 2)
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::BadArgCountMany, "setStdDeviation", "2");

    auto arg0 = vm.argument(0);

    float std_deviation_x = TRY(arg0.to_double(vm));

    if (isinf(std_deviation_x) || isnan(std_deviation_x)) {
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::InvalidRestrictedFloatingPointParameter, "stdDeviationX");
    }
    
    auto arg1 = vm.argument(1);

    float std_deviation_y = TRY(arg1.to_double(vm));

    if (isinf(std_deviation_y) || isnan(std_deviation_y)) {
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::InvalidRestrictedFloatingPointParameter, "stdDeviationY");
    }
    
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_std_deviation(std_deviation_x, std_deviation_y); }));
