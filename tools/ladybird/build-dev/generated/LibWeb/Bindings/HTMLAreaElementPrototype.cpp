...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLAreaElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLAreaElementPrototype);

HTMLAreaElementPrototype::HTMLAreaElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLAreaElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_no_href_getter = JS::NativeFunction::create(realm, no_href_getter, 0, "noHref"_utf16_fly_string, &realm, "get"sv);

    auto native_no_href_setter = JS::NativeFunction::create(realm, no_href_setter, 1, "noHref"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("noHref"_utf16_fly_string, native_no_href_getter, native_no_href_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLAreaElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLAreaElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLAreaElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLAreaElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLAreaElement");
    return static_cast<HTML::HTMLAreaElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::alt_getter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::alt_getter");
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::alt_setter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::alt_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::coords_getter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::coords_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::coords_setter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::coords_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::shape_getter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::shape_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::shape_setter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::shape_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::target_getter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::target_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::target_setter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::target_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::download_getter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::download_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::download_setter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::download_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::ping_getter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::ping_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::ping_setter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::ping_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::rel_getter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::rel_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::rel_setter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::rel_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::rel_list_getter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::rel_list_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::rel_list_setter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::rel_list_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::referrer_policy_getter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::referrer_policy_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLAreaElementPrototype::referrer_policy_setter)
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::referrer_policy_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::no_href_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = impl->has_attribute("nohref"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::no_href_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value)
        impl->remove_attribute("nohref"_fly_string);
    else
        impl->set_attribute_value("nohref"_fly_string, String {});
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::href_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::href_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::origin_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::protocol_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::protocol_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::username_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::username_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::password_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::password_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::host_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::host_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::hostname_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::hostname_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::port_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::port_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::pathname_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::pathname_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::search_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::search_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::hash_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::hash_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLAreaElementPrototype::to_string");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    auto* impl = TRY(impl_from(vm));
