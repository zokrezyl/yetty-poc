...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGTitleElement.h>
...
GC_DEFINE_ALLOCATOR(SVGTitleElementConstructor);

SVGTitleElementConstructor::SVGTitleElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGTitleElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGTitleElementConstructor::~SVGTitleElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGTitleElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGTitleElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGTitleElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGTitleElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGTitleElement");
}


void SVGTitleElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGTitleElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGTitleElementPrototype>(realm, "SVGTitleElement"_fly_string), 0);
