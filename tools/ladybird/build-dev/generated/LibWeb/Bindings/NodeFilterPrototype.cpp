...
GC_DEFINE_ALLOCATOR(NodeFilterPrototype);

NodeFilterPrototype::NodeFilterPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

NodeFilterPrototype::~NodeFilterPrototype()
{
}

void NodeFilterPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "NodeFilter"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void NodeFilterPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
