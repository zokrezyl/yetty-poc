...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGForeignObjectElement.h>
...
GC_DEFINE_ALLOCATOR(SVGForeignObjectElementPrototype);

SVGForeignObjectElementPrototype::SVGForeignObjectElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGForeignObjectElementPrototype::~SVGForeignObjectElementPrototype()
{
}

void SVGForeignObjectElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGForeignObjectElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGForeignObjectElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGForeignObjectElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGForeignObjectElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGForeignObjectElement");
    return static_cast<SVG::SVGForeignObjectElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGForeignObjectElementPrototype::x_getter)
{
    WebIDL::log_trace(vm, "SVGForeignObjectElementPrototype::x_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SVGForeignObjectElementPrototype::y_getter)
{
    WebIDL::log_trace(vm, "SVGForeignObjectElementPrototype::y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGForeignObjectElementPrototype::width_getter)
{
    WebIDL::log_trace(vm, "SVGForeignObjectElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGForeignObjectElementPrototype::height_getter)
{
    WebIDL::log_trace(vm, "SVGForeignObjectElementPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
