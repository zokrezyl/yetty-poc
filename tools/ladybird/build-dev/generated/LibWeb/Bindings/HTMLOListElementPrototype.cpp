...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLOListElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLOListElementPrototype);

HTMLOListElementPrototype::HTMLOListElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLOListElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_reversed_getter = JS::NativeFunction::create(realm, reversed_getter, 0, "reversed"_utf16_fly_string, &realm, "get"sv);

    auto native_reversed_setter = JS::NativeFunction::create(realm, reversed_setter, 1, "reversed"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("reversed"_utf16_fly_string, native_reversed_getter, native_reversed_setter, default_attributes);

    auto native_start_getter = JS::NativeFunction::create(realm, start_getter, 0, "start"_utf16_fly_string, &realm, "get"sv);

    auto native_start_setter = JS::NativeFunction::create(realm, start_setter, 1, "start"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("start"_utf16_fly_string, native_start_getter, native_start_setter, default_attributes);
    ...
    auto native_compact_getter = JS::NativeFunction::create(realm, compact_getter, 0, "compact"_utf16_fly_string, &realm, "get"sv);

    auto native_compact_setter = JS::NativeFunction::create(realm, compact_setter, 1, "compact"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("compact"_utf16_fly_string, native_compact_getter, native_compact_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLOListElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLOListElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLOListElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLOListElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLOListElement");
    return static_cast<HTML::HTMLOListElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLOListElementPrototype::reversed_getter)
{
    WebIDL::log_trace(vm, "HTMLOListElementPrototype::reversed_getter");
    ...
    auto retval = impl->has_attribute("reversed"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLOListElementPrototype::reversed_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value)
        impl->remove_attribute("reversed"_fly_string);
    else
        impl->set_attribute_value("reversed"_fly_string, String {});
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOListElementPrototype::start_getter)
{
    WebIDL::log_trace(vm, "HTMLOListElementPrototype::start_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->start(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOListElementPrototype::start_setter)
{
    WebIDL::log_trace(vm, "HTMLOListElementPrototype::start_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_start(cpp_value); });
...
{
    WebIDL::log_trace(vm, "HTMLOListElementPrototype::type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLOListElementPrototype::type_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLOListElementPrototype::compact_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval = impl->has_attribute("compact"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLOListElementPrototype::compact_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value)
        impl->remove_attribute("compact"_fly_string);
    else
        impl->set_attribute_value("compact"_fly_string, String {});
