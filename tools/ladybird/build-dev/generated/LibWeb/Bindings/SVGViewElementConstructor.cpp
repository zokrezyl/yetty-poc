...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGViewElement.h>
...
GC_DEFINE_ALLOCATOR(SVGViewElementConstructor);

SVGViewElementConstructor::SVGViewElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGViewElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGViewElementConstructor::~SVGViewElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGViewElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGViewElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGViewElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGViewElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGViewElement");
}


void SVGViewElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGViewElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGViewElementPrototype>(realm, "SVGViewElement"_fly_string), 0);
