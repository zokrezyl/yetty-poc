...
GC_DEFINE_ALLOCATOR(SVGImageElementConstructor);

SVGImageElementConstructor::SVGImageElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGImageElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGImageElementConstructor::~SVGImageElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGImageElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGImageElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGImageElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGImageElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGImageElement");
}


void SVGImageElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGImageElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGImageElementPrototype>(realm, "SVGImageElement"_fly_string), 0);
