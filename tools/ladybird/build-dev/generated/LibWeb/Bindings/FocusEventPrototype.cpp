...
GC_DEFINE_ALLOCATOR(FocusEventPrototype);

FocusEventPrototype::FocusEventPrototype([[maybe_unused]] JS::Realm& realm)
...
void FocusEventPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "FocusEvent"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void FocusEventPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<UIEvents::FocusEvent*> impl_from(JS::VM& vm)
{
    ...
    if (!is<UIEvents::FocusEvent>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "FocusEvent");
    return static_cast<UIEvents::FocusEvent*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(FocusEventPrototype::related_target_getter)
{
    WebIDL::log_trace(vm, "FocusEventPrototype::related_target_getter");
