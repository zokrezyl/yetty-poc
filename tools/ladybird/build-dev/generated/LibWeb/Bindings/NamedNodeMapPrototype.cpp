...
void NamedNodeMapPrototype::initialize(JS::Realm& realm)
{
    ...
    define_native_function(realm, "getNamedItem"_utf16_fly_string, get_named_item, 1, default_attributes);

    define_native_function(realm, "getNamedItemNS"_utf16_fly_string, get_named_item_ns, 2, default_attributes);

    define_native_function(realm, "setNamedItem"_utf16_fly_string, set_named_item, 1, default_attributes);

    define_native_function(realm, "setNamedItemNS"_utf16_fly_string, set_named_item_ns, 1, default_attributes);

    define_native_function(realm, "removeNamedItem"_utf16_fly_string, remove_named_item, 1, default_attributes);

    define_native_function(realm, "removeNamedItemNS"_utf16_fly_string, remove_named_item_ns, 2, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "NamedNodeMap"_string), JS::Attribute::Configurable);
...
JS_DEFINE_NATIVE_FUNCTION(NamedNodeMapPrototype::get_named_item)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->get_named_item(qualified_name); }));
...
JS_DEFINE_NATIVE_FUNCTION(NamedNodeMapPrototype::get_named_item_ns)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->get_named_item_ns(namespace_, local_name); }));
...
JS_DEFINE_NATIVE_FUNCTION(NamedNodeMapPrototype::set_named_item)
{
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_named_item(attr); });
...
JS_DEFINE_NATIVE_FUNCTION(NamedNodeMapPrototype::set_named_item_ns)
{
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_named_item_ns(attr); });
...
JS_DEFINE_NATIVE_FUNCTION(NamedNodeMapPrototype::remove_named_item)
{
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->remove_named_item(qualified_name); });
...
JS_DEFINE_NATIVE_FUNCTION(NamedNodeMapPrototype::remove_named_item_ns)
{
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->remove_named_item_ns(namespace_, local_name); });
