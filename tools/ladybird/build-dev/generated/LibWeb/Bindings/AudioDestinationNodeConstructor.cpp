...
GC_DEFINE_ALLOCATOR(AudioDestinationNodeConstructor);

AudioDestinationNodeConstructor::AudioDestinationNodeConstructor(JS::Realm& realm)
    : NativeFunction("AudioDestinationNode"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

AudioDestinationNodeConstructor::~AudioDestinationNodeConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> AudioDestinationNodeConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "AudioDestinationNode");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> AudioDestinationNodeConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "AudioDestinationNodeConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "AudioDestinationNode");
}


void AudioDestinationNodeConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "AudioDestinationNode"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<AudioDestinationNodePrototype>(realm, "AudioDestinationNode"_fly_string), 0);
