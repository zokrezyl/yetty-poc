...
#include <LibWeb/Bindings/ServiceWorkerGlobalScopeGlobalMixin.h>
...
ServiceWorkerGlobalScopeGlobalMixin::ServiceWorkerGlobalScopeGlobalMixin() = default;
ServiceWorkerGlobalScopeGlobalMixin::~ServiceWorkerGlobalScopeGlobalMixin() = default;

void ServiceWorkerGlobalScopeGlobalMixin::initialize(JS::Realm& realm, JS::Object& object)
{
    ...
    object.set_prototype(&ensure_web_prototype<ServiceWorkerGlobalScopePrototype>(realm, "ServiceWorkerGlobalScope"_fly_string));

    object.define_direct_property("clients"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    object.define_direct_property("registration"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    object.define_direct_property("serviceWorker"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    auto native_oninstall_getter = JS::NativeFunction::create(realm, oninstall_getter, 0, "oninstall"_utf16_fly_string, &realm, "get"sv);

    auto native_oninstall_setter = JS::NativeFunction::create(realm, oninstall_setter, 1, "oninstall"_utf16_fly_string, &realm, "set"sv);

    object.define_direct_accessor("oninstall"_utf16_fly_string, native_oninstall_getter, native_oninstall_setter, default_attributes);

    auto native_onactivate_getter = JS::NativeFunction::create(realm, onactivate_getter, 0, "onactivate"_utf16_fly_string, &realm, "get"sv);

    auto native_onactivate_setter = JS::NativeFunction::create(realm, onactivate_setter, 1, "onactivate"_utf16_fly_string, &realm, "set"sv);

    object.define_direct_accessor("onactivate"_utf16_fly_string, native_onactivate_getter, native_onactivate_setter, default_attributes);

    auto native_onfetch_getter = JS::NativeFunction::create(realm, onfetch_getter, 0, "onfetch"_utf16_fly_string, &realm, "get"sv);

    auto native_onfetch_setter = JS::NativeFunction::create(realm, onfetch_setter, 1, "onfetch"_utf16_fly_string, &realm, "set"sv);

    object.define_direct_accessor("onfetch"_utf16_fly_string, native_onfetch_getter, native_onfetch_setter, default_attributes);
    ...
    object.define_direct_accessor("cookieStore"_utf16_fly_string, native_cookie_store_getter, native_cookie_store_setter, default_attributes);
        ...
        object.define_direct_property("skipWaiting"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    object.define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "ServiceWorkerGlobalScope"_string), JS::Attribute::Configurable);

}

void ServiceWorkerGlobalScopeGlobalMixin::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<ServiceWorker::ServiceWorkerGlobalScope*> impl_from(JS::VM& vm)
{
    ...
    if (!is<ServiceWorker::ServiceWorkerGlobalScope>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "ServiceWorkerGlobalScope");
    return static_cast<ServiceWorker::ServiceWorkerGlobalScope*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(ServiceWorkerGlobalScopeGlobalMixin::oninstall_getter)
{
    WebIDL::log_trace(vm, "ServiceWorkerGlobalScopeGlobalMixin::oninstall_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->oninstall(); }));
...
JS_DEFINE_NATIVE_FUNCTION(ServiceWorkerGlobalScopeGlobalMixin::oninstall_setter)
{
    WebIDL::log_trace(vm, "ServiceWorkerGlobalScopeGlobalMixin::oninstall_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_oninstall(cpp_value); }));

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(ServiceWorkerGlobalScopeGlobalMixin::onactivate_getter)
{
    WebIDL::log_trace(vm, "ServiceWorkerGlobalScopeGlobalMixin::onactivate_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->onactivate(); }));
...
JS_DEFINE_NATIVE_FUNCTION(ServiceWorkerGlobalScopeGlobalMixin::onactivate_setter)
{
    WebIDL::log_trace(vm, "ServiceWorkerGlobalScopeGlobalMixin::onactivate_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_onactivate(cpp_value); }));

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(ServiceWorkerGlobalScopeGlobalMixin::onfetch_getter)
{
    WebIDL::log_trace(vm, "ServiceWorkerGlobalScopeGlobalMixin::onfetch_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->onfetch(); }));
...
JS_DEFINE_NATIVE_FUNCTION(ServiceWorkerGlobalScopeGlobalMixin::onfetch_setter)
{
    WebIDL::log_trace(vm, "ServiceWorkerGlobalScopeGlobalMixin::onfetch_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_onfetch(cpp_value); }));

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(ServiceWorkerGlobalScopeGlobalMixin::onmessage_getter)
{
    WebIDL::log_trace(vm, "ServiceWorkerGlobalScopeGlobalMixin::onmessage_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ServiceWorkerGlobalScopeGlobalMixin::onmessage_setter)
{
    WebIDL::log_trace(vm, "ServiceWorkerGlobalScopeGlobalMixin::onmessage_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ServiceWorkerGlobalScopeGlobalMixin::onmessageerror_getter)
{
    WebIDL::log_trace(vm, "ServiceWorkerGlobalScopeGlobalMixin::onmessageerror_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ServiceWorkerGlobalScopeGlobalMixin::onmessageerror_setter)
{
    WebIDL::log_trace(vm, "ServiceWorkerGlobalScopeGlobalMixin::onmessageerror_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ServiceWorkerGlobalScopeGlobalMixin::cookie_store_getter)
{
    WebIDL::log_trace(vm, "ServiceWorkerGlobalScopeGlobalMixin::cookie_store_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
