...
GC_DEFINE_ALLOCATOR(HTMLDocumentPrototype);

HTMLDocumentPrototype::HTMLDocumentPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

HTMLDocumentPrototype::~HTMLDocumentPrototype()
{
}

void HTMLDocumentPrototype::initialize(JS::Realm& realm)
{
    ...
    set_prototype(&ensure_web_prototype<DocumentPrototype>(realm, "Document"_fly_string));


    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLDocument"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLDocumentPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
