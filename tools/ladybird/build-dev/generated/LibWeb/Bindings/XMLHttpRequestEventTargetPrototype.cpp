...
GC_DEFINE_ALLOCATOR(XMLHttpRequestEventTargetPrototype);

XMLHttpRequestEventTargetPrototype::XMLHttpRequestEventTargetPrototype([[maybe_unused]] JS::Realm& realm)
...
void XMLHttpRequestEventTargetPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_ontimeout_getter = JS::NativeFunction::create(realm, ontimeout_getter, 0, "ontimeout"_utf16_fly_string, &realm, "get"sv);

    auto native_ontimeout_setter = JS::NativeFunction::create(realm, ontimeout_setter, 1, "ontimeout"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("ontimeout"_utf16_fly_string, native_ontimeout_getter, native_ontimeout_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "XMLHttpRequestEventTarget"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void XMLHttpRequestEventTargetPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<XHR::XMLHttpRequestEventTarget*> impl_from(JS::VM& vm)
{
    ...
    if (!is<XHR::XMLHttpRequestEventTarget>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "XMLHttpRequestEventTarget");
    return static_cast<XHR::XMLHttpRequestEventTarget*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(XMLHttpRequestEventTargetPrototype::onloadstart_getter)
{
    WebIDL::log_trace(vm, "XMLHttpRequestEventTargetPrototype::onloadstart_getter");
...
{
    WebIDL::log_trace(vm, "XMLHttpRequestEventTargetPrototype::onloadstart_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "XMLHttpRequestEventTargetPrototype::onprogress_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "XMLHttpRequestEventTargetPrototype::onprogress_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "XMLHttpRequestEventTargetPrototype::onabort_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "XMLHttpRequestEventTargetPrototype::onabort_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "XMLHttpRequestEventTargetPrototype::onerror_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "XMLHttpRequestEventTargetPrototype::onerror_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "XMLHttpRequestEventTargetPrototype::onload_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "XMLHttpRequestEventTargetPrototype::onload_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "XMLHttpRequestEventTargetPrototype::ontimeout_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->ontimeout(); }));
...
{
    WebIDL::log_trace(vm, "XMLHttpRequestEventTargetPrototype::ontimeout_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_ontimeout(cpp_value); }));
...
{
    WebIDL::log_trace(vm, "XMLHttpRequestEventTargetPrototype::onloadend_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "XMLHttpRequestEventTargetPrototype::onloadend_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
