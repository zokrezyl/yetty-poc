...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLFieldSetElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLFieldSetElementPrototype);

HTMLFieldSetElementPrototype::HTMLFieldSetElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLFieldSetElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_elements_getter = JS::NativeFunction::create(realm, elements_getter, 0, "elements"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_elements_setter;

    define_direct_accessor("elements"_utf16_fly_string, native_elements_getter, native_elements_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLFieldSetElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLFieldSetElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLFieldSetElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLFieldSetElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLFieldSetElement");
    return static_cast<HTML::HTMLFieldSetElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLFieldSetElementPrototype::disabled_getter)
{
    WebIDL::log_trace(vm, "HTMLFieldSetElementPrototype::disabled_getter");
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFieldSetElementPrototype::disabled_setter)
{
    WebIDL::log_trace(vm, "HTMLFieldSetElementPrototype::disabled_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFieldSetElementPrototype::form_getter)
{
    WebIDL::log_trace(vm, "HTMLFieldSetElementPrototype::form_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFieldSetElementPrototype::name_getter)
{
    WebIDL::log_trace(vm, "HTMLFieldSetElementPrototype::name_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFieldSetElementPrototype::name_setter)
{
    WebIDL::log_trace(vm, "HTMLFieldSetElementPrototype::name_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLFieldSetElementPrototype::type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFieldSetElementPrototype::elements_getter)
{
    WebIDL::log_trace(vm, "HTMLFieldSetElementPrototype::elements_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->elements(); }));

    return &const_cast<HTMLCollection&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(HTMLFieldSetElementPrototype::will_validate_getter)
{
    WebIDL::log_trace(vm, "HTMLFieldSetElementPrototype::will_validate_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFieldSetElementPrototype::validity_getter)
{
    WebIDL::log_trace(vm, "HTMLFieldSetElementPrototype::validity_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFieldSetElementPrototype::validation_message_getter)
{
    WebIDL::log_trace(vm, "HTMLFieldSetElementPrototype::validation_message_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFieldSetElementPrototype::check_validity)
{
    WebIDL::log_trace(vm, "HTMLFieldSetElementPrototype::check_validity");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFieldSetElementPrototype::report_validity)
{
    WebIDL::log_trace(vm, "HTMLFieldSetElementPrototype::report_validity");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLFieldSetElementPrototype::set_custom_validity)
{
    WebIDL::log_trace(vm, "HTMLFieldSetElementPrototype::set_custom_validity");
    [[maybe_unused]] auto& realm = *vm.current_realm();
