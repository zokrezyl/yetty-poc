...
GC_DEFINE_ALLOCATOR(HTMLBRElementPrototype);

HTMLBRElementPrototype::HTMLBRElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLBRElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_clear_getter = JS::NativeFunction::create(realm, clear_getter, 0, "clear"_utf16_fly_string, &realm, "get"sv);

    auto native_clear_setter = JS::NativeFunction::create(realm, clear_setter, 1, "clear"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("clear"_utf16_fly_string, native_clear_getter, native_clear_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLBRElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLBRElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLBRElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLBRElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLBRElement");
    return static_cast<HTML::HTMLBRElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLBRElementPrototype::clear_getter)
{
    WebIDL::log_trace(vm, "HTMLBRElementPrototype::clear_getter");
    ...
    auto contentAttributeValue = impl->attribute("clear"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLBRElementPrototype::clear_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("clear"_fly_string, cpp_value);
