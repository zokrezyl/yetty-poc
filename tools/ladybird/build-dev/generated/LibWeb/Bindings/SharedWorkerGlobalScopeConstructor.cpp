...
GC_DEFINE_ALLOCATOR(SharedWorkerGlobalScopeConstructor);

SharedWorkerGlobalScopeConstructor::SharedWorkerGlobalScopeConstructor(JS::Realm& realm)
    : NativeFunction("SharedWorkerGlobalScope"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SharedWorkerGlobalScopeConstructor::~SharedWorkerGlobalScopeConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SharedWorkerGlobalScopeConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SharedWorkerGlobalScope");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SharedWorkerGlobalScopeConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SharedWorkerGlobalScopeConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SharedWorkerGlobalScope");
}


void SharedWorkerGlobalScopeConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SharedWorkerGlobalScope"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SharedWorkerGlobalScopePrototype>(realm, "SharedWorkerGlobalScope"_fly_string), 0);
