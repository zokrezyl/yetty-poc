...
GC_DEFINE_ALLOCATOR(SVGGradientElementConstructor);

SVGGradientElementConstructor::SVGGradientElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGGradientElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGGradientElementConstructor::~SVGGradientElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGGradientElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGGradientElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGGradientElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGGradientElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGGradientElement");
}


void SVGGradientElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGGradientElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGGradientElementPrototype>(realm, "SVGGradientElement"_fly_string), 0);
