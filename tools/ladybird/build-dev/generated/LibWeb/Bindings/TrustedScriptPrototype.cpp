...
GC_DEFINE_ALLOCATOR(TrustedScriptPrototype);

TrustedScriptPrototype::TrustedScriptPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

TrustedScriptPrototype::~TrustedScriptPrototype()
{
}

void TrustedScriptPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "TrustedScript"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<TrustedScript*> impl_from(JS::VM& vm)
{
