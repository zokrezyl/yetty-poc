...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGMetadataElement.h>
...
GC_DEFINE_ALLOCATOR(SVGMetadataElementConstructor);

SVGMetadataElementConstructor::SVGMetadataElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGMetadataElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGMetadataElementConstructor::~SVGMetadataElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGMetadataElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGMetadataElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGMetadataElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGMetadataElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGMetadataElement");
}


void SVGMetadataElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGMetadataElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGMetadataElementPrototype>(realm, "SVGMetadataElement"_fly_string), 0);
