...
GC_DEFINE_ALLOCATOR(CSSKeyframesRuleConstructor);

CSSKeyframesRuleConstructor::CSSKeyframesRuleConstructor(JS::Realm& realm)
    : NativeFunction("CSSKeyframesRule"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

CSSKeyframesRuleConstructor::~CSSKeyframesRuleConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> CSSKeyframesRuleConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "CSSKeyframesRule");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> CSSKeyframesRuleConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "CSSKeyframesRuleConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "CSSKeyframesRule");
}


void CSSKeyframesRuleConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "CSSKeyframesRule"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<CSSKeyframesRulePrototype>(realm, "CSSKeyframesRule"_fly_string), 0);
