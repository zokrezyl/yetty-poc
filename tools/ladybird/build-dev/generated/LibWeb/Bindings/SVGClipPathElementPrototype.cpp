...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGClipPathElement.h>
...
GC_DEFINE_ALLOCATOR(SVGClipPathElementPrototype);

SVGClipPathElementPrototype::SVGClipPathElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void SVGClipPathElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property("clipPathUnits"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property("transform"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGClipPathElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGClipPathElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGClipPathElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGClipPathElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGClipPathElement");
    return static_cast<SVG::SVGClipPathElement*>(this_object);
}
