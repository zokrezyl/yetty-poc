...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/ResizeObserver/ResizeObserverEntry.h>
...
GC_DEFINE_ALLOCATOR(ResizeObserverEntryPrototype);

ResizeObserverEntryPrototype::ResizeObserverEntryPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

ResizeObserverEntryPrototype::~ResizeObserverEntryPrototype()
{
}

void ResizeObserverEntryPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_content_rect_getter = JS::NativeFunction::create(realm, content_rect_getter, 0, "contentRect"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_content_rect_setter;

    define_direct_accessor("contentRect"_utf16_fly_string, native_content_rect_getter, native_content_rect_setter, default_attributes);

    auto native_border_box_size_getter = JS::NativeFunction::create(realm, border_box_size_getter, 0, "borderBoxSize"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_border_box_size_setter;

    define_direct_accessor("borderBoxSize"_utf16_fly_string, native_border_box_size_getter, native_border_box_size_setter, default_attributes);

    auto native_content_box_size_getter = JS::NativeFunction::create(realm, content_box_size_getter, 0, "contentBoxSize"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_content_box_size_setter;

    define_direct_accessor("contentBoxSize"_utf16_fly_string, native_content_box_size_getter, native_content_box_size_setter, default_attributes);

    auto native_device_pixel_content_box_size_getter = JS::NativeFunction::create(realm, device_pixel_content_box_size_getter, 0, "devicePixelContentBoxSize"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_device_pixel_content_box_size_setter;

    define_direct_accessor("devicePixelContentBoxSize"_utf16_fly_string, native_device_pixel_content_box_size_getter, native_device_pixel_content_box_size_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "ResizeObserverEntry"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<ResizeObserver::ResizeObserverEntry*> impl_from(JS::VM& vm)
{
    ...
    if (!is<ResizeObserver::ResizeObserverEntry>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "ResizeObserverEntry");
    return static_cast<ResizeObserver::ResizeObserverEntry*>(this_object);
}
...
JS_DEFINE_NATIVE_FUNCTION(ResizeObserverEntryPrototype::content_rect_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->content_rect(); }));
...
JS_DEFINE_NATIVE_FUNCTION(ResizeObserverEntryPrototype::border_box_size_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->border_box_size(); }));
...
JS::Value wrapped_element0;
    ...
    wrapped_element0 = &const_cast<ResizeObserverSize&>(*element0);
...
JS_DEFINE_NATIVE_FUNCTION(ResizeObserverEntryPrototype::content_box_size_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->content_box_size(); }));
...
JS_DEFINE_NATIVE_FUNCTION(ResizeObserverEntryPrototype::device_pixel_content_box_size_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->device_pixel_content_box_size(); }));
