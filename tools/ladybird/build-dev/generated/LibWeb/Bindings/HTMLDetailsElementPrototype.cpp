...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLDetailsElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLDetailsElementPrototype);

HTMLDetailsElementPrototype::HTMLDetailsElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLDetailsElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_open_getter = JS::NativeFunction::create(realm, open_getter, 0, "open"_utf16_fly_string, &realm, "get"sv);

    auto native_open_setter = JS::NativeFunction::create(realm, open_setter, 1, "open"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("open"_utf16_fly_string, native_open_getter, native_open_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLDetailsElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLDetailsElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLDetailsElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLDetailsElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLDetailsElement");
    return static_cast<HTML::HTMLDetailsElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLDetailsElementPrototype::name_getter)
{
    WebIDL::log_trace(vm, "HTMLDetailsElementPrototype::name_getter");
...
JS_DEFINE_NATIVE_FUNCTION(HTMLDetailsElementPrototype::name_setter)
{
    WebIDL::log_trace(vm, "HTMLDetailsElementPrototype::name_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLDetailsElementPrototype::open_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval = impl->has_attribute("open"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLDetailsElementPrototype::open_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value)
        impl->remove_attribute("open"_fly_string);
    else
        impl->set_attribute_value("open"_fly_string, String {});
