...
GC_DEFINE_ALLOCATOR(CredentialPrototype);

CredentialPrototype::CredentialPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

CredentialPrototype::~CredentialPrototype()
{
}

void CredentialPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "Credential"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CredentialPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<Credential*> impl_from(JS::VM& vm)
{
    ...
    if (!is<Credential>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "Credential");
    return static_cast<Credential*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CredentialPrototype::id_getter)
{
    WebIDL::log_trace(vm, "CredentialPrototype::id_getter");
...
JS_DEFINE_NATIVE_FUNCTION(CredentialPrototype::type_getter)
{
    WebIDL::log_trace(vm, "CredentialPrototype::type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
