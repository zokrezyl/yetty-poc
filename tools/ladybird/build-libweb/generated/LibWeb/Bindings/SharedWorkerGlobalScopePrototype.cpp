...
GC_DEFINE_ALLOCATOR(SharedWorkerGlobalScopePrototype);

SharedWorkerGlobalScopePrototype::SharedWorkerGlobalScopePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SharedWorkerGlobalScopePrototype::~SharedWorkerGlobalScopePrototype()
{
}

void SharedWorkerGlobalScopePrototype::initialize(JS::Realm& realm)
{
    Base::initialize(realm);

    set_prototype(&ensure_web_prototype<WorkerGlobalScopePrototype>(realm, "WorkerGlobalScope"_fly_string));
