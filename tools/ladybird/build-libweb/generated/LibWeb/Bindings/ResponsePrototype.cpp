...
GC_DEFINE_ALLOCATOR(ResponsePrototype);

ResponsePrototype::ResponsePrototype([[maybe_unused]] JS::Realm& realm)
...
void ResponsePrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_redirected_getter = JS::NativeFunction::create(realm, redirected_getter, 0, "redirected"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_redirected_setter;

    define_direct_accessor("redirected"_utf16_fly_string, native_redirected_getter, native_redirected_setter, default_attributes);
    ...
    auto native_ok_getter = JS::NativeFunction::create(realm, ok_getter, 0, "ok"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_ok_setter;

    define_direct_accessor("ok"_utf16_fly_string, native_ok_getter, native_ok_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "Response"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void ResponsePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<Fetch::Response*> impl_from(JS::VM& vm)
{
    ...
    if (!is<Fetch::Response>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "Response");
    return static_cast<Fetch::Response*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(ResponsePrototype::type_getter)
{
    WebIDL::log_trace(vm, "ResponsePrototype::type_getter");
...
JS_DEFINE_NATIVE_FUNCTION(ResponsePrototype::url_getter)
{
    WebIDL::log_trace(vm, "ResponsePrototype::url_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ResponsePrototype::redirected_getter)
{
    WebIDL::log_trace(vm, "ResponsePrototype::redirected_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->redirected(); }));

    return JS::Value(retval);

}

JS_DEFINE_NATIVE_FUNCTION(ResponsePrototype::status_getter)
{
    WebIDL::log_trace(vm, "ResponsePrototype::status_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ResponsePrototype::ok_getter)
{
    WebIDL::log_trace(vm, "ResponsePrototype::ok_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->ok(); }));

    return JS::Value(retval);

}

JS_DEFINE_NATIVE_FUNCTION(ResponsePrototype::status_text_getter)
{
    WebIDL::log_trace(vm, "ResponsePrototype::status_text_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ResponsePrototype::headers_getter)
{
    WebIDL::log_trace(vm, "ResponsePrototype::headers_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ResponsePrototype::body_getter)
{
    WebIDL::log_trace(vm, "ResponsePrototype::body_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ResponsePrototype::body_used_getter)
{
    WebIDL::log_trace(vm, "ResponsePrototype::body_used_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ResponsePrototype::clone)
{
    WebIDL::log_trace(vm, "ResponsePrototype::clone");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ResponsePrototype::array_buffer)
{
    WebIDL::log_trace(vm, "ResponsePrototype::array_buffer");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ResponsePrototype::blob)
{
    WebIDL::log_trace(vm, "ResponsePrototype::blob");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ResponsePrototype::bytes)
{
    WebIDL::log_trace(vm, "ResponsePrototype::bytes");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ResponsePrototype::form_data)
{
    WebIDL::log_trace(vm, "ResponsePrototype::form_data");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ResponsePrototype::json)
{
    WebIDL::log_trace(vm, "ResponsePrototype::json");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ResponsePrototype::text)
{
    WebIDL::log_trace(vm, "ResponsePrototype::text");
    [[maybe_unused]] auto& realm = *vm.current_realm();
