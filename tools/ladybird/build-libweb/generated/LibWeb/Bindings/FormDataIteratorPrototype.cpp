...
void FormDataIteratorPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "FormData Iterator"_string), JS::Attribute::Configurable);
}

static JS::ThrowCompletionOr<XHR::FormDataIterator*> impl_from(JS::VM& vm)
{
