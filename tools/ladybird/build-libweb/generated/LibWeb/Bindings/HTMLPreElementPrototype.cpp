...
GC_DEFINE_ALLOCATOR(HTMLPreElementPrototype);

HTMLPreElementPrototype::HTMLPreElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLPreElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLPreElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLPreElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLPreElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLPreElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLPreElement");
    return static_cast<HTML::HTMLPreElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLPreElementPrototype::width_getter)
{
    WebIDL::log_trace(vm, "HTMLPreElementPrototype::width_getter");
...
JS_DEFINE_NATIVE_FUNCTION(HTMLPreElementPrototype::width_setter)
{
    WebIDL::log_trace(vm, "HTMLPreElementPrototype::width_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("width"_fly_string, String::number(cpp_value));
