...
GC_DEFINE_ALLOCATOR(SVGFEFuncAElementPrototype);

SVGFEFuncAElementPrototype::SVGFEFuncAElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGFEFuncAElementPrototype::~SVGFEFuncAElementPrototype()
{
}

void SVGFEFuncAElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGFEFuncAElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGFEFuncAElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
