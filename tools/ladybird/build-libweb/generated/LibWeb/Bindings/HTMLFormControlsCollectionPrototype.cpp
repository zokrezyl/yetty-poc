...
GC_DEFINE_ALLOCATOR(HTMLFormControlsCollectionPrototype);

HTMLFormControlsCollectionPrototype::HTMLFormControlsCollectionPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

HTMLFormControlsCollectionPrototype::~HTMLFormControlsCollectionPrototype()
{
}

void HTMLFormControlsCollectionPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLFormControlsCollection"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLFormControlsCollectionPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLFormControlsCollection*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLFormControlsCollection>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLFormControlsCollection");
    return static_cast<HTML::HTMLFormControlsCollection*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLFormControlsCollectionPrototype::named_item)
{
    WebIDL::log_trace(vm, "HTMLFormControlsCollectionPrototype::named_item");
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->named_item_or_radio_node_list(name); }));

    return retval.visit(

        [&vm, &realm]([[maybe_unused]] GC::Root<RadioNodeList> const& visited_union_value0) -> JS::Value {
            // These may be unused.
            (void)vm;
            (void)realm;

    return &const_cast<RadioNodeList&>(*visited_union_value0);
