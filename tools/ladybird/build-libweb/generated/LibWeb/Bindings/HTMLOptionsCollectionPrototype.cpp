...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLOptionsCollection.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/DOM/HTMLCollection.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLOptionElement.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLOptGroupElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLOptionsCollectionPrototype);

HTMLOptionsCollectionPrototype::HTMLOptionsCollectionPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLOptionsCollectionPrototype::initialize(JS::Realm& realm)
{
    ...
    set_prototype(&ensure_web_prototype<HTMLCollectionPrototype>(realm, "HTMLCollection"_fly_string));
    ...
    auto native_selected_index_getter = JS::NativeFunction::create(realm, selected_index_getter, 0, "selectedIndex"_utf16_fly_string, &realm, "get"sv);

    auto native_selected_index_setter = JS::NativeFunction::create(realm, selected_index_setter, 1, "selectedIndex"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("selectedIndex"_utf16_fly_string, native_selected_index_getter, native_selected_index_setter, default_attributes);

    define_native_function(realm, "add"_utf16_fly_string, add, 1, default_attributes);

    define_native_function(realm, "remove"_utf16_fly_string, remove, 1, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLOptionsCollection"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLOptionsCollectionPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLOptionsCollection*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLOptionsCollection>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLOptionsCollection");
    return static_cast<HTML::HTMLOptionsCollection*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLOptionsCollectionPrototype::length_getter)
{
    WebIDL::log_trace(vm, "HTMLOptionsCollectionPrototype::length_getter");
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->length(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOptionsCollectionPrototype::length_setter)
{
    WebIDL::log_trace(vm, "HTMLOptionsCollectionPrototype::length_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_length(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOptionsCollectionPrototype::selected_index_getter)
{
    WebIDL::log_trace(vm, "HTMLOptionsCollectionPrototype::selected_index_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->selected_index(); }));

    return JS::Value(static_cast<WebIDL::Long>(retval));

}

JS_DEFINE_NATIVE_FUNCTION(HTMLOptionsCollectionPrototype::selected_index_setter)
{
    WebIDL::log_trace(vm, "HTMLOptionsCollectionPrototype::selected_index_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_selected_index(cpp_value); }));
...
{
    WebIDL::log_trace(vm, "HTMLOptionsCollectionPrototype::add");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto arg0_to_variant = [&vm, &realm](JS::Value arg0) -> JS::ThrowCompletionOr<Variant<GC::Root<HTMLOptionElement>, GC::Root<HTMLOptGroupElement>>> {
        ...
        if (arg0.is_object()) {
            ...
            if (is<PlatformObject>(arg0_object)) {
                ...
                if (auto* arg0_result = as_if<HTMLOptionElement>(arg0_object))
                    return GC::make_root(*arg0_result);

                if (auto* arg0_result = as_if<HTMLOptGroupElement>(arg0_object))
                    return GC::make_root(*arg0_result);
    ...
    Variant<GC::Root<HTMLOptionElement>, GC::Root<HTMLOptGroupElement>> element = TRY(arg0_to_variant(arg0));

    auto arg1 = vm.argument(1);

    auto arg1_to_variant = [&vm, &realm](JS::Value arg1) -> JS::ThrowCompletionOr<Variant<GC::Root<HTMLElement>, WebIDL::Long>> {
        // These might be unused.
        (void)vm;
        (void)realm;
        ...
        if (arg1.is_object()) {
            ...
            if (is<PlatformObject>(arg1_object)) {
                ...
                if (auto* arg1_result = as_if<HTMLElement>(arg1_object))
    ...
    WebIDL::Long arg1_number;

    arg1_number = TRY(WebIDL::convert_to_int<WebIDL::Long>(vm, arg1, WebIDL::EnforceRange::No, WebIDL::Clamp::No));
    ...
    Optional<Variant<GC::Root<HTMLElement>, WebIDL::Long>> before;
    if (!arg1.is_nullish())
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->add(element, before); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOptionsCollectionPrototype::remove)
{
    WebIDL::log_trace(vm, "HTMLOptionsCollectionPrototype::remove");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->remove(index); });
