...
GC_DEFINE_ALLOCATOR(HTMLTimeElementPrototype);

HTMLTimeElementPrototype::HTMLTimeElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLTimeElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLTimeElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLTimeElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLTimeElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLTimeElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLTimeElement");
    return static_cast<HTML::HTMLTimeElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLTimeElementPrototype::date_time_getter)
{
    WebIDL::log_trace(vm, "HTMLTimeElementPrototype::date_time_getter");
...
{
    WebIDL::log_trace(vm, "HTMLTimeElementPrototype::date_time_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
