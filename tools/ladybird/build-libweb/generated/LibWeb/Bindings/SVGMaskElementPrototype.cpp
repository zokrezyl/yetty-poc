...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGMaskElement.h>
...
GC_DEFINE_ALLOCATOR(SVGMaskElementPrototype);

SVGMaskElementPrototype::SVGMaskElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGMaskElementPrototype::~SVGMaskElementPrototype()
{
}

void SVGMaskElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property("maskUnits"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property("maskContentUnits"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property("x"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property("y"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property("width"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property("height"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGMaskElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGMaskElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGMaskElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGMaskElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGMaskElement");
    return static_cast<SVG::SVGMaskElement*>(this_object);
}
