...
GC_DEFINE_ALLOCATOR(HTMLTitleElementPrototype);

HTMLTitleElementPrototype::HTMLTitleElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLTitleElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLTitleElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLTitleElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLTitleElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLTitleElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLTitleElement");
    return static_cast<HTML::HTMLTitleElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLTitleElementPrototype::text_getter)
{
    WebIDL::log_trace(vm, "HTMLTitleElementPrototype::text_getter");
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTitleElementPrototype::text_setter)
{
    WebIDL::log_trace(vm, "HTMLTitleElementPrototype::text_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
