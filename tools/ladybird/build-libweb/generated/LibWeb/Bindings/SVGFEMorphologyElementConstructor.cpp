...
GC_DEFINE_ALLOCATOR(SVGFEMorphologyElementConstructor);

SVGFEMorphologyElementConstructor::SVGFEMorphologyElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGFEMorphologyElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGFEMorphologyElementConstructor::~SVGFEMorphologyElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGFEMorphologyElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGFEMorphologyElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGFEMorphologyElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGFEMorphologyElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGFEMorphologyElement");
}


void SVGFEMorphologyElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGFEMorphologyElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGFEMorphologyElementPrototype>(realm, "SVGFEMorphologyElement"_fly_string), 0);
