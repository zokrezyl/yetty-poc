...
GC_DEFINE_ALLOCATOR(StyleSheetPrototype);

StyleSheetPrototype::StyleSheetPrototype([[maybe_unused]] JS::Realm& realm)
...
void StyleSheetPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_owner_node_getter = JS::NativeFunction::create(realm, owner_node_getter, 0, "ownerNode"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_owner_node_setter;

    define_direct_accessor("ownerNode"_utf16_fly_string, native_owner_node_getter, native_owner_node_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "StyleSheet"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void StyleSheetPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::StyleSheet*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::StyleSheet>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "StyleSheet");
    return static_cast<CSS::StyleSheet*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(StyleSheetPrototype::type_getter)
{
    WebIDL::log_trace(vm, "StyleSheetPrototype::type_getter");
...
{
    WebIDL::log_trace(vm, "StyleSheetPrototype::href_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "StyleSheetPrototype::owner_node_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->owner_node(); }));
...
{
    WebIDL::log_trace(vm, "StyleSheetPrototype::parent_style_sheet_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "StyleSheetPrototype::title_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->title_for_bindings(); }));
...
JS_DEFINE_NATIVE_FUNCTION(StyleSheetPrototype::media_getter)
{
    WebIDL::log_trace(vm, "StyleSheetPrototype::media_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(StyleSheetPrototype::media_setter)
{
    WebIDL::log_trace(vm, "StyleSheetPrototype::media_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "StyleSheetPrototype::disabled_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "StyleSheetPrototype::disabled_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
