...
GC_DEFINE_ALLOCATOR(HTMLDListElementPrototype);

HTMLDListElementPrototype::HTMLDListElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLDListElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLDListElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLDListElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLDListElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLDListElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLDListElement");
    return static_cast<HTML::HTMLDListElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLDListElementPrototype::compact_getter)
{
    WebIDL::log_trace(vm, "HTMLDListElementPrototype::compact_getter");
...
{
    WebIDL::log_trace(vm, "HTMLDListElementPrototype::compact_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
