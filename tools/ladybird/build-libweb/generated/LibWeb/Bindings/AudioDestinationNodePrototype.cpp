...
GC_DEFINE_ALLOCATOR(AudioDestinationNodePrototype);

AudioDestinationNodePrototype::AudioDestinationNodePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

AudioDestinationNodePrototype::~AudioDestinationNodePrototype()
{
}

void AudioDestinationNodePrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_max_channel_count_getter = JS::NativeFunction::create(realm, max_channel_count_getter, 0, "maxChannelCount"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_max_channel_count_setter;

    define_direct_accessor("maxChannelCount"_utf16_fly_string, native_max_channel_count_getter, native_max_channel_count_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "AudioDestinationNode"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void AudioDestinationNodePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<WebAudio::AudioDestinationNode*> impl_from(JS::VM& vm)
{
    ...
    if (!is<WebAudio::AudioDestinationNode>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "AudioDestinationNode");
    return static_cast<WebAudio::AudioDestinationNode*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(AudioDestinationNodePrototype::max_channel_count_getter)
{
    WebIDL::log_trace(vm, "AudioDestinationNodePrototype::max_channel_count_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->max_channel_count(); }));
