...
GC_DEFINE_ALLOCATOR(FormDataEventPrototype);

FormDataEventPrototype::FormDataEventPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

FormDataEventPrototype::~FormDataEventPrototype()
{
}

void FormDataEventPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "FormDataEvent"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void FormDataEventPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::FormDataEvent*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::FormDataEvent>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "FormDataEvent");
    return static_cast<HTML::FormDataEvent*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(FormDataEventPrototype::form_data_getter)
{
    WebIDL::log_trace(vm, "FormDataEventPrototype::form_data_getter");
