...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGPatternElement.h>
...
GC_DEFINE_ALLOCATOR(SVGPatternElementPrototype);

SVGPatternElementPrototype::SVGPatternElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGPatternElementPrototype::~SVGPatternElementPrototype()
{
}

void SVGPatternElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property("patternUnits"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property("patternContentUnits"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property("patternTransform"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGPatternElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGPatternElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGPatternElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGPatternElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGPatternElement");
    return static_cast<SVG::SVGPatternElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGPatternElementPrototype::x_getter)
{
    WebIDL::log_trace(vm, "SVGPatternElementPrototype::x_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SVGPatternElementPrototype::y_getter)
{
    WebIDL::log_trace(vm, "SVGPatternElementPrototype::y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGPatternElementPrototype::width_getter)
{
    WebIDL::log_trace(vm, "SVGPatternElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGPatternElementPrototype::height_getter)
{
    WebIDL::log_trace(vm, "SVGPatternElementPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGPatternElementPrototype::view_box_getter)
{
    WebIDL::log_trace(vm, "SVGPatternElementPrototype::view_box_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGPatternElementPrototype::href_getter)
{
    WebIDL::log_trace(vm, "SVGPatternElementPrototype::href_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
