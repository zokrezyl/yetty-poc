...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGFEImageElement.h>
...
GC_DEFINE_ALLOCATOR(SVGFEImageElementPrototype);

SVGFEImageElementPrototype::SVGFEImageElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGFEImageElementPrototype::~SVGFEImageElementPrototype()
{
}

void SVGFEImageElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property("crossOrigin"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGFEImageElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGFEImageElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGFEImageElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGFEImageElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGFEImageElement");
    return static_cast<SVG::SVGFEImageElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGFEImageElementPrototype::x_getter)
{
    WebIDL::log_trace(vm, "SVGFEImageElementPrototype::x_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEImageElementPrototype::y_getter)
{
    WebIDL::log_trace(vm, "SVGFEImageElementPrototype::y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEImageElementPrototype::width_getter)
{
    WebIDL::log_trace(vm, "SVGFEImageElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEImageElementPrototype::height_getter)
{
    WebIDL::log_trace(vm, "SVGFEImageElementPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEImageElementPrototype::result_getter)
{
    WebIDL::log_trace(vm, "SVGFEImageElementPrototype::result_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEImageElementPrototype::href_getter)
{
    WebIDL::log_trace(vm, "SVGFEImageElementPrototype::href_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
