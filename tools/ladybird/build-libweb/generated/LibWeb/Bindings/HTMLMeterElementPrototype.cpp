...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLMeterElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLMeterElementPrototype);

HTMLMeterElementPrototype::HTMLMeterElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLMeterElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_min_getter = JS::NativeFunction::create(realm, min_getter, 0, "min"_utf16_fly_string, &realm, "get"sv);

    auto native_min_setter = JS::NativeFunction::create(realm, min_setter, 1, "min"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("min"_utf16_fly_string, native_min_getter, native_min_setter, default_attributes);

    auto native_max_getter = JS::NativeFunction::create(realm, max_getter, 0, "max"_utf16_fly_string, &realm, "get"sv);

    auto native_max_setter = JS::NativeFunction::create(realm, max_setter, 1, "max"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("max"_utf16_fly_string, native_max_getter, native_max_setter, default_attributes);

    auto native_low_getter = JS::NativeFunction::create(realm, low_getter, 0, "low"_utf16_fly_string, &realm, "get"sv);

    auto native_low_setter = JS::NativeFunction::create(realm, low_setter, 1, "low"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("low"_utf16_fly_string, native_low_getter, native_low_setter, default_attributes);

    auto native_high_getter = JS::NativeFunction::create(realm, high_getter, 0, "high"_utf16_fly_string, &realm, "get"sv);

    auto native_high_setter = JS::NativeFunction::create(realm, high_setter, 1, "high"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("high"_utf16_fly_string, native_high_getter, native_high_setter, default_attributes);

    auto native_optimum_getter = JS::NativeFunction::create(realm, optimum_getter, 0, "optimum"_utf16_fly_string, &realm, "get"sv);

    auto native_optimum_setter = JS::NativeFunction::create(realm, optimum_setter, 1, "optimum"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("optimum"_utf16_fly_string, native_optimum_getter, native_optimum_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLMeterElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLMeterElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLMeterElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLMeterElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLMeterElement");
    return static_cast<HTML::HTMLMeterElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLMeterElementPrototype::value_getter)
{
    WebIDL::log_trace(vm, "HTMLMeterElementPrototype::value_getter");
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMeterElementPrototype::value_setter)
{
    WebIDL::log_trace(vm, "HTMLMeterElementPrototype::value_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMeterElementPrototype::min_getter)
{
    WebIDL::log_trace(vm, "HTMLMeterElementPrototype::min_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->min(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMeterElementPrototype::min_setter)
{
    WebIDL::log_trace(vm, "HTMLMeterElementPrototype::min_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (isinf(cpp_value) || isnan(cpp_value)) {
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::InvalidRestrictedFloatingPointParameter, "min");
    }
    
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_min(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMeterElementPrototype::max_getter)
{
    WebIDL::log_trace(vm, "HTMLMeterElementPrototype::max_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->max(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMeterElementPrototype::max_setter)
{
    WebIDL::log_trace(vm, "HTMLMeterElementPrototype::max_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (isinf(cpp_value) || isnan(cpp_value)) {
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::InvalidRestrictedFloatingPointParameter, "max");
    }
    
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_max(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMeterElementPrototype::low_getter)
{
    WebIDL::log_trace(vm, "HTMLMeterElementPrototype::low_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->low(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMeterElementPrototype::low_setter)
{
    WebIDL::log_trace(vm, "HTMLMeterElementPrototype::low_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (isinf(cpp_value) || isnan(cpp_value)) {
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::InvalidRestrictedFloatingPointParameter, "low");
    }
    
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_low(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMeterElementPrototype::high_getter)
{
    WebIDL::log_trace(vm, "HTMLMeterElementPrototype::high_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->high(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMeterElementPrototype::high_setter)
{
    WebIDL::log_trace(vm, "HTMLMeterElementPrototype::high_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (isinf(cpp_value) || isnan(cpp_value)) {
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::InvalidRestrictedFloatingPointParameter, "high");
    }
    
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_high(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMeterElementPrototype::optimum_getter)
{
    WebIDL::log_trace(vm, "HTMLMeterElementPrototype::optimum_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->optimum(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMeterElementPrototype::optimum_setter)
{
    WebIDL::log_trace(vm, "HTMLMeterElementPrototype::optimum_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (isinf(cpp_value) || isnan(cpp_value)) {
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::InvalidRestrictedFloatingPointParameter, "optimum");
    }
    
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_optimum(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLMeterElementPrototype::labels_getter)
{
    WebIDL::log_trace(vm, "HTMLMeterElementPrototype::labels_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
