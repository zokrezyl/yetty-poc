...
GC_DEFINE_ALLOCATOR(XPathResultPrototype);

XPathResultPrototype::XPathResultPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

XPathResultPrototype::~XPathResultPrototype()
{
}

void XPathResultPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_result_type_getter = JS::NativeFunction::create(realm, result_type_getter, 0, "resultType"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_result_type_setter;

    define_direct_accessor("resultType"_utf16_fly_string, native_result_type_getter, native_result_type_setter, default_attributes);

    auto native_number_value_getter = JS::NativeFunction::create(realm, number_value_getter, 0, "numberValue"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_number_value_setter;

    define_direct_accessor("numberValue"_utf16_fly_string, native_number_value_getter, native_number_value_setter, default_attributes);

    auto native_string_value_getter = JS::NativeFunction::create(realm, string_value_getter, 0, "stringValue"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_string_value_setter;

    define_direct_accessor("stringValue"_utf16_fly_string, native_string_value_getter, native_string_value_setter, default_attributes);

    auto native_boolean_value_getter = JS::NativeFunction::create(realm, boolean_value_getter, 0, "booleanValue"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_boolean_value_setter;

    define_direct_accessor("booleanValue"_utf16_fly_string, native_boolean_value_getter, native_boolean_value_setter, default_attributes);

    auto native_single_node_value_getter = JS::NativeFunction::create(realm, single_node_value_getter, 0, "singleNodeValue"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_single_node_value_setter;

    define_direct_accessor("singleNodeValue"_utf16_fly_string, native_single_node_value_getter, native_single_node_value_setter, default_attributes);

    auto native_invalid_iterator_state_getter = JS::NativeFunction::create(realm, invalid_iterator_state_getter, 0, "invalidIteratorState"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_invalid_iterator_state_setter;

    define_direct_accessor("invalidIteratorState"_utf16_fly_string, native_invalid_iterator_state_getter, native_invalid_iterator_state_setter, default_attributes);

    auto native_snapshot_length_getter = JS::NativeFunction::create(realm, snapshot_length_getter, 0, "snapshotLength"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_snapshot_length_setter;

    define_direct_accessor("snapshotLength"_utf16_fly_string, native_snapshot_length_getter, native_snapshot_length_setter, default_attributes);

    auto constant_ANY_TYPE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(0));

    define_direct_property("ANY_TYPE"_utf16_fly_string, constant_ANY_TYPE_value, JS::Attribute::Enumerable);

    auto constant_NUMBER_TYPE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(1));

    define_direct_property("NUMBER_TYPE"_utf16_fly_string, constant_NUMBER_TYPE_value, JS::Attribute::Enumerable);

    auto constant_STRING_TYPE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(2));

    define_direct_property("STRING_TYPE"_utf16_fly_string, constant_STRING_TYPE_value, JS::Attribute::Enumerable);

    auto constant_BOOLEAN_TYPE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(3));

    define_direct_property("BOOLEAN_TYPE"_utf16_fly_string, constant_BOOLEAN_TYPE_value, JS::Attribute::Enumerable);

    auto constant_UNORDERED_NODE_ITERATOR_TYPE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(4));

    define_direct_property("UNORDERED_NODE_ITERATOR_TYPE"_utf16_fly_string, constant_UNORDERED_NODE_ITERATOR_TYPE_value, JS::Attribute::Enumerable);

    auto constant_ORDERED_NODE_ITERATOR_TYPE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(5));

    define_direct_property("ORDERED_NODE_ITERATOR_TYPE"_utf16_fly_string, constant_ORDERED_NODE_ITERATOR_TYPE_value, JS::Attribute::Enumerable);

    auto constant_UNORDERED_NODE_SNAPSHOT_TYPE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(6));

    define_direct_property("UNORDERED_NODE_SNAPSHOT_TYPE"_utf16_fly_string, constant_UNORDERED_NODE_SNAPSHOT_TYPE_value, JS::Attribute::Enumerable);

    auto constant_ORDERED_NODE_SNAPSHOT_TYPE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(7));

    define_direct_property("ORDERED_NODE_SNAPSHOT_TYPE"_utf16_fly_string, constant_ORDERED_NODE_SNAPSHOT_TYPE_value, JS::Attribute::Enumerable);

    auto constant_ANY_UNORDERED_NODE_TYPE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(8));

    define_direct_property("ANY_UNORDERED_NODE_TYPE"_utf16_fly_string, constant_ANY_UNORDERED_NODE_TYPE_value, JS::Attribute::Enumerable);

    auto constant_FIRST_ORDERED_NODE_TYPE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(9));

    define_direct_property("FIRST_ORDERED_NODE_TYPE"_utf16_fly_string, constant_FIRST_ORDERED_NODE_TYPE_value, JS::Attribute::Enumerable);

    define_native_function(realm, "iterateNext"_utf16_fly_string, iterate_next, 0, default_attributes);

    define_native_function(realm, "snapshotItem"_utf16_fly_string, snapshot_item, 1, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "XPathResult"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<XPath::XPathResult*> impl_from(JS::VM& vm)
{
    ...
    if (!is<XPath::XPathResult>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "XPathResult");
    return static_cast<XPath::XPathResult*>(this_object);
}
...
JS_DEFINE_NATIVE_FUNCTION(XPathResultPrototype::result_type_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->result_type(); }));
...
JS_DEFINE_NATIVE_FUNCTION(XPathResultPrototype::number_value_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->number_value(); }));
...
JS_DEFINE_NATIVE_FUNCTION(XPathResultPrototype::string_value_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->string_value(); }));
...
JS_DEFINE_NATIVE_FUNCTION(XPathResultPrototype::boolean_value_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->boolean_value(); }));
...
JS_DEFINE_NATIVE_FUNCTION(XPathResultPrototype::single_node_value_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->single_node_value(); }));
...
JS_DEFINE_NATIVE_FUNCTION(XPathResultPrototype::invalid_iterator_state_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->invalid_iterator_state(); }));
...
JS_DEFINE_NATIVE_FUNCTION(XPathResultPrototype::snapshot_length_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->snapshot_length(); }));
...
JS_DEFINE_NATIVE_FUNCTION(XPathResultPrototype::iterate_next)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->iterate_next(); }));
...
JS_DEFINE_NATIVE_FUNCTION(XPathResultPrototype::snapshot_item)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->snapshot_item(index); }));
