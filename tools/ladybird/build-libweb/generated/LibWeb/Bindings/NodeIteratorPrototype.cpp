...
GC_DEFINE_ALLOCATOR(NodeIteratorPrototype);

NodeIteratorPrototype::NodeIteratorPrototype([[maybe_unused]] JS::Realm& realm)
...
void NodeIteratorPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_reference_node_getter = JS::NativeFunction::create(realm, reference_node_getter, 0, "referenceNode"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_reference_node_setter;

    define_direct_accessor("referenceNode"_utf16_fly_string, native_reference_node_getter, native_reference_node_setter, default_attributes);

    auto native_pointer_before_reference_node_getter = JS::NativeFunction::create(realm, pointer_before_reference_node_getter, 0, "pointerBeforeReferenceNode"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_pointer_before_reference_node_setter;

    define_direct_accessor("pointerBeforeReferenceNode"_utf16_fly_string, native_pointer_before_reference_node_getter, native_pointer_before_reference_node_setter, default_attributes);

    auto native_what_to_show_getter = JS::NativeFunction::create(realm, what_to_show_getter, 0, "whatToShow"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_what_to_show_setter;

    define_direct_accessor("whatToShow"_utf16_fly_string, native_what_to_show_getter, native_what_to_show_setter, default_attributes);
    ...
    define_native_function(realm, "nextNode"_utf16_fly_string, next_node, 0, default_attributes);

    define_native_function(realm, "previousNode"_utf16_fly_string, previous_node, 0, default_attributes);

    define_native_function(realm, "detach"_utf16_fly_string, detach, 0, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "NodeIterator"_string), JS::Attribute::Configurable);
...
JS_DEFINE_NATIVE_FUNCTION(NodeIteratorPrototype::reference_node_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->reference_node(); }));
...
JS_DEFINE_NATIVE_FUNCTION(NodeIteratorPrototype::pointer_before_reference_node_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->pointer_before_reference_node(); }));
...
JS_DEFINE_NATIVE_FUNCTION(NodeIteratorPrototype::what_to_show_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->what_to_show(); }));
...
JS_DEFINE_NATIVE_FUNCTION(NodeIteratorPrototype::next_node)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->next_node(); }));
...
JS_DEFINE_NATIVE_FUNCTION(NodeIteratorPrototype::previous_node)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->previous_node(); }));
