...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLStyleElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLStyleElementPrototype);

HTMLStyleElementPrototype::HTMLStyleElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLStyleElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLStyleElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLStyleElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLStyleElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLStyleElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLStyleElement");
    return static_cast<HTML::HTMLStyleElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLStyleElementPrototype::disabled_getter)
{
    WebIDL::log_trace(vm, "HTMLStyleElementPrototype::disabled_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->disabled(); }));

    return JS::Value(retval);

}

JS_DEFINE_NATIVE_FUNCTION(HTMLStyleElementPrototype::disabled_setter)
{
    WebIDL::log_trace(vm, "HTMLStyleElementPrototype::disabled_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_disabled(cpp_value); }));
...
{
    WebIDL::log_trace(vm, "HTMLStyleElementPrototype::media_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLStyleElementPrototype::media_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLStyleElementPrototype::type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLStyleElementPrototype::type_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLStyleElementPrototype::sheet_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
