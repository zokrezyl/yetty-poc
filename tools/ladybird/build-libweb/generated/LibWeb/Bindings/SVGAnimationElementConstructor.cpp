...
GC_DEFINE_ALLOCATOR(SVGAnimationElementConstructor);

SVGAnimationElementConstructor::SVGAnimationElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGAnimationElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGAnimationElementConstructor::~SVGAnimationElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGAnimationElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGAnimationElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGAnimationElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGAnimationElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGAnimationElement");
}


void SVGAnimationElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGAnimationElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGAnimationElementPrototype>(realm, "SVGAnimationElement"_fly_string), 0);
