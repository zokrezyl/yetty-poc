...
GC_DEFINE_ALLOCATOR(EXTTextureFilterAnisotropicPrototype);

EXTTextureFilterAnisotropicPrototype::EXTTextureFilterAnisotropicPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

EXTTextureFilterAnisotropicPrototype::~EXTTextureFilterAnisotropicPrototype()
{
}

void EXTTextureFilterAnisotropicPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "EXTTextureFilterAnisotropic"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void EXTTextureFilterAnisotropicPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
