...
GC_DEFINE_ALLOCATOR(SVGTextElementPrototype);

SVGTextElementPrototype::SVGTextElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGTextElementPrototype::~SVGTextElementPrototype()
{
}

void SVGTextElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGTextElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGTextElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
