...
GC_DEFINE_ALLOCATOR(CSSMathNegatePrototype);

CSSMathNegatePrototype::CSSMathNegatePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CSSMathNegatePrototype::~CSSMathNegatePrototype()
{
}

void CSSMathNegatePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSMathNegate"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSMathNegatePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSMathNegate*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSMathNegate>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSMathNegate");
    return static_cast<CSS::CSSMathNegate*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSMathNegatePrototype::value_getter)
{
    WebIDL::log_trace(vm, "CSSMathNegatePrototype::value_getter");
