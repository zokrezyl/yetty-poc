...
GC_DEFINE_ALLOCATOR(HTMLCollectionPrototype);

HTMLCollectionPrototype::HTMLCollectionPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLCollectionPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLCollection"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLCollectionPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<DOM::HTMLCollection*> impl_from(JS::VM& vm)
{
    ...
    if (!is<DOM::HTMLCollection>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLCollection");
    return static_cast<DOM::HTMLCollection*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLCollectionPrototype::length_getter)
{
    WebIDL::log_trace(vm, "HTMLCollectionPrototype::length_getter");
...
{
    WebIDL::log_trace(vm, "HTMLCollectionPrototype::item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLCollectionPrototype::named_item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
