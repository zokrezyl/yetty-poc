...
GC_DEFINE_ALLOCATOR(FakeXRDevicePrototype);

FakeXRDevicePrototype::FakeXRDevicePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

FakeXRDevicePrototype::~FakeXRDevicePrototype()
{
}

void FakeXRDevicePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "FakeXRDevice"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void FakeXRDevicePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<Internals::FakeXRDevice*> impl_from(JS::VM& vm)
{
    ...
    if (!is<Internals::FakeXRDevice>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "FakeXRDevice");
    return static_cast<Internals::FakeXRDevice*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(FakeXRDevicePrototype::disconnect)
{
    WebIDL::log_trace(vm, "FakeXRDevicePrototype::disconnect");
