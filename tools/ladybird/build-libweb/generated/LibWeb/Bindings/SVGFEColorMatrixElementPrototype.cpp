...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGFEColorMatrixElement.h>
...
GC_DEFINE_ALLOCATOR(SVGFEColorMatrixElementPrototype);

SVGFEColorMatrixElementPrototype::SVGFEColorMatrixElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGFEColorMatrixElementPrototype::~SVGFEColorMatrixElementPrototype()
{
}

void SVGFEColorMatrixElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_values_getter = JS::NativeFunction::create(realm, values_getter, 0, "values"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_values_setter;

    define_direct_accessor("values"_utf16_fly_string, native_values_getter, native_values_setter, default_attributes);
    ...
    auto constant_SVG_FECOLORMATRIX_TYPE_UNKNOWN_value = JS::Value(static_cast<WebIDL::UnsignedShort>(0));

    define_direct_property("SVG_FECOLORMATRIX_TYPE_UNKNOWN"_utf16_fly_string, constant_SVG_FECOLORMATRIX_TYPE_UNKNOWN_value, JS::Attribute::Enumerable);

    auto constant_SVG_FECOLORMATRIX_TYPE_MATRIX_value = JS::Value(static_cast<WebIDL::UnsignedShort>(1));

    define_direct_property("SVG_FECOLORMATRIX_TYPE_MATRIX"_utf16_fly_string, constant_SVG_FECOLORMATRIX_TYPE_MATRIX_value, JS::Attribute::Enumerable);

    auto constant_SVG_FECOLORMATRIX_TYPE_SATURATE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(2));

    define_direct_property("SVG_FECOLORMATRIX_TYPE_SATURATE"_utf16_fly_string, constant_SVG_FECOLORMATRIX_TYPE_SATURATE_value, JS::Attribute::Enumerable);

    auto constant_SVG_FECOLORMATRIX_TYPE_HUEROTATE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(3));

    define_direct_property("SVG_FECOLORMATRIX_TYPE_HUEROTATE"_utf16_fly_string, constant_SVG_FECOLORMATRIX_TYPE_HUEROTATE_value, JS::Attribute::Enumerable);

    auto constant_SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA_value = JS::Value(static_cast<WebIDL::UnsignedShort>(4));

    define_direct_property("SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA"_utf16_fly_string, constant_SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA_value, JS::Attribute::Enumerable);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGFEColorMatrixElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGFEColorMatrixElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGFEColorMatrixElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGFEColorMatrixElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGFEColorMatrixElement");
    return static_cast<SVG::SVGFEColorMatrixElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGFEColorMatrixElementPrototype::in1_getter)
{
    WebIDL::log_trace(vm, "SVGFEColorMatrixElementPrototype::in1_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEColorMatrixElementPrototype::type_getter)
{
    WebIDL::log_trace(vm, "SVGFEColorMatrixElementPrototype::type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEColorMatrixElementPrototype::values_getter)
{
    WebIDL::log_trace(vm, "SVGFEColorMatrixElementPrototype::values_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->values(); }));

    return &const_cast<SVGAnimatedString&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(SVGFEColorMatrixElementPrototype::x_getter)
{
    WebIDL::log_trace(vm, "SVGFEColorMatrixElementPrototype::x_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEColorMatrixElementPrototype::y_getter)
{
    WebIDL::log_trace(vm, "SVGFEColorMatrixElementPrototype::y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEColorMatrixElementPrototype::width_getter)
{
    WebIDL::log_trace(vm, "SVGFEColorMatrixElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEColorMatrixElementPrototype::height_getter)
{
    WebIDL::log_trace(vm, "SVGFEColorMatrixElementPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEColorMatrixElementPrototype::result_getter)
{
    WebIDL::log_trace(vm, "SVGFEColorMatrixElementPrototype::result_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
