...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLTemplateElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLTemplateElementPrototype);

HTMLTemplateElementPrototype::HTMLTemplateElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLTemplateElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_content_getter = JS::NativeFunction::create(realm, content_getter, 0, "content"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_content_setter;

    define_direct_accessor("content"_utf16_fly_string, native_content_getter, native_content_setter, default_attributes);

    auto native_shadow_root_mode_getter = JS::NativeFunction::create(realm, shadow_root_mode_getter, 0, "shadowRootMode"_utf16_fly_string, &realm, "get"sv);

    auto native_shadow_root_mode_setter = JS::NativeFunction::create(realm, shadow_root_mode_setter, 1, "shadowRootMode"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("shadowRootMode"_utf16_fly_string, native_shadow_root_mode_getter, native_shadow_root_mode_setter, default_attributes);

    auto native_shadow_root_delegates_focus_getter = JS::NativeFunction::create(realm, shadow_root_delegates_focus_getter, 0, "shadowRootDelegatesFocus"_utf16_fly_string, &realm, "get"sv);

    auto native_shadow_root_delegates_focus_setter = JS::NativeFunction::create(realm, shadow_root_delegates_focus_setter, 1, "shadowRootDelegatesFocus"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("shadowRootDelegatesFocus"_utf16_fly_string, native_shadow_root_delegates_focus_getter, native_shadow_root_delegates_focus_setter, default_attributes);

    auto native_shadow_root_clonable_getter = JS::NativeFunction::create(realm, shadow_root_clonable_getter, 0, "shadowRootClonable"_utf16_fly_string, &realm, "get"sv);

    auto native_shadow_root_clonable_setter = JS::NativeFunction::create(realm, shadow_root_clonable_setter, 1, "shadowRootClonable"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("shadowRootClonable"_utf16_fly_string, native_shadow_root_clonable_getter, native_shadow_root_clonable_setter, default_attributes);

    auto native_shadow_root_serializable_getter = JS::NativeFunction::create(realm, shadow_root_serializable_getter, 0, "shadowRootSerializable"_utf16_fly_string, &realm, "get"sv);

    auto native_shadow_root_serializable_setter = JS::NativeFunction::create(realm, shadow_root_serializable_setter, 1, "shadowRootSerializable"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("shadowRootSerializable"_utf16_fly_string, native_shadow_root_serializable_getter, native_shadow_root_serializable_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLTemplateElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLTemplateElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLTemplateElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLTemplateElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLTemplateElement");
    return static_cast<HTML::HTMLTemplateElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLTemplateElementPrototype::content_getter)
{
    WebIDL::log_trace(vm, "HTMLTemplateElementPrototype::content_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->content_for_bindings(); }));

    return &const_cast<DocumentFragment&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(HTMLTemplateElementPrototype::shadow_root_mode_getter)
{
    WebIDL::log_trace(vm, "HTMLTemplateElementPrototype::shadow_root_mode_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("shadowrootmode"_fly_string);
    ...
    Array valid_values { "open"_string, "closed"_string };
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTemplateElementPrototype::shadow_root_mode_setter)
{
    WebIDL::log_trace(vm, "HTMLTemplateElementPrototype::shadow_root_mode_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("shadowrootmode"_fly_string, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTemplateElementPrototype::shadow_root_delegates_focus_getter)
{
    WebIDL::log_trace(vm, "HTMLTemplateElementPrototype::shadow_root_delegates_focus_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval = impl->has_attribute("shadowrootdelegatesfocus"_fly_string);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTemplateElementPrototype::shadow_root_delegates_focus_setter)
{
    WebIDL::log_trace(vm, "HTMLTemplateElementPrototype::shadow_root_delegates_focus_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value)
        impl->remove_attribute("shadowrootdelegatesfocus"_fly_string);
    else
        impl->set_attribute_value("shadowrootdelegatesfocus"_fly_string, String {});
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTemplateElementPrototype::shadow_root_clonable_getter)
{
    WebIDL::log_trace(vm, "HTMLTemplateElementPrototype::shadow_root_clonable_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval = impl->has_attribute("shadowrootclonable"_fly_string);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTemplateElementPrototype::shadow_root_clonable_setter)
{
    WebIDL::log_trace(vm, "HTMLTemplateElementPrototype::shadow_root_clonable_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value)
        impl->remove_attribute("shadowrootclonable"_fly_string);
    else
        impl->set_attribute_value("shadowrootclonable"_fly_string, String {});
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTemplateElementPrototype::shadow_root_serializable_getter)
{
    WebIDL::log_trace(vm, "HTMLTemplateElementPrototype::shadow_root_serializable_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval = impl->has_attribute("shadowrootserializable"_fly_string);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTemplateElementPrototype::shadow_root_serializable_setter)
{
    WebIDL::log_trace(vm, "HTMLTemplateElementPrototype::shadow_root_serializable_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value)
        impl->remove_attribute("shadowrootserializable"_fly_string);
    else
        impl->set_attribute_value("shadowrootserializable"_fly_string, String {});
