...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/CSS/CSSStyleRule.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/CSS/CSSGroupingRule.h>
...
GC_DEFINE_ALLOCATOR(CSSStyleRulePrototype);

CSSStyleRulePrototype::CSSStyleRulePrototype([[maybe_unused]] JS::Realm& realm)
...
void CSSStyleRulePrototype::initialize(JS::Realm& realm)
{
    ...
    set_prototype(&ensure_web_prototype<CSSGroupingRulePrototype>(realm, "CSSGroupingRule"_fly_string));


    auto native_selector_text_getter = JS::NativeFunction::create(realm, selector_text_getter, 0, "selectorText"_utf16_fly_string, &realm, "get"sv);

    auto native_selector_text_setter = JS::NativeFunction::create(realm, selector_text_setter, 1, "selectorText"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("selectorText"_utf16_fly_string, native_selector_text_getter, native_selector_text_setter, default_attributes);
    ...
    auto native_style_map_getter = JS::NativeFunction::create(realm, style_map_getter, 0, "styleMap"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_style_map_setter;

    define_direct_accessor("styleMap"_utf16_fly_string, native_style_map_getter, native_style_map_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSStyleRule"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSStyleRulePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSStyleRule*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSStyleRule>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSStyleRule");
    return static_cast<CSS::CSSStyleRule*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSStyleRulePrototype::selector_text_getter)
{
    WebIDL::log_trace(vm, "CSSStyleRulePrototype::selector_text_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->selector_text(); }));
...
{
    WebIDL::log_trace(vm, "CSSStyleRulePrototype::selector_text_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_selector_text(cpp_value); }));
...
{
    WebIDL::log_trace(vm, "CSSStyleRulePrototype::style_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(CSSStyleRulePrototype::style_setter)
{
    WebIDL::log_trace(vm, "CSSStyleRulePrototype::style_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(CSSStyleRulePrototype::style_map_getter)
{
    WebIDL::log_trace(vm, "CSSStyleRulePrototype::style_map_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->style_map(); }));
