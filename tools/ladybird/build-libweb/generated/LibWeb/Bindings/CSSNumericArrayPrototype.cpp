...
GC_DEFINE_ALLOCATOR(CSSNumericArrayPrototype);

CSSNumericArrayPrototype::CSSNumericArrayPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

CSSNumericArrayPrototype::~CSSNumericArrayPrototype()
{
}

void CSSNumericArrayPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSNumericArray"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSNumericArrayPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSNumericArray*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSNumericArray>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSNumericArray");
    return static_cast<CSS::CSSNumericArray*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSNumericArrayPrototype::length_getter)
{
    WebIDL::log_trace(vm, "CSSNumericArrayPrototype::length_getter");
