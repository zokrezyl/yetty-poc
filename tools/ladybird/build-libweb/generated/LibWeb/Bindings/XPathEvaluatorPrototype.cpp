...
GC_DEFINE_ALLOCATOR(XPathEvaluatorPrototype);

XPathEvaluatorPrototype::XPathEvaluatorPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

XPathEvaluatorPrototype::~XPathEvaluatorPrototype()
{
}

void XPathEvaluatorPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "XPathEvaluator"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void XPathEvaluatorPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<XPath::XPathEvaluator*> impl_from(JS::VM& vm)
{
    ...
    if (!is<XPath::XPathEvaluator>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "XPathEvaluator");
    return static_cast<XPath::XPathEvaluator*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(XPathEvaluatorPrototype::create_expression)
{
    WebIDL::log_trace(vm, "XPathEvaluatorPrototype::create_expression");
...
JS_DEFINE_NATIVE_FUNCTION(XPathEvaluatorPrototype::create_ns_resolver)
{
    WebIDL::log_trace(vm, "XPathEvaluatorPrototype::create_ns_resolver");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(XPathEvaluatorPrototype::evaluate)
{
    WebIDL::log_trace(vm, "XPathEvaluatorPrototype::evaluate");
    [[maybe_unused]] auto& realm = *vm.current_realm();
