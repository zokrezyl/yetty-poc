...
GC_DEFINE_ALLOCATOR(SVGNumberListPrototype);

SVGNumberListPrototype::SVGNumberListPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

SVGNumberListPrototype::~SVGNumberListPrototype()
{
}

void SVGNumberListPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGNumberList"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGNumberListPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGNumberList*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGNumberList>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGNumberList");
    return static_cast<SVG::SVGNumberList*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGNumberListPrototype::length_getter)
{
    WebIDL::log_trace(vm, "SVGNumberListPrototype::length_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SVGNumberListPrototype::number_of_items_getter)
{
    WebIDL::log_trace(vm, "SVGNumberListPrototype::number_of_items_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGNumberListPrototype::clear)
{
    WebIDL::log_trace(vm, "SVGNumberListPrototype::clear");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGNumberListPrototype::initialize_)
{
    WebIDL::log_trace(vm, "SVGNumberListPrototype::initialize_");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!arg0.is_object() || !is<SVGNumber>(arg0.as_object()))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGNumber");

    auto& new_item = static_cast<SVGNumber&>(arg0.as_object());

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->initialize_(new_item); }));

    return &const_cast<SVGNumber&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(SVGNumberListPrototype::get_item)
{
    WebIDL::log_trace(vm, "SVGNumberListPrototype::get_item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGNumberListPrototype::insert_item_before)
{
    WebIDL::log_trace(vm, "SVGNumberListPrototype::insert_item_before");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGNumberListPrototype::replace_item)
{
    WebIDL::log_trace(vm, "SVGNumberListPrototype::replace_item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGNumberListPrototype::remove_item)
{
    WebIDL::log_trace(vm, "SVGNumberListPrototype::remove_item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGNumberListPrototype::append_item)
{
    WebIDL::log_trace(vm, "SVGNumberListPrototype::append_item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
