...
GC_DEFINE_ALLOCATOR(SVGFEMergeNodeElementPrototype);

SVGFEMergeNodeElementPrototype::SVGFEMergeNodeElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGFEMergeNodeElementPrototype::~SVGFEMergeNodeElementPrototype()
{
}

void SVGFEMergeNodeElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGFEMergeNodeElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGFEMergeNodeElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGFEMergeNodeElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGFEMergeNodeElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGFEMergeNodeElement");
    return static_cast<SVG::SVGFEMergeNodeElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGFEMergeNodeElementPrototype::in1_getter)
{
    WebIDL::log_trace(vm, "SVGFEMergeNodeElementPrototype::in1_getter");
