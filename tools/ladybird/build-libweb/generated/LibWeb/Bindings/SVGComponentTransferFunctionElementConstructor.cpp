...
GC_DEFINE_ALLOCATOR(SVGComponentTransferFunctionElementConstructor);

SVGComponentTransferFunctionElementConstructor::SVGComponentTransferFunctionElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGComponentTransferFunctionElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGComponentTransferFunctionElementConstructor::~SVGComponentTransferFunctionElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGComponentTransferFunctionElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGComponentTransferFunctionElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGComponentTransferFunctionElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGComponentTransferFunctionElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGComponentTransferFunctionElement");
}


void SVGComponentTransferFunctionElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGComponentTransferFunctionElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGComponentTransferFunctionElementPrototype>(realm, "SVGComponentTransferFunctionElement"_fly_string), 0);
