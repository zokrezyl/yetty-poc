...
GC_DEFINE_ALLOCATOR(HTMLTableRowElementPrototype);

HTMLTableRowElementPrototype::HTMLTableRowElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLTableRowElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_row_index_getter = JS::NativeFunction::create(realm, row_index_getter, 0, "rowIndex"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_row_index_setter;

    define_direct_accessor("rowIndex"_utf16_fly_string, native_row_index_getter, native_row_index_setter, default_attributes);

    auto native_section_row_index_getter = JS::NativeFunction::create(realm, section_row_index_getter, 0, "sectionRowIndex"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_section_row_index_setter;

    define_direct_accessor("sectionRowIndex"_utf16_fly_string, native_section_row_index_getter, native_section_row_index_setter, default_attributes);

    auto native_cells_getter = JS::NativeFunction::create(realm, cells_getter, 0, "cells"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_cells_setter;

    define_direct_accessor("cells"_utf16_fly_string, native_cells_getter, native_cells_setter, default_attributes);
    ...
    define_native_function(realm, "insertCell"_utf16_fly_string, insert_cell, 0, default_attributes);

    define_native_function(realm, "deleteCell"_utf16_fly_string, delete_cell, 1, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLTableRowElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLTableRowElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLTableRowElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLTableRowElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLTableRowElement");
    return static_cast<HTML::HTMLTableRowElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLTableRowElementPrototype::row_index_getter)
{
    WebIDL::log_trace(vm, "HTMLTableRowElementPrototype::row_index_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->row_index(); }));
...
{
    WebIDL::log_trace(vm, "HTMLTableRowElementPrototype::section_row_index_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->section_row_index(); }));
...
{
    WebIDL::log_trace(vm, "HTMLTableRowElementPrototype::cells_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->cells(); }));
...
{
    WebIDL::log_trace(vm, "HTMLTableRowElementPrototype::align_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableRowElementPrototype::align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableRowElementPrototype::ch_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableRowElementPrototype::ch_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableRowElementPrototype::ch_off_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableRowElementPrototype::ch_off_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableRowElementPrototype::v_align_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableRowElementPrototype::v_align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableRowElementPrototype::bg_color_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableRowElementPrototype::bg_color_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableRowElementPrototype::insert_cell)
{
    WebIDL::log_trace(vm, "HTMLTableRowElementPrototype::insert_cell");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->insert_cell(index); }));

    return &const_cast<HTMLTableCellElement&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(HTMLTableRowElementPrototype::delete_cell)
{
    WebIDL::log_trace(vm, "HTMLTableRowElementPrototype::delete_cell");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    auto* impl = TRY(impl_from(vm));

    if (vm.argument_count() < 1)
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::BadArgCountOne, "deleteCell");
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->delete_cell(index); });
