...
GC_DEFINE_ALLOCATOR(CSSGroupingRulePrototype);

CSSGroupingRulePrototype::CSSGroupingRulePrototype([[maybe_unused]] JS::Realm& realm)
...
void CSSGroupingRulePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSGroupingRule"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSGroupingRulePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSGroupingRule*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSGroupingRule>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSGroupingRule");
    return static_cast<CSS::CSSGroupingRule*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSGroupingRulePrototype::css_rules_getter)
{
    WebIDL::log_trace(vm, "CSSGroupingRulePrototype::css_rules_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->css_rules_for_bindings(); }));
...
{
    WebIDL::log_trace(vm, "CSSGroupingRulePrototype::insert_rule");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "CSSGroupingRulePrototype::delete_rule");
    [[maybe_unused]] auto& realm = *vm.current_realm();
