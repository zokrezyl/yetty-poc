...
GC_DEFINE_ALLOCATOR(TextEncoderStreamPrototype);

TextEncoderStreamPrototype::TextEncoderStreamPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

TextEncoderStreamPrototype::~TextEncoderStreamPrototype()
{
}

void TextEncoderStreamPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "TextEncoderStream"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void TextEncoderStreamPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<Encoding::TextEncoderStream*> impl_from(JS::VM& vm)
{
    ...
    if (!is<Encoding::TextEncoderStream>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "TextEncoderStream");
    return static_cast<Encoding::TextEncoderStream*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(TextEncoderStreamPrototype::encoding_getter)
{
    WebIDL::log_trace(vm, "TextEncoderStreamPrototype::encoding_getter");
...
JS_DEFINE_NATIVE_FUNCTION(TextEncoderStreamPrototype::readable_getter)
{
    WebIDL::log_trace(vm, "TextEncoderStreamPrototype::readable_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(TextEncoderStreamPrototype::writable_getter)
{
    WebIDL::log_trace(vm, "TextEncoderStreamPrototype::writable_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
