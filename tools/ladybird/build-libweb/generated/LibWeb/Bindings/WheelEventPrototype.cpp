...
GC_DEFINE_ALLOCATOR(WheelEventPrototype);

WheelEventPrototype::WheelEventPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

WheelEventPrototype::~WheelEventPrototype()
{
}

void WheelEventPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_delta_x_getter = JS::NativeFunction::create(realm, delta_x_getter, 0, "deltaX"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_delta_x_setter;

    define_direct_accessor("deltaX"_utf16_fly_string, native_delta_x_getter, native_delta_x_setter, default_attributes);

    auto native_delta_y_getter = JS::NativeFunction::create(realm, delta_y_getter, 0, "deltaY"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_delta_y_setter;

    define_direct_accessor("deltaY"_utf16_fly_string, native_delta_y_getter, native_delta_y_setter, default_attributes);

    auto native_delta_z_getter = JS::NativeFunction::create(realm, delta_z_getter, 0, "deltaZ"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_delta_z_setter;

    define_direct_accessor("deltaZ"_utf16_fly_string, native_delta_z_getter, native_delta_z_setter, default_attributes);

    auto native_delta_mode_getter = JS::NativeFunction::create(realm, delta_mode_getter, 0, "deltaMode"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_delta_mode_setter;

    define_direct_accessor("deltaMode"_utf16_fly_string, native_delta_mode_getter, native_delta_mode_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "WheelEvent"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void WheelEventPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<UIEvents::WheelEvent*> impl_from(JS::VM& vm)
{
    ...
    if (!is<UIEvents::WheelEvent>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "WheelEvent");
    return static_cast<UIEvents::WheelEvent*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(WheelEventPrototype::delta_x_getter)
{
    WebIDL::log_trace(vm, "WheelEventPrototype::delta_x_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->delta_x(); }));

    return JS::Value(retval);

}

JS_DEFINE_NATIVE_FUNCTION(WheelEventPrototype::delta_y_getter)
{
    WebIDL::log_trace(vm, "WheelEventPrototype::delta_y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->delta_y(); }));

    return JS::Value(retval);

}

JS_DEFINE_NATIVE_FUNCTION(WheelEventPrototype::delta_z_getter)
{
    WebIDL::log_trace(vm, "WheelEventPrototype::delta_z_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->delta_z(); }));

    return JS::Value(retval);

}

JS_DEFINE_NATIVE_FUNCTION(WheelEventPrototype::delta_mode_getter)
{
    WebIDL::log_trace(vm, "WheelEventPrototype::delta_mode_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->delta_mode(); }));
