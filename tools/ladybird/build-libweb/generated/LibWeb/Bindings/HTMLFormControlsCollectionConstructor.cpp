...
GC_DEFINE_ALLOCATOR(HTMLFormControlsCollectionConstructor);

HTMLFormControlsCollectionConstructor::HTMLFormControlsCollectionConstructor(JS::Realm& realm)
    : NativeFunction("HTMLFormControlsCollection"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

HTMLFormControlsCollectionConstructor::~HTMLFormControlsCollectionConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> HTMLFormControlsCollectionConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "HTMLFormControlsCollection");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> HTMLFormControlsCollectionConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "HTMLFormControlsCollectionConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "HTMLFormControlsCollection");
}


void HTMLFormControlsCollectionConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    set_prototype(&ensure_web_constructor<HTMLCollectionPrototype>(realm, "HTMLCollection"_fly_string));

    define_direct_property(vm.names.length, JS::Value(0), JS::Attribute::Configurable);
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "HTMLFormControlsCollection"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<HTMLFormControlsCollectionPrototype>(realm, "HTMLFormControlsCollection"_fly_string), 0);
