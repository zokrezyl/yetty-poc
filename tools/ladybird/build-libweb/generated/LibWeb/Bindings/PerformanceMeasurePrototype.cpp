...
GC_DEFINE_ALLOCATOR(PerformanceMeasurePrototype);

PerformanceMeasurePrototype::PerformanceMeasurePrototype([[maybe_unused]] JS::Realm& realm)
...
void PerformanceMeasurePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "PerformanceMeasure"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void PerformanceMeasurePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<PerformanceMeasure*> impl_from(JS::VM& vm)
{
    ...
    if (!is<PerformanceMeasure>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "PerformanceMeasure");
    return static_cast<PerformanceMeasure*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(PerformanceMeasurePrototype::detail_getter)
{
    WebIDL::log_trace(vm, "PerformanceMeasurePrototype::detail_getter");
