...
GC_DEFINE_ALLOCATOR(CSSLayerBlockRulePrototype);

CSSLayerBlockRulePrototype::CSSLayerBlockRulePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CSSLayerBlockRulePrototype::~CSSLayerBlockRulePrototype()
{
}

void CSSLayerBlockRulePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSLayerBlockRule"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSLayerBlockRulePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSLayerBlockRule*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSLayerBlockRule>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSLayerBlockRule");
    return static_cast<CSS::CSSLayerBlockRule*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSLayerBlockRulePrototype::name_getter)
{
    WebIDL::log_trace(vm, "CSSLayerBlockRulePrototype::name_getter");
