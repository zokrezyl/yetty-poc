...
GC_DEFINE_ALLOCATOR(CSSRulePrototype);

CSSRulePrototype::CSSRulePrototype([[maybe_unused]] JS::Realm& realm)
...
void CSSRulePrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_parent_style_sheet_getter = JS::NativeFunction::create(realm, parent_style_sheet_getter, 0, "parentStyleSheet"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_parent_style_sheet_setter;

    define_direct_accessor("parentStyleSheet"_utf16_fly_string, native_parent_style_sheet_getter, native_parent_style_sheet_setter, default_attributes);
    ...
    auto constant_STYLE_RULE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(1));

    define_direct_property("STYLE_RULE"_utf16_fly_string, constant_STYLE_RULE_value, JS::Attribute::Enumerable);

    auto constant_CHARSET_RULE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(2));

    define_direct_property("CHARSET_RULE"_utf16_fly_string, constant_CHARSET_RULE_value, JS::Attribute::Enumerable);

    auto constant_IMPORT_RULE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(3));

    define_direct_property("IMPORT_RULE"_utf16_fly_string, constant_IMPORT_RULE_value, JS::Attribute::Enumerable);

    auto constant_MEDIA_RULE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(4));

    define_direct_property("MEDIA_RULE"_utf16_fly_string, constant_MEDIA_RULE_value, JS::Attribute::Enumerable);

    auto constant_FONT_FACE_RULE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(5));

    define_direct_property("FONT_FACE_RULE"_utf16_fly_string, constant_FONT_FACE_RULE_value, JS::Attribute::Enumerable);

    auto constant_PAGE_RULE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(6));

    define_direct_property("PAGE_RULE"_utf16_fly_string, constant_PAGE_RULE_value, JS::Attribute::Enumerable);

    auto constant_KEYFRAMES_RULE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(7));

    define_direct_property("KEYFRAMES_RULE"_utf16_fly_string, constant_KEYFRAMES_RULE_value, JS::Attribute::Enumerable);

    auto constant_KEYFRAME_RULE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(8));

    define_direct_property("KEYFRAME_RULE"_utf16_fly_string, constant_KEYFRAME_RULE_value, JS::Attribute::Enumerable);

    auto constant_MARGIN_RULE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(9));

    define_direct_property("MARGIN_RULE"_utf16_fly_string, constant_MARGIN_RULE_value, JS::Attribute::Enumerable);

    auto constant_NAMESPACE_RULE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(10));

    define_direct_property("NAMESPACE_RULE"_utf16_fly_string, constant_NAMESPACE_RULE_value, JS::Attribute::Enumerable);

    auto constant_COUNTER_STYLE_RULE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(11));

    define_direct_property("COUNTER_STYLE_RULE"_utf16_fly_string, constant_COUNTER_STYLE_RULE_value, JS::Attribute::Enumerable);

    auto constant_SUPPORTS_RULE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(12));

    define_direct_property("SUPPORTS_RULE"_utf16_fly_string, constant_SUPPORTS_RULE_value, JS::Attribute::Enumerable);

    auto constant_FONT_FEATURE_VALUES_RULE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(14));

    define_direct_property("FONT_FEATURE_VALUES_RULE"_utf16_fly_string, constant_FONT_FEATURE_VALUES_RULE_value, JS::Attribute::Enumerable);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSRule"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSRulePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSRule*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSRule>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSRule");
    return static_cast<CSS::CSSRule*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSRulePrototype::css_text_getter)
{
    WebIDL::log_trace(vm, "CSSRulePrototype::css_text_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->css_text(); }));
...
{
    WebIDL::log_trace(vm, "CSSRulePrototype::css_text_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_css_text(cpp_value); }));
...
{
    WebIDL::log_trace(vm, "CSSRulePrototype::parent_rule_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "CSSRulePrototype::parent_style_sheet_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->parent_style_sheet(); }));
...
{
    WebIDL::log_trace(vm, "CSSRulePrototype::type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->type_for_bindings(); }));
