...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGStyleElement.h>
...
GC_DEFINE_ALLOCATOR(SVGStyleElementPrototype);

SVGStyleElementPrototype::SVGStyleElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGStyleElementPrototype::~SVGStyleElementPrototype()
{
}

void SVGStyleElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGStyleElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGStyleElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGStyleElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGStyleElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGStyleElement");
    return static_cast<SVG::SVGStyleElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGStyleElementPrototype::type_getter)
{
    WebIDL::log_trace(vm, "SVGStyleElementPrototype::type_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SVGStyleElementPrototype::type_setter)
{
    WebIDL::log_trace(vm, "SVGStyleElementPrototype::type_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGStyleElementPrototype::media_getter)
{
    WebIDL::log_trace(vm, "SVGStyleElementPrototype::media_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGStyleElementPrototype::media_setter)
{
    WebIDL::log_trace(vm, "SVGStyleElementPrototype::media_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGStyleElementPrototype::title_getter)
{
    WebIDL::log_trace(vm, "SVGStyleElementPrototype::title_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGStyleElementPrototype::title_setter)
{
    WebIDL::log_trace(vm, "SVGStyleElementPrototype::title_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGStyleElementPrototype::sheet_getter)
{
    WebIDL::log_trace(vm, "SVGStyleElementPrototype::sheet_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
