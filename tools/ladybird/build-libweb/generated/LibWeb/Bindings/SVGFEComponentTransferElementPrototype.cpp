...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGFEComponentTransferElement.h>
...
GC_DEFINE_ALLOCATOR(SVGFEComponentTransferElementPrototype);

SVGFEComponentTransferElementPrototype::SVGFEComponentTransferElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGFEComponentTransferElementPrototype::~SVGFEComponentTransferElementPrototype()
{
}

void SVGFEComponentTransferElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGFEComponentTransferElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGFEComponentTransferElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGFEComponentTransferElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGFEComponentTransferElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGFEComponentTransferElement");
    return static_cast<SVG::SVGFEComponentTransferElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGFEComponentTransferElementPrototype::in1_getter)
{
    WebIDL::log_trace(vm, "SVGFEComponentTransferElementPrototype::in1_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEComponentTransferElementPrototype::x_getter)
{
    WebIDL::log_trace(vm, "SVGFEComponentTransferElementPrototype::x_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEComponentTransferElementPrototype::y_getter)
{
    WebIDL::log_trace(vm, "SVGFEComponentTransferElementPrototype::y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEComponentTransferElementPrototype::width_getter)
{
    WebIDL::log_trace(vm, "SVGFEComponentTransferElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEComponentTransferElementPrototype::height_getter)
{
    WebIDL::log_trace(vm, "SVGFEComponentTransferElementPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEComponentTransferElementPrototype::result_getter)
{
    WebIDL::log_trace(vm, "SVGFEComponentTransferElementPrototype::result_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
