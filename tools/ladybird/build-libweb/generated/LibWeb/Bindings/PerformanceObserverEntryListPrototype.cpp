...
GC_DEFINE_ALLOCATOR(PerformanceObserverEntryListPrototype);

PerformanceObserverEntryListPrototype::PerformanceObserverEntryListPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

PerformanceObserverEntryListPrototype::~PerformanceObserverEntryListPrototype()
{
}

void PerformanceObserverEntryListPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "PerformanceObserverEntryList"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void PerformanceObserverEntryListPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<PerformanceObserverEntryList*> impl_from(JS::VM& vm)
{
    ...
    if (!is<PerformanceObserverEntryList>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "PerformanceObserverEntryList");
    return static_cast<PerformanceObserverEntryList*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(PerformanceObserverEntryListPrototype::get_entries)
{
    WebIDL::log_trace(vm, "PerformanceObserverEntryListPrototype::get_entries");
...
JS_DEFINE_NATIVE_FUNCTION(PerformanceObserverEntryListPrototype::get_entries_by_type)
{
    WebIDL::log_trace(vm, "PerformanceObserverEntryListPrototype::get_entries_by_type");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(PerformanceObserverEntryListPrototype::get_entries_by_name)
{
    WebIDL::log_trace(vm, "PerformanceObserverEntryListPrototype::get_entries_by_name");
    [[maybe_unused]] auto& realm = *vm.current_realm();
