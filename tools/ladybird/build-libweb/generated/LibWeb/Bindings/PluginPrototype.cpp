...
GC_DEFINE_ALLOCATOR(PluginPrototype);

PluginPrototype::PluginPrototype([[maybe_unused]] JS::Realm& realm)
...
void PluginPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "Plugin"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void PluginPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::Plugin*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::Plugin>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "Plugin");
    return static_cast<HTML::Plugin*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(PluginPrototype::name_getter)
{
    WebIDL::log_trace(vm, "PluginPrototype::name_getter");
...
JS_DEFINE_NATIVE_FUNCTION(PluginPrototype::description_getter)
{
    WebIDL::log_trace(vm, "PluginPrototype::description_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(PluginPrototype::filename_getter)
{
    WebIDL::log_trace(vm, "PluginPrototype::filename_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(PluginPrototype::length_getter)
{
    WebIDL::log_trace(vm, "PluginPrototype::length_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(PluginPrototype::item)
{
    WebIDL::log_trace(vm, "PluginPrototype::item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(PluginPrototype::named_item)
{
    WebIDL::log_trace(vm, "PluginPrototype::named_item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
