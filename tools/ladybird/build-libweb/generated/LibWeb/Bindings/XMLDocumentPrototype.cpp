...
GC_DEFINE_ALLOCATOR(XMLDocumentPrototype);

XMLDocumentPrototype::XMLDocumentPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

XMLDocumentPrototype::~XMLDocumentPrototype()
{
}

void XMLDocumentPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "XMLDocument"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void XMLDocumentPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
