...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/EventSource.h>
...
GC_DEFINE_ALLOCATOR(EventSourcePrototype);

EventSourcePrototype::EventSourcePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

EventSourcePrototype::~EventSourcePrototype()
{
}

void EventSourcePrototype::initialize(JS::Realm& realm)
{
    ...
    GC::Ptr<JS::NativeFunction> native_with_credentials_setter;
    ...
    auto constant_CLOSED_value = JS::Value(static_cast<WebIDL::UnsignedShort>(2));
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "EventSource"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void EventSourcePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::EventSource*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::EventSource>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "EventSource");
    return static_cast<HTML::EventSource*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(EventSourcePrototype::url_getter)
{
    WebIDL::log_trace(vm, "EventSourcePrototype::url_getter");
...
JS_DEFINE_NATIVE_FUNCTION(EventSourcePrototype::with_credentials_getter)
{
    WebIDL::log_trace(vm, "EventSourcePrototype::with_credentials_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(EventSourcePrototype::ready_state_getter)
{
    WebIDL::log_trace(vm, "EventSourcePrototype::ready_state_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(EventSourcePrototype::onopen_getter)
{
    WebIDL::log_trace(vm, "EventSourcePrototype::onopen_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(EventSourcePrototype::onopen_setter)
{
    WebIDL::log_trace(vm, "EventSourcePrototype::onopen_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(EventSourcePrototype::onmessage_getter)
{
    WebIDL::log_trace(vm, "EventSourcePrototype::onmessage_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(EventSourcePrototype::onmessage_setter)
{
    WebIDL::log_trace(vm, "EventSourcePrototype::onmessage_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(EventSourcePrototype::onerror_getter)
{
    WebIDL::log_trace(vm, "EventSourcePrototype::onerror_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(EventSourcePrototype::onerror_setter)
{
    WebIDL::log_trace(vm, "EventSourcePrototype::onerror_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(EventSourcePrototype::close)
{
    WebIDL::log_trace(vm, "EventSourcePrototype::close");
    [[maybe_unused]] auto& realm = *vm.current_realm();
