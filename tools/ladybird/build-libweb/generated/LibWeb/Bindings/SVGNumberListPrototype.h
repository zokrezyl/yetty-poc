...
class SVGNumberListPrototype : public JS::Object {
    JS_OBJECT(SVGNumberListPrototype, JS::Object);
    GC_DECLARE_ALLOCATOR(SVGNumberListPrototype);
public:
    static void define_unforgeable_attributes(JS::Realm&, JS::Object&);

    explicit SVGNumberListPrototype(JS::Realm&);
    virtual void initialize(JS::Realm&) override;
    virtual ~SVGNumberListPrototype() override;
private:
