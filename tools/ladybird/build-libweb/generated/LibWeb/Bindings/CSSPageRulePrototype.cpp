...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/CSS/CSSPageRule.h>
...
GC_DEFINE_ALLOCATOR(CSSPageRulePrototype);

CSSPageRulePrototype::CSSPageRulePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CSSPageRulePrototype::~CSSPageRulePrototype()
{
}

void CSSPageRulePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSPageRule"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSPageRulePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSPageRule*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSPageRule>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSPageRule");
    return static_cast<CSS::CSSPageRule*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSPageRulePrototype::selector_text_getter)
{
    WebIDL::log_trace(vm, "CSSPageRulePrototype::selector_text_getter");
...
JS_DEFINE_NATIVE_FUNCTION(CSSPageRulePrototype::selector_text_setter)
{
    WebIDL::log_trace(vm, "CSSPageRulePrototype::selector_text_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(CSSPageRulePrototype::style_getter)
{
    WebIDL::log_trace(vm, "CSSPageRulePrototype::style_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    return &const_cast<CSSPageDescriptors&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(CSSPageRulePrototype::style_setter)
{
    WebIDL::log_trace(vm, "CSSPageRulePrototype::style_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
