...
GC_DEFINE_ALLOCATOR(HTMLDataListElementPrototype);

HTMLDataListElementPrototype::HTMLDataListElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLDataListElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_options_getter = JS::NativeFunction::create(realm, options_getter, 0, "options"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_options_setter;

    define_direct_accessor("options"_utf16_fly_string, native_options_getter, native_options_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLDataListElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLDataListElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLDataListElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLDataListElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLDataListElement");
    return static_cast<HTML::HTMLDataListElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLDataListElementPrototype::options_getter)
{
    WebIDL::log_trace(vm, "HTMLDataListElementPrototype::options_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->options(); }));
