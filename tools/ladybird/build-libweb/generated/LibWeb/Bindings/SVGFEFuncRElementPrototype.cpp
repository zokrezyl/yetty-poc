...
GC_DEFINE_ALLOCATOR(SVGFEFuncRElementPrototype);

SVGFEFuncRElementPrototype::SVGFEFuncRElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGFEFuncRElementPrototype::~SVGFEFuncRElementPrototype()
{
}

void SVGFEFuncRElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGFEFuncRElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGFEFuncRElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
