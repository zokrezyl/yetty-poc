...
#if __has_include(<LibWeb/Bindings/SVGGradientElementPrototype.h>)
#    include <LibWeb/Bindings/SVGGradientElementPrototype.h>
#endif


#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGLinearGradientElement.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGAnimatedLength.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGGradientElement.h>
...
GC_DEFINE_ALLOCATOR(SVGLinearGradientElementPrototype);

SVGLinearGradientElementPrototype::SVGLinearGradientElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGLinearGradientElementPrototype::~SVGLinearGradientElementPrototype()
{
}

void SVGLinearGradientElementPrototype::initialize(JS::Realm& realm)
{
    ...
    set_prototype(&ensure_web_prototype<SVGGradientElementPrototype>(realm, "SVGGradientElement"_fly_string));


    auto native_x1_getter = JS::NativeFunction::create(realm, x1_getter, 0, "x1"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_x1_setter;

    define_direct_accessor("x1"_utf16_fly_string, native_x1_getter, native_x1_setter, default_attributes);

    auto native_y1_getter = JS::NativeFunction::create(realm, y1_getter, 0, "y1"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_y1_setter;

    define_direct_accessor("y1"_utf16_fly_string, native_y1_getter, native_y1_setter, default_attributes);

    auto native_x2_getter = JS::NativeFunction::create(realm, x2_getter, 0, "x2"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_x2_setter;

    define_direct_accessor("x2"_utf16_fly_string, native_x2_getter, native_x2_setter, default_attributes);

    auto native_y2_getter = JS::NativeFunction::create(realm, y2_getter, 0, "y2"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_y2_setter;

    define_direct_accessor("y2"_utf16_fly_string, native_y2_getter, native_y2_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGLinearGradientElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGLinearGradientElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGLinearGradientElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGLinearGradientElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGLinearGradientElement");
    return static_cast<SVG::SVGLinearGradientElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGLinearGradientElementPrototype::x1_getter)
{
    WebIDL::log_trace(vm, "SVGLinearGradientElementPrototype::x1_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->x1(); }));

    return &const_cast<SVGAnimatedLength&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(SVGLinearGradientElementPrototype::y1_getter)
{
    WebIDL::log_trace(vm, "SVGLinearGradientElementPrototype::y1_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->y1(); }));

    return &const_cast<SVGAnimatedLength&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(SVGLinearGradientElementPrototype::x2_getter)
{
    WebIDL::log_trace(vm, "SVGLinearGradientElementPrototype::x2_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->x2(); }));

    return &const_cast<SVGAnimatedLength&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(SVGLinearGradientElementPrototype::y2_getter)
{
    WebIDL::log_trace(vm, "SVGLinearGradientElementPrototype::y2_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->y2(); }));
