...
void HeadersIteratorPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "Headers Iterator"_string), JS::Attribute::Configurable);
}

static JS::ThrowCompletionOr<Fetch::HeadersIterator*> impl_from(JS::VM& vm)
{
