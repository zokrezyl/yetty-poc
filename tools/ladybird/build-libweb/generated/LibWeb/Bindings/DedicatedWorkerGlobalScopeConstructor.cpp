...
#if __has_include(<LibWeb/Bindings/WorkerGlobalScopePrototype.h>)
#    include <LibWeb/Bindings/WorkerGlobalScopePrototype.h>
#endif


#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/DedicatedWorkerGlobalScope.h>
...
GC_DEFINE_ALLOCATOR(DedicatedWorkerGlobalScopeConstructor);

DedicatedWorkerGlobalScopeConstructor::DedicatedWorkerGlobalScopeConstructor(JS::Realm& realm)
    : NativeFunction("DedicatedWorkerGlobalScope"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

DedicatedWorkerGlobalScopeConstructor::~DedicatedWorkerGlobalScopeConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> DedicatedWorkerGlobalScopeConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "DedicatedWorkerGlobalScope");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> DedicatedWorkerGlobalScopeConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "DedicatedWorkerGlobalScopeConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "DedicatedWorkerGlobalScope");
}


void DedicatedWorkerGlobalScopeConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    set_prototype(&ensure_web_constructor<WorkerGlobalScopePrototype>(realm, "WorkerGlobalScope"_fly_string));

    define_direct_property(vm.names.length, JS::Value(0), JS::Attribute::Configurable);
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "DedicatedWorkerGlobalScope"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<DedicatedWorkerGlobalScopePrototype>(realm, "DedicatedWorkerGlobalScope"_fly_string), 0);
