...
GC_DEFINE_ALLOCATOR(SVGPathElementPrototype);

SVGPathElementPrototype::SVGPathElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void SVGPathElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGPathElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGPathElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
