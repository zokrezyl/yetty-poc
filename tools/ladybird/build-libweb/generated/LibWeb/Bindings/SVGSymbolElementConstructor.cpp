...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGSymbolElement.h>
...
GC_DEFINE_ALLOCATOR(SVGSymbolElementConstructor);

SVGSymbolElementConstructor::SVGSymbolElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGSymbolElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGSymbolElementConstructor::~SVGSymbolElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGSymbolElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGSymbolElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGSymbolElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGSymbolElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGSymbolElement");
}


void SVGSymbolElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGSymbolElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGSymbolElementPrototype>(realm, "SVGSymbolElement"_fly_string), 0);
