...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/CSS/CSSFontFeatureValuesRule.h>
...
GC_DEFINE_ALLOCATOR(CSSFontFeatureValuesRulePrototype);

CSSFontFeatureValuesRulePrototype::CSSFontFeatureValuesRulePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CSSFontFeatureValuesRulePrototype::~CSSFontFeatureValuesRulePrototype()
{
}

void CSSFontFeatureValuesRulePrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_font_family_getter = JS::NativeFunction::create(realm, font_family_getter, 0, "fontFamily"_utf16_fly_string, &realm, "get"sv);

    auto native_font_family_setter = JS::NativeFunction::create(realm, font_family_setter, 1, "fontFamily"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("fontFamily"_utf16_fly_string, native_font_family_getter, native_font_family_setter, default_attributes);

    auto native_annotation_getter = JS::NativeFunction::create(realm, annotation_getter, 0, "annotation"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_annotation_setter;

    define_direct_accessor("annotation"_utf16_fly_string, native_annotation_getter, native_annotation_setter, default_attributes);

    auto native_ornaments_getter = JS::NativeFunction::create(realm, ornaments_getter, 0, "ornaments"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_ornaments_setter;

    define_direct_accessor("ornaments"_utf16_fly_string, native_ornaments_getter, native_ornaments_setter, default_attributes);

    auto native_stylistic_getter = JS::NativeFunction::create(realm, stylistic_getter, 0, "stylistic"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_stylistic_setter;

    define_direct_accessor("stylistic"_utf16_fly_string, native_stylistic_getter, native_stylistic_setter, default_attributes);

    auto native_swash_getter = JS::NativeFunction::create(realm, swash_getter, 0, "swash"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_swash_setter;

    define_direct_accessor("swash"_utf16_fly_string, native_swash_getter, native_swash_setter, default_attributes);

    auto native_character_variant_getter = JS::NativeFunction::create(realm, character_variant_getter, 0, "characterVariant"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_character_variant_setter;

    define_direct_accessor("characterVariant"_utf16_fly_string, native_character_variant_getter, native_character_variant_setter, default_attributes);

    auto native_styleset_getter = JS::NativeFunction::create(realm, styleset_getter, 0, "styleset"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_styleset_setter;

    define_direct_accessor("styleset"_utf16_fly_string, native_styleset_getter, native_styleset_setter, default_attributes);

    auto native_historical_forms_getter = JS::NativeFunction::create(realm, historical_forms_getter, 0, "historicalForms"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_historical_forms_setter;

    define_direct_accessor("historicalForms"_utf16_fly_string, native_historical_forms_getter, native_historical_forms_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSFontFeatureValuesRule"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSFontFeatureValuesRulePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSFontFeatureValuesRule*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSFontFeatureValuesRule>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSFontFeatureValuesRule");
    return static_cast<CSS::CSSFontFeatureValuesRule*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSFontFeatureValuesRulePrototype::font_family_getter)
{
    WebIDL::log_trace(vm, "CSSFontFeatureValuesRulePrototype::font_family_getter");
...
JS_DEFINE_NATIVE_FUNCTION(CSSFontFeatureValuesRulePrototype::font_family_setter)
{
    WebIDL::log_trace(vm, "CSSFontFeatureValuesRulePrototype::font_family_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(CSSFontFeatureValuesRulePrototype::annotation_getter)
{
    WebIDL::log_trace(vm, "CSSFontFeatureValuesRulePrototype::annotation_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->annotation(); }));

    return &const_cast<CSSFontFeatureValuesMap&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(CSSFontFeatureValuesRulePrototype::ornaments_getter)
{
    WebIDL::log_trace(vm, "CSSFontFeatureValuesRulePrototype::ornaments_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->ornaments(); }));

    return &const_cast<CSSFontFeatureValuesMap&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(CSSFontFeatureValuesRulePrototype::stylistic_getter)
{
    WebIDL::log_trace(vm, "CSSFontFeatureValuesRulePrototype::stylistic_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->stylistic(); }));

    return &const_cast<CSSFontFeatureValuesMap&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(CSSFontFeatureValuesRulePrototype::swash_getter)
{
    WebIDL::log_trace(vm, "CSSFontFeatureValuesRulePrototype::swash_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->swash(); }));

    return &const_cast<CSSFontFeatureValuesMap&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(CSSFontFeatureValuesRulePrototype::character_variant_getter)
{
    WebIDL::log_trace(vm, "CSSFontFeatureValuesRulePrototype::character_variant_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->character_variant(); }));

    return &const_cast<CSSFontFeatureValuesMap&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(CSSFontFeatureValuesRulePrototype::styleset_getter)
{
    WebIDL::log_trace(vm, "CSSFontFeatureValuesRulePrototype::styleset_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->styleset(); }));

    return &const_cast<CSSFontFeatureValuesMap&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(CSSFontFeatureValuesRulePrototype::historical_forms_getter)
{
    WebIDL::log_trace(vm, "CSSFontFeatureValuesRulePrototype::historical_forms_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->historical_forms(); }));
