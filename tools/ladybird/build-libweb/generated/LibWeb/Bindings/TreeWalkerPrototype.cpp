...
GC_DEFINE_ALLOCATOR(TreeWalkerPrototype);

TreeWalkerPrototype::TreeWalkerPrototype([[maybe_unused]] JS::Realm& realm)
...
void TreeWalkerPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_current_node_getter = JS::NativeFunction::create(realm, current_node_getter, 0, "currentNode"_utf16_fly_string, &realm, "get"sv);

    auto native_current_node_setter = JS::NativeFunction::create(realm, current_node_setter, 1, "currentNode"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("currentNode"_utf16_fly_string, native_current_node_getter, native_current_node_setter, default_attributes);

    define_native_function(realm, "parentNode"_utf16_fly_string, parent_node, 0, default_attributes);

    define_native_function(realm, "firstChild"_utf16_fly_string, first_child, 0, default_attributes);

    define_native_function(realm, "lastChild"_utf16_fly_string, last_child, 0, default_attributes);

    define_native_function(realm, "previousSibling"_utf16_fly_string, previous_sibling, 0, default_attributes);

    define_native_function(realm, "nextSibling"_utf16_fly_string, next_sibling, 0, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "TreeWalker"_string), JS::Attribute::Configurable);
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::current_node_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->current_node(); }));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::current_node_setter)
{
    ...
    if (!value.is_object() || !is<Node>(value.as_object()))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "Node");

    auto& cpp_value = static_cast<Node&>(value.as_object());

    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_current_node(cpp_value); }));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::parent_node)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->parent_node(); }));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::first_child)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->first_child(); }));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::last_child)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->last_child(); }));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::previous_sibling)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->previous_sibling(); }));
...
JS_DEFINE_NATIVE_FUNCTION(TreeWalkerPrototype::next_sibling)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->next_sibling(); }));
