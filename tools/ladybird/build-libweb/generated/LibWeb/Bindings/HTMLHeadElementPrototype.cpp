...
GC_DEFINE_ALLOCATOR(HTMLHeadElementPrototype);

HTMLHeadElementPrototype::HTMLHeadElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLHeadElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLHeadElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLHeadElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
