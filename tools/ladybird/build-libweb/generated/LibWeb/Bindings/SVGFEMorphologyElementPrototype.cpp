...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGFEMorphologyElement.h>
...
GC_DEFINE_ALLOCATOR(SVGFEMorphologyElementPrototype);

SVGFEMorphologyElementPrototype::SVGFEMorphologyElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGFEMorphologyElementPrototype::~SVGFEMorphologyElementPrototype()
{
}

void SVGFEMorphologyElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_radius_x_getter = JS::NativeFunction::create(realm, radius_x_getter, 0, "radiusX"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_radius_x_setter;

    define_direct_accessor("radiusX"_utf16_fly_string, native_radius_x_getter, native_radius_x_setter, default_attributes);

    auto native_radius_y_getter = JS::NativeFunction::create(realm, radius_y_getter, 0, "radiusY"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_radius_y_setter;

    define_direct_accessor("radiusY"_utf16_fly_string, native_radius_y_getter, native_radius_y_setter, default_attributes);
    ...
    auto constant_SVG_MORPHOLOGY_OPERATOR_UNKNOWN_value = JS::Value(static_cast<WebIDL::UnsignedShort>(0));

    define_direct_property("SVG_MORPHOLOGY_OPERATOR_UNKNOWN"_utf16_fly_string, constant_SVG_MORPHOLOGY_OPERATOR_UNKNOWN_value, JS::Attribute::Enumerable);

    auto constant_SVG_MORPHOLOGY_OPERATOR_ERODE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(1));

    define_direct_property("SVG_MORPHOLOGY_OPERATOR_ERODE"_utf16_fly_string, constant_SVG_MORPHOLOGY_OPERATOR_ERODE_value, JS::Attribute::Enumerable);

    auto constant_SVG_MORPHOLOGY_OPERATOR_DILATE_value = JS::Value(static_cast<WebIDL::UnsignedShort>(2));

    define_direct_property("SVG_MORPHOLOGY_OPERATOR_DILATE"_utf16_fly_string, constant_SVG_MORPHOLOGY_OPERATOR_DILATE_value, JS::Attribute::Enumerable);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGFEMorphologyElement"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGFEMorphologyElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGFEMorphologyElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGFEMorphologyElement");
    return static_cast<SVG::SVGFEMorphologyElement*>(this_object);
}
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEMorphologyElementPrototype::operator_getter)
{
    WebIDL::log_trace(vm, "SVGFEMorphologyElementPrototype::operator_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEMorphologyElementPrototype::radius_x_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->radius_x(); }));
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEMorphologyElementPrototype::radius_y_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->radius_y(); }));
