...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLTableElement.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLElement.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLTableCaptionElement.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLTableRowElement.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLTableSectionElement.h>
...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLTableCellElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLTableElementPrototype);

HTMLTableElementPrototype::HTMLTableElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLTableElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_caption_getter = JS::NativeFunction::create(realm, caption_getter, 0, "caption"_utf16_fly_string, &realm, "get"sv);

    auto native_caption_setter = JS::NativeFunction::create(realm, caption_setter, 1, "caption"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("caption"_utf16_fly_string, native_caption_getter, native_caption_setter, default_attributes);

    auto native_t_head_getter = JS::NativeFunction::create(realm, t_head_getter, 0, "tHead"_utf16_fly_string, &realm, "get"sv);

    auto native_t_head_setter = JS::NativeFunction::create(realm, t_head_setter, 1, "tHead"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("tHead"_utf16_fly_string, native_t_head_getter, native_t_head_setter, default_attributes);

    auto native_t_foot_getter = JS::NativeFunction::create(realm, t_foot_getter, 0, "tFoot"_utf16_fly_string, &realm, "get"sv);

    auto native_t_foot_setter = JS::NativeFunction::create(realm, t_foot_setter, 1, "tFoot"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("tFoot"_utf16_fly_string, native_t_foot_getter, native_t_foot_setter, default_attributes);

    auto native_t_bodies_getter = JS::NativeFunction::create(realm, t_bodies_getter, 0, "tBodies"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_t_bodies_setter;

    define_direct_accessor("tBodies"_utf16_fly_string, native_t_bodies_getter, native_t_bodies_setter, default_attributes);

    auto native_rows_getter = JS::NativeFunction::create(realm, rows_getter, 0, "rows"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_rows_setter;
    ...
    auto native_frame_getter = JS::NativeFunction::create(realm, frame_getter, 0, "frame"_utf16_fly_string, &realm, "get"sv);

    auto native_frame_setter = JS::NativeFunction::create(realm, frame_setter, 1, "frame"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("frame"_utf16_fly_string, native_frame_getter, native_frame_setter, default_attributes);

    auto native_rules_getter = JS::NativeFunction::create(realm, rules_getter, 0, "rules"_utf16_fly_string, &realm, "get"sv);

    auto native_rules_setter = JS::NativeFunction::create(realm, rules_setter, 1, "rules"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("rules"_utf16_fly_string, native_rules_getter, native_rules_setter, default_attributes);

    auto native_summary_getter = JS::NativeFunction::create(realm, summary_getter, 0, "summary"_utf16_fly_string, &realm, "get"sv);

    auto native_summary_setter = JS::NativeFunction::create(realm, summary_setter, 1, "summary"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("summary"_utf16_fly_string, native_summary_getter, native_summary_setter, default_attributes);
    ...
    auto native_cell_padding_getter = JS::NativeFunction::create(realm, cell_padding_getter, 0, "cellPadding"_utf16_fly_string, &realm, "get"sv);

    auto native_cell_padding_setter = JS::NativeFunction::create(realm, cell_padding_setter, 1, "cellPadding"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("cellPadding"_utf16_fly_string, native_cell_padding_getter, native_cell_padding_setter, default_attributes);

    auto native_cell_spacing_getter = JS::NativeFunction::create(realm, cell_spacing_getter, 0, "cellSpacing"_utf16_fly_string, &realm, "get"sv);

    auto native_cell_spacing_setter = JS::NativeFunction::create(realm, cell_spacing_setter, 1, "cellSpacing"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("cellSpacing"_utf16_fly_string, native_cell_spacing_getter, native_cell_spacing_setter, default_attributes);

    define_native_function(realm, "createCaption"_utf16_fly_string, create_caption, 0, default_attributes);

    define_native_function(realm, "deleteCaption"_utf16_fly_string, delete_caption, 0, default_attributes);

    define_native_function(realm, "createTHead"_utf16_fly_string, create_t_head, 0, default_attributes);

    define_native_function(realm, "deleteTHead"_utf16_fly_string, delete_t_head, 0, default_attributes);

    define_native_function(realm, "createTFoot"_utf16_fly_string, create_t_foot, 0, default_attributes);

    define_native_function(realm, "deleteTFoot"_utf16_fly_string, delete_t_foot, 0, default_attributes);

    define_native_function(realm, "createTBody"_utf16_fly_string, create_t_body, 0, default_attributes);

    define_native_function(realm, "insertRow"_utf16_fly_string, insert_row, 0, default_attributes);

    define_native_function(realm, "deleteRow"_utf16_fly_string, delete_row, 1, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLTableElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLTableElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLTableElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLTableElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLTableElement");
    return static_cast<HTML::HTMLTableElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLTableElementPrototype::caption_getter)
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::caption_getter");
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->caption(); });
    ...
    return &const_cast<HTMLTableCaptionElement&>(*retval);
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::caption_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    GC::Ptr<HTMLTableCaptionElement> cpp_value;

    if (!value.is_nullish()) {
        if (!value.is_object() || !is<HTMLTableCaptionElement>(value.as_object()))
            return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLTableCaptionElement");

        cpp_value = &static_cast<HTMLTableCaptionElement&>(value.as_object());
    }

    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_caption(cpp_value); });
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::t_head_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->t_head(); });
    ...
    return &const_cast<HTMLTableSectionElement&>(*retval);
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::t_head_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    GC::Ptr<HTMLTableSectionElement> cpp_value;

    if (!value.is_nullish()) {
        if (!value.is_object() || !is<HTMLTableSectionElement>(value.as_object()))
            return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLTableSectionElement");

        cpp_value = &static_cast<HTMLTableSectionElement&>(value.as_object());
    }

    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_t_head(cpp_value); });
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::t_foot_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->t_foot(); });
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::t_foot_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_t_foot(cpp_value); });
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::t_bodies_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->t_bodies(); }));
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::rows_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->rows(); }));
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::align_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::border_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::border_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::frame_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("frame"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::frame_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("frame"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::rules_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("rules"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::rules_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("rules"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::summary_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("summary"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::summary_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("summary"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::width_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::bg_color_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::bg_color_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::cell_padding_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("cellpadding"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::cell_padding_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("cellpadding"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::cell_spacing_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("cellspacing"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::cell_spacing_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("cellspacing"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::create_caption");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    auto* impl = TRY(impl_from(vm));

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->create_caption(); }));
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::delete_caption");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->delete_caption(); });
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::create_t_head");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    auto* impl = TRY(impl_from(vm));

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->create_t_head(); }));
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::delete_t_head");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->delete_t_head(); });
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::create_t_foot");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    auto* impl = TRY(impl_from(vm));

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->create_t_foot(); }));
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::delete_t_foot");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->delete_t_foot(); });
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::create_t_body");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    auto* impl = TRY(impl_from(vm));

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->create_t_body(); }));
...
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::insert_row");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    index = TRY(WebIDL::convert_to_int<WebIDL::Long>(vm, arg0, WebIDL::EnforceRange::No, WebIDL::Clamp::No));

    else
        index = static_cast<WebIDL::Long>(-1);

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->insert_row(index); }));

    return &const_cast<HTMLTableRowElement&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(HTMLTableElementPrototype::delete_row)
{
    WebIDL::log_trace(vm, "HTMLTableElementPrototype::delete_row");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    auto* impl = TRY(impl_from(vm));

    if (vm.argument_count() < 1)
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::BadArgCountOne, "deleteRow");
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->delete_row(index); });
