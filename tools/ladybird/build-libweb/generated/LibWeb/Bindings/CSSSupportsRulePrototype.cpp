...
GC_DEFINE_ALLOCATOR(CSSSupportsRulePrototype);

CSSSupportsRulePrototype::CSSSupportsRulePrototype([[maybe_unused]] JS::Realm& realm)
...
void CSSSupportsRulePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSSupportsRule"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSSupportsRulePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSSupportsRule*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSSupportsRule>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSSupportsRule");
    return static_cast<CSS::CSSSupportsRule*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSSupportsRulePrototype::matches_getter)
{
    WebIDL::log_trace(vm, "CSSSupportsRulePrototype::matches_getter");
