...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/CSS/CSSRotate.h>
...
GC_DEFINE_ALLOCATOR(CSSRotateConstructor);

CSSRotateConstructor::CSSRotateConstructor(JS::Realm& realm)
    : NativeFunction("CSSRotate"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

CSSRotateConstructor::~CSSRotateConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> CSSRotateConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "CSSRotate");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> CSSRotateConstructor::construct0([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "CSSRotateConstructor::construct0");
    ...
    auto& angle = static_cast<CSSNumericValue&>(arg0.as_object());
...
JS::ThrowCompletionOr<GC::Ref<JS::Object>> CSSRotateConstructor::construct1([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "CSSRotateConstructor::construct1");
    ...
    Variant<double, GC::Root<CSSNumericValue>> x = TRY(arg0_to_variant(arg0));
    ...
    Variant<double, GC::Root<CSSNumericValue>> y = TRY(arg1_to_variant(arg1));
    ...
    Variant<double, GC::Root<CSSNumericValue>> z = TRY(arg2_to_variant(arg2));

    auto arg3 = vm.argument(3);

    if (!arg3.is_object() || !is<CSSNumericValue>(arg3.as_object()))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSNumericValue");

    auto& angle = static_cast<CSSNumericValue&>(arg3.as_object());
...
JS::ThrowCompletionOr<GC::Ref<JS::Object>> CSSRotateConstructor::construct(JS::FunctionObject& new_target)
{
    auto& vm = this->vm();
    WebIDL::log_trace(vm, "CSSRotateConstructor::construct");
...
void CSSRotateConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "CSSRotate"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<CSSRotatePrototype>(realm, "CSSRotate"_fly_string), 0);
