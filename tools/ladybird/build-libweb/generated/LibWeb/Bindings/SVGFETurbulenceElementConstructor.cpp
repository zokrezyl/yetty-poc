...
GC_DEFINE_ALLOCATOR(SVGFETurbulenceElementConstructor);

SVGFETurbulenceElementConstructor::SVGFETurbulenceElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGFETurbulenceElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGFETurbulenceElementConstructor::~SVGFETurbulenceElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGFETurbulenceElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGFETurbulenceElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGFETurbulenceElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGFETurbulenceElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGFETurbulenceElement");
}


void SVGFETurbulenceElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGFETurbulenceElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGFETurbulenceElementPrototype>(realm, "SVGFETurbulenceElement"_fly_string), 0);
