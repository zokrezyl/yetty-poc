...
GC_DEFINE_ALLOCATOR(HTMLQuoteElementPrototype);

HTMLQuoteElementPrototype::HTMLQuoteElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLQuoteElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLQuoteElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLQuoteElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLQuoteElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLQuoteElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLQuoteElement");
    return static_cast<HTML::HTMLQuoteElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLQuoteElementPrototype::cite_getter)
{
    WebIDL::log_trace(vm, "HTMLQuoteElementPrototype::cite_getter");
...
{
    WebIDL::log_trace(vm, "HTMLQuoteElementPrototype::cite_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
