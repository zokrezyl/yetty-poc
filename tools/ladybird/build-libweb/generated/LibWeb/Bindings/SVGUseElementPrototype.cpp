...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGUseElement.h>
...
GC_DEFINE_ALLOCATOR(SVGUseElementPrototype);

SVGUseElementPrototype::SVGUseElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGUseElementPrototype::~SVGUseElementPrototype()
{
}

void SVGUseElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_instance_root_getter = JS::NativeFunction::create(realm, instance_root_getter, 0, "instanceRoot"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_instance_root_setter;

    define_direct_accessor("instanceRoot"_utf16_fly_string, native_instance_root_getter, native_instance_root_setter, default_attributes);

    auto native_animated_instance_root_getter = JS::NativeFunction::create(realm, animated_instance_root_getter, 0, "animatedInstanceRoot"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_animated_instance_root_setter;

    define_direct_accessor("animatedInstanceRoot"_utf16_fly_string, native_animated_instance_root_getter, native_animated_instance_root_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGUseElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGUseElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGUseElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGUseElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGUseElement");
    return static_cast<SVG::SVGUseElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGUseElementPrototype::x_getter)
{
    WebIDL::log_trace(vm, "SVGUseElementPrototype::x_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SVGUseElementPrototype::y_getter)
{
    WebIDL::log_trace(vm, "SVGUseElementPrototype::y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGUseElementPrototype::width_getter)
{
    WebIDL::log_trace(vm, "SVGUseElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGUseElementPrototype::height_getter)
{
    WebIDL::log_trace(vm, "SVGUseElementPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGUseElementPrototype::instance_root_getter)
{
    WebIDL::log_trace(vm, "SVGUseElementPrototype::instance_root_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->instance_root(); }));
...
JS_DEFINE_NATIVE_FUNCTION(SVGUseElementPrototype::animated_instance_root_getter)
{
    WebIDL::log_trace(vm, "SVGUseElementPrototype::animated_instance_root_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->animated_instance_root(); }));
...
JS_DEFINE_NATIVE_FUNCTION(SVGUseElementPrototype::href_getter)
{
    WebIDL::log_trace(vm, "SVGUseElementPrototype::href_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
