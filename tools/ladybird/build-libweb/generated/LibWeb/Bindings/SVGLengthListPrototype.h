...
class SVGLengthListPrototype : public JS::Object {
    JS_OBJECT(SVGLengthListPrototype, JS::Object);
    GC_DECLARE_ALLOCATOR(SVGLengthListPrototype);
public:
    static void define_unforgeable_attributes(JS::Realm&, JS::Object&);

    explicit SVGLengthListPrototype(JS::Realm&);
    virtual void initialize(JS::Realm&) override;
    virtual ~SVGLengthListPrototype() override;
private:
