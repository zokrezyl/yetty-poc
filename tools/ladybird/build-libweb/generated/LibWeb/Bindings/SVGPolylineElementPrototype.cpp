...
GC_DEFINE_ALLOCATOR(SVGPolylineElementPrototype);

SVGPolylineElementPrototype::SVGPolylineElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void SVGPolylineElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGPolylineElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGPolylineElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
