...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGFEFuncAElement.h>
...
GC_DEFINE_ALLOCATOR(SVGFEFuncAElementConstructor);

SVGFEFuncAElementConstructor::SVGFEFuncAElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGFEFuncAElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGFEFuncAElementConstructor::~SVGFEFuncAElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGFEFuncAElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGFEFuncAElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGFEFuncAElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGFEFuncAElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGFEFuncAElement");
}


void SVGFEFuncAElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGFEFuncAElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGFEFuncAElementPrototype>(realm, "SVGFEFuncAElement"_fly_string), 0);
