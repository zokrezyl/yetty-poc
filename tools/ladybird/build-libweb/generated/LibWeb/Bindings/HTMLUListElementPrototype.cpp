...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLUListElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLUListElementPrototype);

HTMLUListElementPrototype::HTMLUListElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLUListElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLUListElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLUListElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLUListElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLUListElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLUListElement");
    return static_cast<HTML::HTMLUListElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLUListElementPrototype::compact_getter)
{
    WebIDL::log_trace(vm, "HTMLUListElementPrototype::compact_getter");
...
{
    WebIDL::log_trace(vm, "HTMLUListElementPrototype::compact_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLUListElementPrototype::type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLUListElementPrototype::type_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
