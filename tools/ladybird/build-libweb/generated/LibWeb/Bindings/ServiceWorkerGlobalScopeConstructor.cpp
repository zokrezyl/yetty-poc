...
GC_DEFINE_ALLOCATOR(ServiceWorkerGlobalScopeConstructor);

ServiceWorkerGlobalScopeConstructor::ServiceWorkerGlobalScopeConstructor(JS::Realm& realm)
    : NativeFunction("ServiceWorkerGlobalScope"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

ServiceWorkerGlobalScopeConstructor::~ServiceWorkerGlobalScopeConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> ServiceWorkerGlobalScopeConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "ServiceWorkerGlobalScope");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> ServiceWorkerGlobalScopeConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "ServiceWorkerGlobalScopeConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "ServiceWorkerGlobalScope");
}


void ServiceWorkerGlobalScopeConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "ServiceWorkerGlobalScope"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<ServiceWorkerGlobalScopePrototype>(realm, "ServiceWorkerGlobalScope"_fly_string), 0);
