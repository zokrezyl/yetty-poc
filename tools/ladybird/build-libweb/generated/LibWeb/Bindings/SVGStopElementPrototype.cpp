...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGStopElement.h>
...
GC_DEFINE_ALLOCATOR(SVGStopElementPrototype);

SVGStopElementPrototype::SVGStopElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGStopElementPrototype::~SVGStopElementPrototype()
{
}

void SVGStopElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGStopElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGStopElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGStopElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGStopElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGStopElement");
    return static_cast<SVG::SVGStopElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGStopElementPrototype::offset_getter)
{
    WebIDL::log_trace(vm, "SVGStopElementPrototype::offset_getter");
