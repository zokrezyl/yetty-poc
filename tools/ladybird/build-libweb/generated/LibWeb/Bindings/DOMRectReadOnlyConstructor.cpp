...
GC_DEFINE_ALLOCATOR(DOMRectReadOnlyConstructor);

DOMRectReadOnlyConstructor::DOMRectReadOnlyConstructor(JS::Realm& realm)
    : NativeFunction("DOMRectReadOnly"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}
...
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "DOMRectReadOnly");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> DOMRectReadOnlyConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "DOMRectReadOnlyConstructor::construct");
...
void DOMRectReadOnlyConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "DOMRectReadOnly"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<DOMRectReadOnlyPrototype>(realm, "DOMRectReadOnly"_fly_string), 0);
...
JS_DEFINE_NATIVE_FUNCTION(DOMRectReadOnlyConstructor::from_rect)
{
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return Geometry::DOMRectReadOnly::from_rect(vm, other); }));
