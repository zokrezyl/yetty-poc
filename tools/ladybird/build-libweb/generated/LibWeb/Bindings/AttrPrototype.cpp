...
GC_DEFINE_ALLOCATOR(AttrPrototype);

AttrPrototype::AttrPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

AttrPrototype::~AttrPrototype()
{
}

void AttrPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_owner_element_getter = JS::NativeFunction::create(realm, owner_element_getter, 0, "ownerElement"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_owner_element_setter;

    define_direct_accessor("ownerElement"_utf16_fly_string, native_owner_element_getter, native_owner_element_setter, default_attributes);

    auto native_specified_getter = JS::NativeFunction::create(realm, specified_getter, 0, "specified"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_specified_setter;

    define_direct_accessor("specified"_utf16_fly_string, native_specified_getter, native_specified_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "Attr"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void AttrPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<DOM::Attr*> impl_from(JS::VM& vm)
{
    ...
    if (!is<DOM::Attr>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "Attr");
    return static_cast<DOM::Attr*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(AttrPrototype::namespace_uri_getter)
{
    WebIDL::log_trace(vm, "AttrPrototype::namespace_uri_getter");
...
JS_DEFINE_NATIVE_FUNCTION(AttrPrototype::prefix_getter)
{
    WebIDL::log_trace(vm, "AttrPrototype::prefix_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(AttrPrototype::local_name_getter)
{
    WebIDL::log_trace(vm, "AttrPrototype::local_name_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(AttrPrototype::name_getter)
{
    WebIDL::log_trace(vm, "AttrPrototype::name_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(AttrPrototype::value_getter)
{
    WebIDL::log_trace(vm, "AttrPrototype::value_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(AttrPrototype::value_setter)
{
    WebIDL::log_trace(vm, "AttrPrototype::value_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(AttrPrototype::owner_element_getter)
{
    WebIDL::log_trace(vm, "AttrPrototype::owner_element_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->owner_element(); }));
...
JS_DEFINE_NATIVE_FUNCTION(AttrPrototype::specified_getter)
{
    WebIDL::log_trace(vm, "AttrPrototype::specified_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->specified(); }));
