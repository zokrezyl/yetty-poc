...
GC_DEFINE_ALLOCATOR(SVGFEFuncGElementPrototype);

SVGFEFuncGElementPrototype::SVGFEFuncGElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGFEFuncGElementPrototype::~SVGFEFuncGElementPrototype()
{
}

void SVGFEFuncGElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGFEFuncGElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGFEFuncGElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
