...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/CSS/CSSKeyframesRule.h>
...
GC_DEFINE_ALLOCATOR(CSSKeyframesRulePrototype);

CSSKeyframesRulePrototype::CSSKeyframesRulePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CSSKeyframesRulePrototype::~CSSKeyframesRulePrototype()
{
}

void CSSKeyframesRulePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_accessor("length"_utf16_fly_string, native_length_getter, native_length_setter, default_attributes);
        ...
        define_direct_property("appendRule"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
        define_direct_property("deleteRule"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
        define_direct_property("findRule"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSKeyframesRule"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CSSKeyframesRulePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSKeyframesRule*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSKeyframesRule>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSKeyframesRule");
    return static_cast<CSS::CSSKeyframesRule*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSKeyframesRulePrototype::name_getter)
{
    WebIDL::log_trace(vm, "CSSKeyframesRulePrototype::name_getter");
...
JS_DEFINE_NATIVE_FUNCTION(CSSKeyframesRulePrototype::name_setter)
{
    WebIDL::log_trace(vm, "CSSKeyframesRulePrototype::name_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(CSSKeyframesRulePrototype::css_rules_getter)
{
    WebIDL::log_trace(vm, "CSSKeyframesRulePrototype::css_rules_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(CSSKeyframesRulePrototype::length_getter)
{
    WebIDL::log_trace(vm, "CSSKeyframesRulePrototype::length_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
