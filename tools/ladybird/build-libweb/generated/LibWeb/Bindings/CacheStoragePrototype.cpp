...
GC_DEFINE_ALLOCATOR(CacheStoragePrototype);

CacheStoragePrototype::CacheStoragePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

CacheStoragePrototype::~CacheStoragePrototype()
{
}

void CacheStoragePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CacheStorage"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void CacheStoragePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<ServiceWorker::CacheStorage*> impl_from(JS::VM& vm)
{
    ...
    if (!is<ServiceWorker::CacheStorage>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CacheStorage");
    return static_cast<ServiceWorker::CacheStorage*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CacheStoragePrototype::has)
{
    WebIDL::log_trace(vm, "CacheStoragePrototype::has");
    ...
    if (!false || !arg0.is_null()) {
        cache_name = TRY(WebIDL::to_string(vm, arg0));
    }

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->has(cache_name); }));
...
JS_DEFINE_NATIVE_FUNCTION(CacheStoragePrototype::open)
{
    WebIDL::log_trace(vm, "CacheStoragePrototype::open");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->open(cache_name); }));
