...
GC_DEFINE_ALLOCATOR(SVGFEComponentTransferElementConstructor);

SVGFEComponentTransferElementConstructor::SVGFEComponentTransferElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGFEComponentTransferElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGFEComponentTransferElementConstructor::~SVGFEComponentTransferElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGFEComponentTransferElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGFEComponentTransferElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGFEComponentTransferElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGFEComponentTransferElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGFEComponentTransferElement");
}


void SVGFEComponentTransferElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGFEComponentTransferElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGFEComponentTransferElementPrototype>(realm, "SVGFEComponentTransferElement"_fly_string), 0);
