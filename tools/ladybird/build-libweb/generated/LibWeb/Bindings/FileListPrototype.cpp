...
GC_DEFINE_ALLOCATOR(FileListPrototype);

FileListPrototype::FileListPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

FileListPrototype::~FileListPrototype()
{
}

void FileListPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "FileList"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void FileListPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<FileAPI::FileList*> impl_from(JS::VM& vm)
{
    ...
    if (!is<FileAPI::FileList>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "FileList");
    return static_cast<FileAPI::FileList*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(FileListPrototype::length_getter)
{
    WebIDL::log_trace(vm, "FileListPrototype::length_getter");
...
JS_DEFINE_NATIVE_FUNCTION(FileListPrototype::item)
{
    WebIDL::log_trace(vm, "FileListPrototype::item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
