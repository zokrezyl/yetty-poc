...
GC_DEFINE_ALLOCATOR(SVGFEColorMatrixElementConstructor);

SVGFEColorMatrixElementConstructor::SVGFEColorMatrixElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGFEColorMatrixElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGFEColorMatrixElementConstructor::~SVGFEColorMatrixElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGFEColorMatrixElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGFEColorMatrixElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGFEColorMatrixElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGFEColorMatrixElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGFEColorMatrixElement");
}


void SVGFEColorMatrixElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGFEColorMatrixElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGFEColorMatrixElementPrototype>(realm, "SVGFEColorMatrixElement"_fly_string), 0);
