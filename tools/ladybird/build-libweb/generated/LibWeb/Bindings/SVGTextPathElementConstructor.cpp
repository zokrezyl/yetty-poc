...
GC_DEFINE_ALLOCATOR(SVGTextPathElementConstructor);

SVGTextPathElementConstructor::SVGTextPathElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGTextPathElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGTextPathElementConstructor::~SVGTextPathElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGTextPathElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGTextPathElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGTextPathElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGTextPathElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGTextPathElement");
}


void SVGTextPathElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    set_prototype(&ensure_web_constructor<SVGTextContentElementPrototype>(realm, "SVGTextContentElement"_fly_string));

    define_direct_property(vm.names.length, JS::Value(0), JS::Attribute::Configurable);
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGTextPathElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGTextPathElementPrototype>(realm, "SVGTextPathElement"_fly_string), 0);
