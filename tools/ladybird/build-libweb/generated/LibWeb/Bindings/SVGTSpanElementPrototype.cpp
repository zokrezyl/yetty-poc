...
GC_DEFINE_ALLOCATOR(SVGTSpanElementPrototype);

SVGTSpanElementPrototype::SVGTSpanElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGTSpanElementPrototype::~SVGTSpanElementPrototype()
{
}

void SVGTSpanElementPrototype::initialize(JS::Realm& realm)
{
    ...
    set_prototype(&ensure_web_prototype<SVGTextPositioningElementPrototype>(realm, "SVGTextPositioningElement"_fly_string));


    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGTSpanElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGTSpanElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
