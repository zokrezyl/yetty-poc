...
GC_DEFINE_ALLOCATOR(MediaElementAudioSourceNodePrototype);

MediaElementAudioSourceNodePrototype::MediaElementAudioSourceNodePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

MediaElementAudioSourceNodePrototype::~MediaElementAudioSourceNodePrototype()
{
}

void MediaElementAudioSourceNodePrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_media_element_getter = JS::NativeFunction::create(realm, media_element_getter, 0, "mediaElement"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_media_element_setter;

    define_direct_accessor("mediaElement"_utf16_fly_string, native_media_element_getter, native_media_element_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "MediaElementAudioSourceNode"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void MediaElementAudioSourceNodePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<WebAudio::MediaElementAudioSourceNode*> impl_from(JS::VM& vm)
{
    ...
    if (!is<WebAudio::MediaElementAudioSourceNode>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "MediaElementAudioSourceNode");
    return static_cast<WebAudio::MediaElementAudioSourceNode*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(MediaElementAudioSourceNodePrototype::media_element_getter)
{
    WebIDL::log_trace(vm, "MediaElementAudioSourceNodePrototype::media_element_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->media_element(); }));

    return &const_cast<HTMLMediaElement&>(*retval);
