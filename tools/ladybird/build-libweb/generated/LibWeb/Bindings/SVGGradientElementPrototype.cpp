...
GC_DEFINE_ALLOCATOR(SVGGradientElementPrototype);

SVGGradientElementPrototype::SVGGradientElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGGradientElementPrototype::~SVGGradientElementPrototype()
{
}

void SVGGradientElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property("gradientUnits"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property("gradientTransform"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
    define_direct_property("spreadMethod"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
    ...
    auto constant_SVG_SPREADMETHOD_UNKNOWN_value = JS::Value(static_cast<WebIDL::UnsignedShort>(0));

    define_direct_property("SVG_SPREADMETHOD_UNKNOWN"_utf16_fly_string, constant_SVG_SPREADMETHOD_UNKNOWN_value, JS::Attribute::Enumerable);

    auto constant_SVG_SPREADMETHOD_PAD_value = JS::Value(static_cast<WebIDL::UnsignedShort>(1));

    define_direct_property("SVG_SPREADMETHOD_PAD"_utf16_fly_string, constant_SVG_SPREADMETHOD_PAD_value, JS::Attribute::Enumerable);

    auto constant_SVG_SPREADMETHOD_REFLECT_value = JS::Value(static_cast<WebIDL::UnsignedShort>(2));

    define_direct_property("SVG_SPREADMETHOD_REFLECT"_utf16_fly_string, constant_SVG_SPREADMETHOD_REFLECT_value, JS::Attribute::Enumerable);

    auto constant_SVG_SPREADMETHOD_REPEAT_value = JS::Value(static_cast<WebIDL::UnsignedShort>(3));

    define_direct_property("SVG_SPREADMETHOD_REPEAT"_utf16_fly_string, constant_SVG_SPREADMETHOD_REPEAT_value, JS::Attribute::Enumerable);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGGradientElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGGradientElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGGradientElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGGradientElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGGradientElement");
    return static_cast<SVG::SVGGradientElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGGradientElementPrototype::href_getter)
{
    WebIDL::log_trace(vm, "SVGGradientElementPrototype::href_getter");
