...
GC_DEFINE_ALLOCATOR(ImageBitmapPrototype);

ImageBitmapPrototype::ImageBitmapPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

ImageBitmapPrototype::~ImageBitmapPrototype()
{
}

void ImageBitmapPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "ImageBitmap"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void ImageBitmapPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::ImageBitmap*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::ImageBitmap>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "ImageBitmap");
    return static_cast<HTML::ImageBitmap*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(ImageBitmapPrototype::width_getter)
{
    WebIDL::log_trace(vm, "ImageBitmapPrototype::width_getter");
...
JS_DEFINE_NATIVE_FUNCTION(ImageBitmapPrototype::height_getter)
{
    WebIDL::log_trace(vm, "ImageBitmapPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(ImageBitmapPrototype::close)
{
    WebIDL::log_trace(vm, "ImageBitmapPrototype::close");
    [[maybe_unused]] auto& realm = *vm.current_realm();
