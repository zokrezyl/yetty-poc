...
GC_DEFINE_ALLOCATOR(SVGGElementPrototype);

SVGGElementPrototype::SVGGElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGGElementPrototype::~SVGGElementPrototype()
{
}

void SVGGElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGGElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGGElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
