...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGFEMergeElement.h>
...
GC_DEFINE_ALLOCATOR(SVGFEMergeElementPrototype);

SVGFEMergeElementPrototype::SVGFEMergeElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGFEMergeElementPrototype::~SVGFEMergeElementPrototype()
{
}

void SVGFEMergeElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGFEMergeElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGFEMergeElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGFEMergeElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGFEMergeElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGFEMergeElement");
    return static_cast<SVG::SVGFEMergeElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGFEMergeElementPrototype::x_getter)
{
    WebIDL::log_trace(vm, "SVGFEMergeElementPrototype::x_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEMergeElementPrototype::y_getter)
{
    WebIDL::log_trace(vm, "SVGFEMergeElementPrototype::y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEMergeElementPrototype::width_getter)
{
    WebIDL::log_trace(vm, "SVGFEMergeElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEMergeElementPrototype::height_getter)
{
    WebIDL::log_trace(vm, "SVGFEMergeElementPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SVGFEMergeElementPrototype::result_getter)
{
    WebIDL::log_trace(vm, "SVGFEMergeElementPrototype::result_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
