...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGLineElement.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGAnimatedLength.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGGeometryElement.h>
...
GC_DEFINE_ALLOCATOR(SVGLineElementPrototype);

SVGLineElementPrototype::SVGLineElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void SVGLineElementPrototype::initialize(JS::Realm& realm)
{
    ...
    set_prototype(&ensure_web_prototype<SVGGeometryElementPrototype>(realm, "SVGGeometryElement"_fly_string));
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGLineElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SVGLineElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGLineElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGLineElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGLineElement");
    return static_cast<SVG::SVGLineElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SVGLineElementPrototype::x1_getter)
{
    WebIDL::log_trace(vm, "SVGLineElementPrototype::x1_getter");
...
{
    WebIDL::log_trace(vm, "SVGLineElementPrototype::y1_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "SVGLineElementPrototype::x2_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "SVGLineElementPrototype::y2_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
