...
GC_DEFINE_ALLOCATOR(SharedWorkerPrototype);

SharedWorkerPrototype::SharedWorkerPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SharedWorkerPrototype::~SharedWorkerPrototype()
{
}

void SharedWorkerPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SharedWorker"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SharedWorkerPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::SharedWorker*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::SharedWorker>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SharedWorker");
    return static_cast<HTML::SharedWorker*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SharedWorkerPrototype::port_getter)
{
    WebIDL::log_trace(vm, "SharedWorkerPrototype::port_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SharedWorkerPrototype::onerror_getter)
{
    WebIDL::log_trace(vm, "SharedWorkerPrototype::onerror_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(SharedWorkerPrototype::onerror_setter)
{
    WebIDL::log_trace(vm, "SharedWorkerPrototype::onerror_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
