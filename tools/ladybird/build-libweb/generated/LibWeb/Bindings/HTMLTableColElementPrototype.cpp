...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLTableColElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLTableColElementPrototype);

HTMLTableColElementPrototype::HTMLTableColElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLTableColElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_span_getter = JS::NativeFunction::create(realm, span_getter, 0, "span"_utf16_fly_string, &realm, "get"sv);

    auto native_span_setter = JS::NativeFunction::create(realm, span_setter, 1, "span"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("span"_utf16_fly_string, native_span_getter, native_span_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLTableColElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLTableColElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLTableColElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLTableColElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLTableColElement");
    return static_cast<HTML::HTMLTableColElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLTableColElementPrototype::span_getter)
{
    WebIDL::log_trace(vm, "HTMLTableColElementPrototype::span_getter");
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->span(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableColElementPrototype::span_setter)
{
    WebIDL::log_trace(vm, "HTMLTableColElementPrototype::span_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_span(cpp_value); });
...
{
    WebIDL::log_trace(vm, "HTMLTableColElementPrototype::align_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableColElementPrototype::align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableColElementPrototype::ch_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableColElementPrototype::ch_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableColElementPrototype::ch_off_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableColElementPrototype::ch_off_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableColElementPrototype::v_align_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableColElementPrototype::v_align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableColElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableColElementPrototype::width_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
