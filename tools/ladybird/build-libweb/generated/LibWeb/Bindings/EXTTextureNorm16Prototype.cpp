...
GC_DEFINE_ALLOCATOR(EXTTextureNorm16Prototype);

EXTTextureNorm16Prototype::EXTTextureNorm16Prototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

EXTTextureNorm16Prototype::~EXTTextureNorm16Prototype()
{
}

void EXTTextureNorm16Prototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "EXTTextureNorm16"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void EXTTextureNorm16Prototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
