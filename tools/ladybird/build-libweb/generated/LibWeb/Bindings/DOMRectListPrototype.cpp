...
GC_DEFINE_ALLOCATOR(DOMRectListPrototype);

DOMRectListPrototype::DOMRectListPrototype([[maybe_unused]] JS::Realm& realm)
...
void DOMRectListPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "DOMRectList"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void DOMRectListPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<Geometry::DOMRectList*> impl_from(JS::VM& vm)
{
    ...
    if (!is<Geometry::DOMRectList>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "DOMRectList");
    return static_cast<Geometry::DOMRectList*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(DOMRectListPrototype::length_getter)
{
    WebIDL::log_trace(vm, "DOMRectListPrototype::length_getter");
...
{
    WebIDL::log_trace(vm, "DOMRectListPrototype::item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
