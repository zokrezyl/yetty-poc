...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/CSS/CSSImportRule.h>
...
GC_DEFINE_ALLOCATOR(CSSImportRulePrototype);

CSSImportRulePrototype::CSSImportRulePrototype([[maybe_unused]] JS::Realm& realm)
...
void CSSImportRulePrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_style_sheet_getter = JS::NativeFunction::create(realm, style_sheet_getter, 0, "styleSheet"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_style_sheet_setter;

    define_direct_accessor("styleSheet"_utf16_fly_string, native_style_sheet_getter, native_style_sheet_setter, default_attributes);

    auto native_layer_name_getter = JS::NativeFunction::create(realm, layer_name_getter, 0, "layerName"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_layer_name_setter;

    define_direct_accessor("layerName"_utf16_fly_string, native_layer_name_getter, native_layer_name_setter, default_attributes);

    auto native_supports_text_getter = JS::NativeFunction::create(realm, supports_text_getter, 0, "supportsText"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_supports_text_setter;

    define_direct_accessor("supportsText"_utf16_fly_string, native_supports_text_getter, native_supports_text_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSImportRule"_string), JS::Attribute::Configurable);
...
JS_DEFINE_NATIVE_FUNCTION(CSSImportRulePrototype::media_getter)
{
    ...
    return &const_cast<MediaList&>(*retval);
...
JS_DEFINE_NATIVE_FUNCTION(CSSImportRulePrototype::media_setter)
{
    ...
    auto receiver_value = TRY(impl->get("media"_utf16_fly_string));
...
JS_DEFINE_NATIVE_FUNCTION(CSSImportRulePrototype::style_sheet_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->style_sheet_for_bindings(); }));
...
JS_DEFINE_NATIVE_FUNCTION(CSSImportRulePrototype::layer_name_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->layer_name(); }));
...
JS_DEFINE_NATIVE_FUNCTION(CSSImportRulePrototype::supports_text_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->supports_text(); }));
