...
GC_DEFINE_ALLOCATOR(SVGFEGaussianBlurElementConstructor);

SVGFEGaussianBlurElementConstructor::SVGFEGaussianBlurElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGFEGaussianBlurElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGFEGaussianBlurElementConstructor::~SVGFEGaussianBlurElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGFEGaussianBlurElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGFEGaussianBlurElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGFEGaussianBlurElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGFEGaussianBlurElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGFEGaussianBlurElement");
}


void SVGFEGaussianBlurElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGFEGaussianBlurElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGFEGaussianBlurElementPrototype>(realm, "SVGFEGaussianBlurElement"_fly_string), 0);
