...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLFontElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLFontElementPrototype);

HTMLFontElementPrototype::HTMLFontElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLFontElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_face_getter = JS::NativeFunction::create(realm, face_getter, 0, "face"_utf16_fly_string, &realm, "get"sv);

    auto native_face_setter = JS::NativeFunction::create(realm, face_setter, 1, "face"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("face"_utf16_fly_string, native_face_getter, native_face_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLFontElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLFontElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLFontElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLFontElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLFontElement");
    return static_cast<HTML::HTMLFontElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLFontElementPrototype::color_getter)
{
    WebIDL::log_trace(vm, "HTMLFontElementPrototype::color_getter");
...
{
    WebIDL::log_trace(vm, "HTMLFontElementPrototype::color_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLFontElementPrototype::face_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("face"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLFontElementPrototype::face_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("face"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLFontElementPrototype::size_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLFontElementPrototype::size_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
