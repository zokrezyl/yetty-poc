...
GC_DEFINE_ALLOCATOR(SVGFEOffsetElementConstructor);

SVGFEOffsetElementConstructor::SVGFEOffsetElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGFEOffsetElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGFEOffsetElementConstructor::~SVGFEOffsetElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGFEOffsetElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGFEOffsetElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGFEOffsetElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGFEOffsetElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGFEOffsetElement");
}


void SVGFEOffsetElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGFEOffsetElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGFEOffsetElementPrototype>(realm, "SVGFEOffsetElement"_fly_string), 0);
