...
GC_DEFINE_ALLOCATOR(DOMParserPrototype);

DOMParserPrototype::DOMParserPrototype([[maybe_unused]] JS::Realm& realm)
...
void DOMParserPrototype::initialize(JS::Realm& realm)
{
    ...
    define_native_function(realm, "parseFromString"_utf16_fly_string, parse_from_string, 2, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "DOMParser"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void DOMParserPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::DOMParser*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::DOMParser>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "DOMParser");
    return static_cast<HTML::DOMParser*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(DOMParserPrototype::parse_from_string)
{
    WebIDL::log_trace(vm, "DOMParserPrototype::parse_from_string");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    auto* impl = TRY(impl_from(vm));

    if (vm.argument_count() < 2)
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::BadArgCountMany, "parseFromString", "2");
    ...
    if (arg1_string == "text/html"sv)
    ...
    else if (arg1_string == "application/xhtml+xml"sv)
        ...
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::InvalidEnumerationValue, arg1_string, "DOMParserSupportedType");

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->parse_from_string(string, type); }));
