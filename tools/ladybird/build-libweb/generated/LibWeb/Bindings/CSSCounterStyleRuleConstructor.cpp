...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/CSS/CSSCounterStyleRule.h>
...
GC_DEFINE_ALLOCATOR(CSSCounterStyleRuleConstructor);

CSSCounterStyleRuleConstructor::CSSCounterStyleRuleConstructor(JS::Realm& realm)
    : NativeFunction("CSSCounterStyleRule"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

CSSCounterStyleRuleConstructor::~CSSCounterStyleRuleConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> CSSCounterStyleRuleConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "CSSCounterStyleRule");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> CSSCounterStyleRuleConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "CSSCounterStyleRuleConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "CSSCounterStyleRule");
}


void CSSCounterStyleRuleConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "CSSCounterStyleRule"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<CSSCounterStyleRulePrototype>(realm, "CSSCounterStyleRule"_fly_string), 0);
