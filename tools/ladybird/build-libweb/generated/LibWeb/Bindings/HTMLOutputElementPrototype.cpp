...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLOutputElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLOutputElementPrototype);

HTMLOutputElementPrototype::HTMLOutputElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLOutputElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLOutputElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLOutputElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLOutputElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLOutputElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLOutputElement");
    return static_cast<HTML::HTMLOutputElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLOutputElementPrototype::html_for_getter)
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::html_for_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->html_for(); }));

    return &const_cast<DOMTokenList&>(*retval);

}

JS_DEFINE_NATIVE_FUNCTION(HTMLOutputElementPrototype::html_for_setter)
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::html_for_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto receiver_value = TRY(impl->get("htmlFor"_utf16_fly_string));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOutputElementPrototype::form_getter)
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::form_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOutputElementPrototype::name_getter)
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::name_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOutputElementPrototype::name_setter)
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::name_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOutputElementPrototype::default_value_getter)
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::default_value_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOutputElementPrototype::default_value_setter)
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::default_value_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOutputElementPrototype::value_getter)
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::value_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOutputElementPrototype::value_setter)
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::value_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOutputElementPrototype::will_validate_getter)
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::will_validate_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOutputElementPrototype::validity_getter)
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::validity_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOutputElementPrototype::validation_message_getter)
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::validation_message_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOutputElementPrototype::labels_getter)
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::labels_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOutputElementPrototype::check_validity)
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::check_validity");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOutputElementPrototype::report_validity)
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::report_validity");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLOutputElementPrototype::set_custom_validity)
{
    WebIDL::log_trace(vm, "HTMLOutputElementPrototype::set_custom_validity");
    [[maybe_unused]] auto& realm = *vm.current_realm();
