...
GC_DEFINE_ALLOCATOR(TextTrackListPrototype);

TextTrackListPrototype::TextTrackListPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

TextTrackListPrototype::~TextTrackListPrototype()
{
}

void TextTrackListPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "TextTrackList"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void TextTrackListPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::TextTrackList*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::TextTrackList>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "TextTrackList");
    return static_cast<HTML::TextTrackList*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(TextTrackListPrototype::length_getter)
{
    WebIDL::log_trace(vm, "TextTrackListPrototype::length_getter");
...
JS_DEFINE_NATIVE_FUNCTION(TextTrackListPrototype::onchange_getter)
{
    WebIDL::log_trace(vm, "TextTrackListPrototype::onchange_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(TextTrackListPrototype::onchange_setter)
{
    WebIDL::log_trace(vm, "TextTrackListPrototype::onchange_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(TextTrackListPrototype::onaddtrack_getter)
{
    WebIDL::log_trace(vm, "TextTrackListPrototype::onaddtrack_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(TextTrackListPrototype::onaddtrack_setter)
{
    WebIDL::log_trace(vm, "TextTrackListPrototype::onaddtrack_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(TextTrackListPrototype::onremovetrack_getter)
{
    WebIDL::log_trace(vm, "TextTrackListPrototype::onremovetrack_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(TextTrackListPrototype::onremovetrack_setter)
{
    WebIDL::log_trace(vm, "TextTrackListPrototype::onremovetrack_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(TextTrackListPrototype::get_track_by_id)
{
    WebIDL::log_trace(vm, "TextTrackListPrototype::get_track_by_id");
    [[maybe_unused]] auto& realm = *vm.current_realm();
