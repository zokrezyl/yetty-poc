...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLObjectElement.h>
...
GC_DEFINE_ALLOCATOR(HTMLObjectElementPrototype);

HTMLObjectElementPrototype::HTMLObjectElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLObjectElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_archive_getter = JS::NativeFunction::create(realm, archive_getter, 0, "archive"_utf16_fly_string, &realm, "get"sv);

    auto native_archive_setter = JS::NativeFunction::create(realm, archive_setter, 1, "archive"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("archive"_utf16_fly_string, native_archive_getter, native_archive_setter, default_attributes);

    auto native_code_getter = JS::NativeFunction::create(realm, code_getter, 0, "code"_utf16_fly_string, &realm, "get"sv);

    auto native_code_setter = JS::NativeFunction::create(realm, code_setter, 1, "code"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("code"_utf16_fly_string, native_code_getter, native_code_setter, default_attributes);

    auto native_declare_getter = JS::NativeFunction::create(realm, declare_getter, 0, "declare"_utf16_fly_string, &realm, "get"sv);

    auto native_declare_setter = JS::NativeFunction::create(realm, declare_setter, 1, "declare"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("declare"_utf16_fly_string, native_declare_getter, native_declare_setter, default_attributes);
    ...
    auto native_standby_getter = JS::NativeFunction::create(realm, standby_getter, 0, "standby"_utf16_fly_string, &realm, "get"sv);

    auto native_standby_setter = JS::NativeFunction::create(realm, standby_setter, 1, "standby"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("standby"_utf16_fly_string, native_standby_getter, native_standby_setter, default_attributes);
    ...
    auto native_code_base_getter = JS::NativeFunction::create(realm, code_base_getter, 0, "codeBase"_utf16_fly_string, &realm, "get"sv);

    auto native_code_base_setter = JS::NativeFunction::create(realm, code_base_setter, 1, "codeBase"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("codeBase"_utf16_fly_string, native_code_base_getter, native_code_base_setter, default_attributes);

    auto native_code_type_getter = JS::NativeFunction::create(realm, code_type_getter, 0, "codeType"_utf16_fly_string, &realm, "get"sv);

    auto native_code_type_setter = JS::NativeFunction::create(realm, code_type_setter, 1, "codeType"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("codeType"_utf16_fly_string, native_code_type_getter, native_code_type_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLObjectElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLObjectElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLObjectElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLObjectElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLObjectElement");
    return static_cast<HTML::HTMLObjectElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLObjectElementPrototype::data_getter)
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::data_getter");
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->data(); });
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::data_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_data(cpp_value); });
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::type_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::name_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::name_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLObjectElementPrototype::form_getter)
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::form_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::width_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::height_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::content_document_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLObjectElementPrototype::content_window_getter)
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::content_window_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLObjectElementPrototype::will_validate_getter)
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::will_validate_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLObjectElementPrototype::validity_getter)
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::validity_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLObjectElementPrototype::validation_message_getter)
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::validation_message_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::align_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::archive_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("archive"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::archive_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("archive"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::code_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("code"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::code_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("code"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::declare_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval = impl->has_attribute("declare"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::declare_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value)
        impl->remove_attribute("declare"_fly_string);
    else
        impl->set_attribute_value("declare"_fly_string, String {});
...
JS_DEFINE_NATIVE_FUNCTION(HTMLObjectElementPrototype::hspace_getter)
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::hspace_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLObjectElementPrototype::hspace_setter)
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::hspace_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::standby_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("standby"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::standby_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("standby"_fly_string, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLObjectElementPrototype::vspace_getter)
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::vspace_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLObjectElementPrototype::vspace_setter)
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::vspace_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLObjectElementPrototype::code_base_getter)
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::code_base_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto content_attribute_value = impl->attribute("codebase"_fly_string);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLObjectElementPrototype::code_base_setter)
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::code_base_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("codebase"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::code_type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("codetype"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::code_type_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("codetype"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::use_map_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::use_map_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::border_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::border_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::get_svg_document");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLObjectElementPrototype::check_validity)
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::check_validity");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLObjectElementPrototype::report_validity)
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::report_validity");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLObjectElementPrototype::set_custom_validity)
{
    WebIDL::log_trace(vm, "HTMLObjectElementPrototype::set_custom_validity");
    [[maybe_unused]] auto& realm = *vm.current_realm();
