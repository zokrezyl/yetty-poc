...
#if __has_include(<LibWeb/Bindings/DOMPointReadOnlyPrototype.h>)
...
GC_DEFINE_ALLOCATOR(DOMPointPrototype);

DOMPointPrototype::DOMPointPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

DOMPointPrototype::~DOMPointPrototype()
{
}

void DOMPointPrototype::initialize(JS::Realm& realm)
{
    ...
    set_prototype(&ensure_web_prototype<DOMPointReadOnlyPrototype>(realm, "DOMPointReadOnly"_fly_string));
    ...
    auto native_w_setter = JS::NativeFunction::create(realm, w_setter, 1, "w"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("w"_utf16_fly_string, native_w_getter, native_w_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "DOMPoint"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void DOMPointPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<Geometry::DOMPoint*> impl_from(JS::VM& vm)
{
    ...
    if (!is<Geometry::DOMPoint>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "DOMPoint");
    return static_cast<Geometry::DOMPoint*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(DOMPointPrototype::x_getter)
{
    WebIDL::log_trace(vm, "DOMPointPrototype::x_getter");
...
JS_DEFINE_NATIVE_FUNCTION(DOMPointPrototype::x_setter)
{
    WebIDL::log_trace(vm, "DOMPointPrototype::x_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(DOMPointPrototype::y_getter)
{
    WebIDL::log_trace(vm, "DOMPointPrototype::y_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(DOMPointPrototype::y_setter)
{
    WebIDL::log_trace(vm, "DOMPointPrototype::y_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(DOMPointPrototype::z_getter)
{
    WebIDL::log_trace(vm, "DOMPointPrototype::z_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(DOMPointPrototype::z_setter)
{
    WebIDL::log_trace(vm, "DOMPointPrototype::z_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(DOMPointPrototype::w_getter)
{
    WebIDL::log_trace(vm, "DOMPointPrototype::w_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(DOMPointPrototype::w_setter)
{
    WebIDL::log_trace(vm, "DOMPointPrototype::w_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_w(cpp_value); }));
