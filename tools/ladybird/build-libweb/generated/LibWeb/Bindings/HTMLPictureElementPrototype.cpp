...
GC_DEFINE_ALLOCATOR(HTMLPictureElementPrototype);

HTMLPictureElementPrototype::HTMLPictureElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLPictureElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLPictureElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLPictureElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
