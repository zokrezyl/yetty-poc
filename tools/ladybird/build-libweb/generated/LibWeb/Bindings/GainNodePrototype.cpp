...
GC_DEFINE_ALLOCATOR(GainNodePrototype);

GainNodePrototype::GainNodePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

GainNodePrototype::~GainNodePrototype()
{
}

void GainNodePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "GainNode"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void GainNodePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<WebAudio::GainNode*> impl_from(JS::VM& vm)
{
    ...
    if (!is<WebAudio::GainNode>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "GainNode");
    return static_cast<WebAudio::GainNode*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(GainNodePrototype::gain_getter)
{
    WebIDL::log_trace(vm, "GainNodePrototype::gain_getter");
