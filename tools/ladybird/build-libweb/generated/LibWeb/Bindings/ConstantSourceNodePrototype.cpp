...
GC_DEFINE_ALLOCATOR(ConstantSourceNodePrototype);

ConstantSourceNodePrototype::ConstantSourceNodePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

ConstantSourceNodePrototype::~ConstantSourceNodePrototype()
{
}

void ConstantSourceNodePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "ConstantSourceNode"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void ConstantSourceNodePrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<WebAudio::ConstantSourceNode*> impl_from(JS::VM& vm)
{
    ...
    if (!is<WebAudio::ConstantSourceNode>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "ConstantSourceNode");
    return static_cast<WebAudio::ConstantSourceNode*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(ConstantSourceNodePrototype::offset_getter)
{
    WebIDL::log_trace(vm, "ConstantSourceNodePrototype::offset_getter");
