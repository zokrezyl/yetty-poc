...
GC_DEFINE_ALLOCATOR(SpeechGrammarListPrototype);

SpeechGrammarListPrototype::SpeechGrammarListPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

SpeechGrammarListPrototype::~SpeechGrammarListPrototype()
{
}

void SpeechGrammarListPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_accessor("length"_utf16_fly_string, native_length_getter, native_length_setter, default_attributes);
        ...
        define_direct_property("addFromURI"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
            
        define_direct_property("addFromString"_utf16_fly_string, JS::js_undefined(), default_attributes | JS::Attribute::Unimplemented);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SpeechGrammarList"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void SpeechGrammarListPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<SpeechGrammarList*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SpeechGrammarList>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SpeechGrammarList");
    return static_cast<SpeechGrammarList*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(SpeechGrammarListPrototype::length_getter)
{
    WebIDL::log_trace(vm, "SpeechGrammarListPrototype::length_getter");
...
JS_DEFINE_NATIVE_FUNCTION(SpeechGrammarListPrototype::item)
{
    WebIDL::log_trace(vm, "SpeechGrammarListPrototype::item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    return &const_cast<SpeechGrammar&>(*retval);
