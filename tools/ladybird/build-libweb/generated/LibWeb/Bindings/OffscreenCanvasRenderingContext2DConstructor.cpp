...
GC_DEFINE_ALLOCATOR(OffscreenCanvasRenderingContext2DConstructor);

OffscreenCanvasRenderingContext2DConstructor::OffscreenCanvasRenderingContext2DConstructor(JS::Realm& realm)
    : NativeFunction("OffscreenCanvasRenderingContext2D"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

OffscreenCanvasRenderingContext2DConstructor::~OffscreenCanvasRenderingContext2DConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> OffscreenCanvasRenderingContext2DConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "OffscreenCanvasRenderingContext2D");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> OffscreenCanvasRenderingContext2DConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "OffscreenCanvasRenderingContext2DConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "OffscreenCanvasRenderingContext2D");
}


void OffscreenCanvasRenderingContext2DConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "OffscreenCanvasRenderingContext2D"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<OffscreenCanvasRenderingContext2DPrototype>(realm, "OffscreenCanvasRenderingContext2D"_fly_string), 0);
