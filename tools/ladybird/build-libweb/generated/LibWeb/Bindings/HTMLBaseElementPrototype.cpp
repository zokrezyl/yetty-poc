...
GC_DEFINE_ALLOCATOR(HTMLBaseElementPrototype);

HTMLBaseElementPrototype::HTMLBaseElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLBaseElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLBaseElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLBaseElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLBaseElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLBaseElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLBaseElement");
    return static_cast<HTML::HTMLBaseElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLBaseElementPrototype::href_getter)
{
    WebIDL::log_trace(vm, "HTMLBaseElementPrototype::href_getter");
...
JS_DEFINE_NATIVE_FUNCTION(HTMLBaseElementPrototype::href_setter)
{
    WebIDL::log_trace(vm, "HTMLBaseElementPrototype::href_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLBaseElementPrototype::target_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLBaseElementPrototype::target_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
