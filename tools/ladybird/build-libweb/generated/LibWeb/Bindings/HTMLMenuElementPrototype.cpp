...
GC_DEFINE_ALLOCATOR(HTMLMenuElementPrototype);

HTMLMenuElementPrototype::HTMLMenuElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLMenuElementPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLMenuElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLMenuElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLMenuElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLMenuElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLMenuElement");
    return static_cast<HTML::HTMLMenuElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLMenuElementPrototype::compact_getter)
{
    WebIDL::log_trace(vm, "HTMLMenuElementPrototype::compact_getter");
...
{
    WebIDL::log_trace(vm, "HTMLMenuElementPrototype::compact_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
