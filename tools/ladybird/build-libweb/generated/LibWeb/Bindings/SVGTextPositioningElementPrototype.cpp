...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGTextPositioningElement.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGAnimatedLengthList.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGAnimatedNumberList.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGTextContentElement.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGLengthList.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGNumberList.h>
...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/SVG/SVGNumber.h>
...
GC_DEFINE_ALLOCATOR(SVGTextPositioningElementPrototype);

SVGTextPositioningElementPrototype::SVGTextPositioningElementPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

SVGTextPositioningElementPrototype::~SVGTextPositioningElementPrototype()
{
}

void SVGTextPositioningElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_rotate_getter = JS::NativeFunction::create(realm, rotate_getter, 0, "rotate"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_rotate_setter;

    define_direct_accessor("rotate"_utf16_fly_string, native_rotate_getter, native_rotate_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "SVGTextPositioningElement"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<SVG::SVGTextPositioningElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<SVG::SVGTextPositioningElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "SVGTextPositioningElement");
    return static_cast<SVG::SVGTextPositioningElement*>(this_object);
}
...
JS_DEFINE_NATIVE_FUNCTION(SVGTextPositioningElementPrototype::x_getter)
{
    ...
    return &const_cast<SVGAnimatedLengthList&>(*retval);
...
JS_DEFINE_NATIVE_FUNCTION(SVGTextPositioningElementPrototype::rotate_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->rotate(); }));
