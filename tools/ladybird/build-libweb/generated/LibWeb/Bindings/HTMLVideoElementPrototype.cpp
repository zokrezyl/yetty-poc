...
GC_DEFINE_ALLOCATOR(HTMLVideoElementPrototype);

HTMLVideoElementPrototype::HTMLVideoElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLVideoElementPrototype::initialize(JS::Realm& realm)
{
    ...
    set_prototype(&ensure_web_prototype<HTMLMediaElementPrototype>(realm, "HTMLMediaElement"_fly_string));
    ...
    auto native_video_width_getter = JS::NativeFunction::create(realm, video_width_getter, 0, "videoWidth"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_video_width_setter;

    define_direct_accessor("videoWidth"_utf16_fly_string, native_video_width_getter, native_video_width_setter, default_attributes);

    auto native_video_height_getter = JS::NativeFunction::create(realm, video_height_getter, 0, "videoHeight"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_video_height_setter;

    define_direct_accessor("videoHeight"_utf16_fly_string, native_video_height_getter, native_video_height_setter, default_attributes);

    auto native_poster_getter = JS::NativeFunction::create(realm, poster_getter, 0, "poster"_utf16_fly_string, &realm, "get"sv);

    auto native_poster_setter = JS::NativeFunction::create(realm, poster_setter, 1, "poster"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("poster"_utf16_fly_string, native_poster_getter, native_poster_setter, default_attributes);

    auto native_plays_inline_getter = JS::NativeFunction::create(realm, plays_inline_getter, 0, "playsInline"_utf16_fly_string, &realm, "get"sv);

    auto native_plays_inline_setter = JS::NativeFunction::create(realm, plays_inline_setter, 1, "playsInline"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("playsInline"_utf16_fly_string, native_plays_inline_getter, native_plays_inline_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLVideoElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLVideoElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLVideoElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLVideoElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLVideoElement");
    return static_cast<HTML::HTMLVideoElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLVideoElementPrototype::width_getter)
{
    WebIDL::log_trace(vm, "HTMLVideoElementPrototype::width_getter");
    ...
    u32 retval = 0;
    auto content_attribute_value = impl->get_attribute("width"_fly_string);
    u32 minimum = 0;
...
JS_DEFINE_NATIVE_FUNCTION(HTMLVideoElementPrototype::width_setter)
{
    WebIDL::log_trace(vm, "HTMLVideoElementPrototype::width_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (cpp_value >= minimum && cpp_value <= 2147483647)
        new_value = cpp_value;
    impl->set_attribute_value("width"_fly_string, String::number(new_value));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLVideoElementPrototype::height_getter)
{
    WebIDL::log_trace(vm, "HTMLVideoElementPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    u32 retval = 0;
    auto content_attribute_value = impl->get_attribute("height"_fly_string);
    u32 minimum = 0;
    u32 maximum = 2147483647;
    if (content_attribute_value.has_value()) {
        auto parsed_value = Web::HTML::parse_non_negative_integer(*content_attribute_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLVideoElementPrototype::height_setter)
{
    WebIDL::log_trace(vm, "HTMLVideoElementPrototype::height_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (cpp_value >= minimum && cpp_value <= 2147483647)
        new_value = cpp_value;
    impl->set_attribute_value("height"_fly_string, String::number(new_value));
...
JS_DEFINE_NATIVE_FUNCTION(HTMLVideoElementPrototype::video_width_getter)
{
    WebIDL::log_trace(vm, "HTMLVideoElementPrototype::video_width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->video_width(); }));

    return JS::Value(static_cast<WebIDL::UnsignedLong>(retval));

}

JS_DEFINE_NATIVE_FUNCTION(HTMLVideoElementPrototype::video_height_getter)
{
    WebIDL::log_trace(vm, "HTMLVideoElementPrototype::video_height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->video_height(); }));
...
{
    WebIDL::log_trace(vm, "HTMLVideoElementPrototype::poster_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto content_attribute_value = impl->attribute("poster"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLVideoElementPrototype::poster_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("poster"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLVideoElementPrototype::plays_inline_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval = impl->has_attribute("playsinline"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLVideoElementPrototype::plays_inline_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value)
        impl->remove_attribute("playsinline"_fly_string);
    else
        impl->set_attribute_value("playsinline"_fly_string, String {});
