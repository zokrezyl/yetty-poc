...
GC_DEFINE_ALLOCATOR(HTMLTableCellElementPrototype);

HTMLTableCellElementPrototype::HTMLTableCellElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLTableCellElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_col_span_getter = JS::NativeFunction::create(realm, col_span_getter, 0, "colSpan"_utf16_fly_string, &realm, "get"sv);

    auto native_col_span_setter = JS::NativeFunction::create(realm, col_span_setter, 1, "colSpan"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("colSpan"_utf16_fly_string, native_col_span_getter, native_col_span_setter, default_attributes);

    auto native_row_span_getter = JS::NativeFunction::create(realm, row_span_getter, 0, "rowSpan"_utf16_fly_string, &realm, "get"sv);

    auto native_row_span_setter = JS::NativeFunction::create(realm, row_span_setter, 1, "rowSpan"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("rowSpan"_utf16_fly_string, native_row_span_getter, native_row_span_setter, default_attributes);

    auto native_headers_getter = JS::NativeFunction::create(realm, headers_getter, 0, "headers"_utf16_fly_string, &realm, "get"sv);

    auto native_headers_setter = JS::NativeFunction::create(realm, headers_setter, 1, "headers"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("headers"_utf16_fly_string, native_headers_getter, native_headers_setter, default_attributes);

    auto native_cell_index_getter = JS::NativeFunction::create(realm, cell_index_getter, 0, "cellIndex"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_cell_index_setter;

    define_direct_accessor("cellIndex"_utf16_fly_string, native_cell_index_getter, native_cell_index_setter, default_attributes);

    auto native_scope_getter = JS::NativeFunction::create(realm, scope_getter, 0, "scope"_utf16_fly_string, &realm, "get"sv);

    auto native_scope_setter = JS::NativeFunction::create(realm, scope_setter, 1, "scope"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("scope"_utf16_fly_string, native_scope_getter, native_scope_setter, default_attributes);

    auto native_abbr_getter = JS::NativeFunction::create(realm, abbr_getter, 0, "abbr"_utf16_fly_string, &realm, "get"sv);

    auto native_abbr_setter = JS::NativeFunction::create(realm, abbr_setter, 1, "abbr"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("abbr"_utf16_fly_string, native_abbr_getter, native_abbr_setter, default_attributes);
    ...
    auto native_axis_getter = JS::NativeFunction::create(realm, axis_getter, 0, "axis"_utf16_fly_string, &realm, "get"sv);

    auto native_axis_setter = JS::NativeFunction::create(realm, axis_setter, 1, "axis"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("axis"_utf16_fly_string, native_axis_getter, native_axis_setter, default_attributes);
    ...
    auto native_ch_getter = JS::NativeFunction::create(realm, ch_getter, 0, "ch"_utf16_fly_string, &realm, "get"sv);

    auto native_ch_setter = JS::NativeFunction::create(realm, ch_setter, 1, "ch"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("ch"_utf16_fly_string, native_ch_getter, native_ch_setter, default_attributes);

    auto native_ch_off_getter = JS::NativeFunction::create(realm, ch_off_getter, 0, "chOff"_utf16_fly_string, &realm, "get"sv);

    auto native_ch_off_setter = JS::NativeFunction::create(realm, ch_off_setter, 1, "chOff"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("chOff"_utf16_fly_string, native_ch_off_getter, native_ch_off_setter, default_attributes);

    auto native_no_wrap_getter = JS::NativeFunction::create(realm, no_wrap_getter, 0, "noWrap"_utf16_fly_string, &realm, "get"sv);

    auto native_no_wrap_setter = JS::NativeFunction::create(realm, no_wrap_setter, 1, "noWrap"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("noWrap"_utf16_fly_string, native_no_wrap_getter, native_no_wrap_setter, default_attributes);

    auto native_v_align_getter = JS::NativeFunction::create(realm, v_align_getter, 0, "vAlign"_utf16_fly_string, &realm, "get"sv);

    auto native_v_align_setter = JS::NativeFunction::create(realm, v_align_setter, 1, "vAlign"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("vAlign"_utf16_fly_string, native_v_align_getter, native_v_align_setter, default_attributes);
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLTableCellElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLTableCellElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLTableCellElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLTableCellElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLTableCellElement");
    return static_cast<HTML::HTMLTableCellElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLTableCellElementPrototype::col_span_getter)
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::col_span_getter");
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->col_span(); });
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::col_span_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_col_span(cpp_value); });
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::row_span_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->row_span(); });
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::row_span_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_row_span(cpp_value); });
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::headers_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("headers"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::headers_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("headers"_fly_string, cpp_value);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableCellElementPrototype::cell_index_getter)
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::cell_index_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->cell_index(); }));

    return JS::Value(static_cast<WebIDL::Long>(retval));

}

JS_DEFINE_NATIVE_FUNCTION(HTMLTableCellElementPrototype::scope_getter)
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::scope_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("scope"_fly_string);
    ...
    Array valid_values { "row"_string, "col"_string, "rowgroup"_string, "colgroup"_string };
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTableCellElementPrototype::scope_setter)
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::scope_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("scope"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::abbr_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("abbr"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::abbr_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("abbr"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::align_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::axis_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("axis"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::axis_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("axis"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::height_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::height_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::width_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::width_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::ch_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("char"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::ch_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("char"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::ch_off_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("charoff"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::ch_off_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("charoff"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::no_wrap_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval = impl->has_attribute("nowrap"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::no_wrap_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value)
        impl->remove_attribute("nowrap"_fly_string);
    else
        impl->set_attribute_value("nowrap"_fly_string, String {});
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::v_align_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("valign"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::v_align_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("valign"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::bg_color_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTableCellElementPrototype::bg_color_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
