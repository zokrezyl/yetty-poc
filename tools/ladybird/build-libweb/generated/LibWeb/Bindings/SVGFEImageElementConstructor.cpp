...
GC_DEFINE_ALLOCATOR(SVGFEImageElementConstructor);

SVGFEImageElementConstructor::SVGFEImageElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGFEImageElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGFEImageElementConstructor::~SVGFEImageElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGFEImageElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGFEImageElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGFEImageElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGFEImageElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGFEImageElement");
}


void SVGFEImageElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGFEImageElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGFEImageElementPrototype>(realm, "SVGFEImageElement"_fly_string), 0);
