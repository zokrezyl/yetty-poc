...
GC_DEFINE_ALLOCATOR(CSSMathValuePrototype);

CSSMathValuePrototype::CSSMathValuePrototype([[maybe_unused]] JS::Realm& realm)
    : Object(realm, nullptr)

{
}

CSSMathValuePrototype::~CSSMathValuePrototype()
{
}

void CSSMathValuePrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "CSSMathValue"_string), JS::Attribute::Configurable);
...
[[maybe_unused]] static JS::ThrowCompletionOr<CSS::CSSMathValue*> impl_from(JS::VM& vm)
{
    ...
    if (!is<CSS::CSSMathValue>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "CSSMathValue");
    return static_cast<CSS::CSSMathValue*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(CSSMathValuePrototype::operator_getter)
{
    WebIDL::log_trace(vm, "CSSMathValuePrototype::operator_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->operator_(); }));
