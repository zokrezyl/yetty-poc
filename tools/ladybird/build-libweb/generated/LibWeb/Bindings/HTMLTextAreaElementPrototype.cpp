...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLTextAreaElement.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLElement.h>

#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLFormElement.h>
...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/HTMLFormControlsCollection.h>
...
#include </home/misi/work/my/yetty/tmp/ladybird/Libraries/LibWeb/HTML/RadioNodeList.h>
...
GC_DEFINE_ALLOCATOR(HTMLTextAreaElementPrototype);

HTMLTextAreaElementPrototype::HTMLTextAreaElementPrototype([[maybe_unused]] JS::Realm& realm)
...
void HTMLTextAreaElementPrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_autocomplete_getter = JS::NativeFunction::create(realm, autocomplete_getter, 0, "autocomplete"_utf16_fly_string, &realm, "get"sv);

    auto native_autocomplete_setter = JS::NativeFunction::create(realm, autocomplete_setter, 1, "autocomplete"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("autocomplete"_utf16_fly_string, native_autocomplete_getter, native_autocomplete_setter, default_attributes);

    auto native_cols_getter = JS::NativeFunction::create(realm, cols_getter, 0, "cols"_utf16_fly_string, &realm, "get"sv);

    auto native_cols_setter = JS::NativeFunction::create(realm, cols_setter, 1, "cols"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("cols"_utf16_fly_string, native_cols_getter, native_cols_setter, default_attributes);

    auto native_dir_name_getter = JS::NativeFunction::create(realm, dir_name_getter, 0, "dirName"_utf16_fly_string, &realm, "get"sv);

    auto native_dir_name_setter = JS::NativeFunction::create(realm, dir_name_setter, 1, "dirName"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("dirName"_utf16_fly_string, native_dir_name_getter, native_dir_name_setter, default_attributes);
    ...
    auto native_max_length_getter = JS::NativeFunction::create(realm, max_length_getter, 0, "maxLength"_utf16_fly_string, &realm, "get"sv);

    auto native_max_length_setter = JS::NativeFunction::create(realm, max_length_setter, 1, "maxLength"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("maxLength"_utf16_fly_string, native_max_length_getter, native_max_length_setter, default_attributes);

    auto native_min_length_getter = JS::NativeFunction::create(realm, min_length_getter, 0, "minLength"_utf16_fly_string, &realm, "get"sv);

    auto native_min_length_setter = JS::NativeFunction::create(realm, min_length_setter, 1, "minLength"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("minLength"_utf16_fly_string, native_min_length_getter, native_min_length_setter, default_attributes);
    ...
    auto native_placeholder_getter = JS::NativeFunction::create(realm, placeholder_getter, 0, "placeholder"_utf16_fly_string, &realm, "get"sv);

    auto native_placeholder_setter = JS::NativeFunction::create(realm, placeholder_setter, 1, "placeholder"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("placeholder"_utf16_fly_string, native_placeholder_getter, native_placeholder_setter, default_attributes);

    auto native_read_only_getter = JS::NativeFunction::create(realm, read_only_getter, 0, "readOnly"_utf16_fly_string, &realm, "get"sv);

    auto native_read_only_setter = JS::NativeFunction::create(realm, read_only_setter, 1, "readOnly"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("readOnly"_utf16_fly_string, native_read_only_getter, native_read_only_setter, default_attributes);

    auto native_required_getter = JS::NativeFunction::create(realm, required_getter, 0, "required"_utf16_fly_string, &realm, "get"sv);

    auto native_required_setter = JS::NativeFunction::create(realm, required_setter, 1, "required"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("required"_utf16_fly_string, native_required_getter, native_required_setter, default_attributes);

    auto native_rows_getter = JS::NativeFunction::create(realm, rows_getter, 0, "rows"_utf16_fly_string, &realm, "get"sv);

    auto native_rows_setter = JS::NativeFunction::create(realm, rows_setter, 1, "rows"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("rows"_utf16_fly_string, native_rows_getter, native_rows_setter, default_attributes);

    auto native_wrap_getter = JS::NativeFunction::create(realm, wrap_getter, 0, "wrap"_utf16_fly_string, &realm, "get"sv);

    auto native_wrap_setter = JS::NativeFunction::create(realm, wrap_setter, 1, "wrap"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("wrap"_utf16_fly_string, native_wrap_getter, native_wrap_setter, default_attributes);
    ...
    auto native_default_value_setter = JS::NativeFunction::create(realm, default_value_setter, 1, "defaultValue"_utf16_fly_string, &realm, "set"sv);
    ...
    auto native_text_length_getter = JS::NativeFunction::create(realm, text_length_getter, 0, "textLength"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_text_length_setter;

    define_direct_accessor("textLength"_utf16_fly_string, native_text_length_getter, native_text_length_setter, default_attributes);
    ...
    auto native_selection_start_getter = JS::NativeFunction::create(realm, selection_start_getter, 0, "selectionStart"_utf16_fly_string, &realm, "get"sv);

    auto native_selection_start_setter = JS::NativeFunction::create(realm, selection_start_setter, 1, "selectionStart"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("selectionStart"_utf16_fly_string, native_selection_start_getter, native_selection_start_setter, default_attributes);

    auto native_selection_end_getter = JS::NativeFunction::create(realm, selection_end_getter, 0, "selectionEnd"_utf16_fly_string, &realm, "get"sv);

    auto native_selection_end_setter = JS::NativeFunction::create(realm, selection_end_setter, 1, "selectionEnd"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("selectionEnd"_utf16_fly_string, native_selection_end_getter, native_selection_end_setter, default_attributes);

    auto native_selection_direction_getter = JS::NativeFunction::create(realm, selection_direction_getter, 0, "selectionDirection"_utf16_fly_string, &realm, "get"sv);

    auto native_selection_direction_setter = JS::NativeFunction::create(realm, selection_direction_setter, 1, "selectionDirection"_utf16_fly_string, &realm, "set"sv);

    define_direct_accessor("selectionDirection"_utf16_fly_string, native_selection_direction_getter, native_selection_direction_setter, default_attributes);
    ...
    define_native_function(realm, "setCustomValidity"_utf16_fly_string, set_custom_validity, 1, default_attributes);

    define_native_function(realm, "select"_utf16_fly_string, select, 0, default_attributes);

    define_native_function(realm, "setRangeText"_utf16_fly_string, set_range_text, 1, default_attributes);

    define_native_function(realm, "setSelectionRange"_utf16_fly_string, set_selection_range, 2, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "HTMLTextAreaElement"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void HTMLTextAreaElementPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::HTMLTextAreaElement*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::HTMLTextAreaElement>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "HTMLTextAreaElement");
    return static_cast<HTML::HTMLTextAreaElement*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::autocomplete_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::autocomplete_getter");
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->autocomplete(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::autocomplete_setter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::autocomplete_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_autocomplete(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::cols_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::cols_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->cols(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::cols_setter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::cols_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_cols(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::dir_name_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::dir_name_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("dirname"_fly_string);
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::dir_name_setter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::dir_name_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("dirname"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::disabled_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::disabled_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::form_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::form_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::max_length_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::max_length_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->max_length(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::max_length_setter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::max_length_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_max_length(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::min_length_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::min_length_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->min_length(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::min_length_setter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::min_length_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_min_length(cpp_value); });
...
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::name_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::name_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::placeholder_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("placeholder"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::placeholder_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("placeholder"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::read_only_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval = impl->has_attribute("readonly"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::read_only_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value)
        impl->remove_attribute("readonly"_fly_string);
    else
        impl->set_attribute_value("readonly"_fly_string, String {});
...
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::required_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval = impl->has_attribute("required"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::required_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!cpp_value)
        impl->remove_attribute("required"_fly_string);
    else
        impl->set_attribute_value("required"_fly_string, String {});
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::rows_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::rows_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->rows(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::rows_setter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::rows_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_rows(cpp_value); });
...
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::wrap_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto contentAttributeValue = impl->attribute("wrap"_fly_string);
...
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::wrap_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    impl->set_attribute_value("wrap"_fly_string, cpp_value);
...
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::type_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::default_value_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::default_value_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto retval_or_exception = throw_dom_exception_if_needed(vm, [&] { return impl->default_value(); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::default_value_setter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::default_value_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    auto maybe_exception = throw_dom_exception_if_needed(vm, [&] { return impl->set_default_value(cpp_value); });
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::value_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::value_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::value_setter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::value_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::text_length_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::text_length_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->text_length(); }));

    return JS::Value(static_cast<WebIDL::UnsignedLong>(retval));

}

JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::will_validate_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::will_validate_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::validity_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::validity_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::validation_message_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::validation_message_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::labels_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::labels_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::selection_start_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::selection_start_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->selection_start_binding(); }));

    return JS::Value(static_cast<WebIDL::UnsignedLong>(retval));

}

JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::selection_start_setter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::selection_start_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_selection_start_binding(cpp_value); }));

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::selection_end_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::selection_end_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->selection_end_binding(); }));

    return JS::Value(static_cast<WebIDL::UnsignedLong>(retval));

}

JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::selection_end_setter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::selection_end_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_selection_end_binding(cpp_value); }));

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::selection_direction_getter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::selection_direction_getter");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    [[maybe_unused]] auto* impl = TRY(impl_from(vm));

    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->selection_direction_binding(); }));

    return JS::PrimitiveString::create(vm, retval);

}

JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::selection_direction_setter)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::selection_direction_setter");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_selection_direction_binding(cpp_value); }));

    return JS::js_undefined();
}

JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::check_validity)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::check_validity");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::report_validity)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::report_validity");
    [[maybe_unused]] auto& realm = *vm.current_realm();
...
JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::set_custom_validity)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::set_custom_validity");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!false || !arg0.is_null()) {
        error = TRY(WebIDL::to_string(vm, arg0));
    }

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_custom_validity(error); }));

    return JS::js_undefined();

}

JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::select)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::select");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    auto* impl = TRY(impl_from(vm));

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->select(); }));

    return JS::js_undefined();

}

JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::set_range_text0)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::set_range_text0");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    if (!false || !arg0.is_null()) {
        replacement = TRY(WebIDL::to_utf16_string(vm, arg0));
    }

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_range_text_binding(replacement); }));

    return JS::js_undefined();

}

JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::set_range_text1)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::set_range_text1");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    SelectionMode selection_mode { SelectionMode::Preserve };

    if (!arg3.is_undefined()) {

    auto arg3_string = TRY(arg3.to_string(vm));

    if (arg3_string == "select"sv)
        selection_mode = SelectionMode::Select;

    else if (arg3_string == "start"sv)
        selection_mode = SelectionMode::Start;

    else if (arg3_string == "end"sv)
        selection_mode = SelectionMode::End;

    else if (arg3_string == "preserve"sv)
        selection_mode = SelectionMode::Preserve;

    else
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::InvalidEnumerationValue, arg3_string, "SelectionMode");

    }

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_range_text_binding(replacement, start, end, selection_mode); }));

    return JS::js_undefined();

}

JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::set_selection_range)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::set_selection_range");
    [[maybe_unused]] auto& realm = *vm.current_realm();

    auto* impl = TRY(impl_from(vm));

    if (vm.argument_count() < 2)
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::BadArgCountMany, "setSelectionRange", "2");

    auto arg0 = vm.argument(0);

    WebIDL::UnsignedLong start;

    start = TRY(WebIDL::convert_to_int<WebIDL::UnsignedLong>(vm, arg0, WebIDL::EnforceRange::No, WebIDL::Clamp::No));

    auto arg1 = vm.argument(1);

    WebIDL::UnsignedLong end;

    end = TRY(WebIDL::convert_to_int<WebIDL::UnsignedLong>(vm, arg1, WebIDL::EnforceRange::No, WebIDL::Clamp::No));
    ...
    if (!arg2.is_undefined()) {
        if (!false || !arg2.is_null())
            direction = TRY(WebIDL::to_string(vm, arg2));
    }

    [[maybe_unused]] auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->set_selection_range(start, end, direction); }));

    return JS::js_undefined();

}

JS_DEFINE_NATIVE_FUNCTION(HTMLTextAreaElementPrototype::set_range_text)
{
    WebIDL::log_trace(vm, "HTMLTextAreaElementPrototype::set_range_text");
    ...
    case 0:
        ...
        return set_range_text0(vm);

    case 1:

        return set_range_text1(vm);
