...
GC_DEFINE_ALLOCATOR(MimeTypeArrayPrototype);

MimeTypeArrayPrototype::MimeTypeArrayPrototype([[maybe_unused]] JS::Realm& realm)
    : Object(ConstructWithPrototypeTag::Tag, realm.intrinsics().object_prototype())

{
}

MimeTypeArrayPrototype::~MimeTypeArrayPrototype()
{
}

void MimeTypeArrayPrototype::initialize(JS::Realm& realm)
{
    ...
    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "MimeTypeArray"_string), JS::Attribute::Configurable);

    Base::initialize(realm);

}

void MimeTypeArrayPrototype::define_unforgeable_attributes(JS::Realm& realm, [[maybe_unused]] JS::Object& object)
{
...
[[maybe_unused]] static JS::ThrowCompletionOr<HTML::MimeTypeArray*> impl_from(JS::VM& vm)
{
    ...
    if (!is<HTML::MimeTypeArray>(this_object))
        return vm.throw_completion<JS::TypeError>(JS::ErrorType::NotAnObjectOfType, "MimeTypeArray");
    return static_cast<HTML::MimeTypeArray*>(this_object);
}

JS_DEFINE_NATIVE_FUNCTION(MimeTypeArrayPrototype::length_getter)
{
    WebIDL::log_trace(vm, "MimeTypeArrayPrototype::length_getter");
...
JS_DEFINE_NATIVE_FUNCTION(MimeTypeArrayPrototype::item)
{
    WebIDL::log_trace(vm, "MimeTypeArrayPrototype::item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
    ...
    return &const_cast<MimeType&>(*retval);
...
JS_DEFINE_NATIVE_FUNCTION(MimeTypeArrayPrototype::named_item)
{
    WebIDL::log_trace(vm, "MimeTypeArrayPrototype::named_item");
    [[maybe_unused]] auto& realm = *vm.current_realm();
