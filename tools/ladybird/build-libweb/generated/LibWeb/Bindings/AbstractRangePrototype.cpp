...
GC_DEFINE_ALLOCATOR(AbstractRangePrototype);

AbstractRangePrototype::AbstractRangePrototype([[maybe_unused]] JS::Realm& realm)
...
void AbstractRangePrototype::initialize(JS::Realm& realm)
{
    ...
    auto native_start_container_getter = JS::NativeFunction::create(realm, start_container_getter, 0, "startContainer"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_start_container_setter;

    define_direct_accessor("startContainer"_utf16_fly_string, native_start_container_getter, native_start_container_setter, default_attributes);

    auto native_start_offset_getter = JS::NativeFunction::create(realm, start_offset_getter, 0, "startOffset"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_start_offset_setter;

    define_direct_accessor("startOffset"_utf16_fly_string, native_start_offset_getter, native_start_offset_setter, default_attributes);

    auto native_end_container_getter = JS::NativeFunction::create(realm, end_container_getter, 0, "endContainer"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_end_container_setter;

    define_direct_accessor("endContainer"_utf16_fly_string, native_end_container_getter, native_end_container_setter, default_attributes);

    auto native_end_offset_getter = JS::NativeFunction::create(realm, end_offset_getter, 0, "endOffset"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_end_offset_setter;

    define_direct_accessor("endOffset"_utf16_fly_string, native_end_offset_getter, native_end_offset_setter, default_attributes);

    auto native_collapsed_getter = JS::NativeFunction::create(realm, collapsed_getter, 0, "collapsed"_utf16_fly_string, &realm, "get"sv);

    GC::Ptr<JS::NativeFunction> native_collapsed_setter;

    define_direct_accessor("collapsed"_utf16_fly_string, native_collapsed_getter, native_collapsed_setter, default_attributes);

    define_direct_property(vm.well_known_symbol_to_string_tag(), JS::PrimitiveString::create(vm, "AbstractRange"_string), JS::Attribute::Configurable);
...
JS_DEFINE_NATIVE_FUNCTION(AbstractRangePrototype::start_container_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->start_container(); }));
...
JS_DEFINE_NATIVE_FUNCTION(AbstractRangePrototype::start_offset_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->start_offset(); }));
...
JS_DEFINE_NATIVE_FUNCTION(AbstractRangePrototype::end_container_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->end_container(); }));
...
JS_DEFINE_NATIVE_FUNCTION(AbstractRangePrototype::end_offset_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->end_offset(); }));
...
JS_DEFINE_NATIVE_FUNCTION(AbstractRangePrototype::collapsed_getter)
{
    ...
    auto retval = TRY(throw_dom_exception_if_needed(vm, [&] { return impl->collapsed(); }));
