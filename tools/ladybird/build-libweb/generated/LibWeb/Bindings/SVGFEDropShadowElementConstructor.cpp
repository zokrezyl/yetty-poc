...
GC_DEFINE_ALLOCATOR(SVGFEDropShadowElementConstructor);

SVGFEDropShadowElementConstructor::SVGFEDropShadowElementConstructor(JS::Realm& realm)
    : NativeFunction("SVGFEDropShadowElement"_utf16_fly_string, realm.intrinsics().function_prototype())
{
}

SVGFEDropShadowElementConstructor::~SVGFEDropShadowElementConstructor()
{
}

JS::ThrowCompletionOr<JS::Value> SVGFEDropShadowElementConstructor::call()
{
    return vm().throw_completion<JS::TypeError>(JS::ErrorType::ConstructorWithoutNew, "SVGFEDropShadowElement");
}


JS::ThrowCompletionOr<GC::Ref<JS::Object>> SVGFEDropShadowElementConstructor::construct([[maybe_unused]] FunctionObject& new_target)
{
    WebIDL::log_trace(vm(), "SVGFEDropShadowElementConstructor::construct");

    return vm().throw_completion<JS::TypeError>(JS::ErrorType::NotAConstructor, "SVGFEDropShadowElement");
}


void SVGFEDropShadowElementConstructor::initialize(JS::Realm& realm)
{
    auto& vm = this->vm();
    ...
    define_direct_property(vm.names.name, JS::PrimitiveString::create(vm, "SVGFEDropShadowElement"_string), JS::Attribute::Configurable);
    define_direct_property(vm.names.prototype, &ensure_web_prototype<SVGFEDropShadowElementPrototype>(realm, "SVGFEDropShadowElement"_fly_string), 0);
