#!/bin/bash
# Scrolling YDraw Overlay Demo: Text at pixel coordinates
...
# Text overlay demo for scrolling ydraw overlay
background: "#00000000"
...
body:
  ...
  - text:
      position: [50, 50]
      content: "Scrolling YDraw Overlay"
      font-size: 32
      color: "#3498db"
...
echo "Screen draw layer: text demo sent"
