...
# Uses the card system to create a YDraw card with many shapes
#
...
python3 tools/yetty-client/main.py create ydraw -f demo/assets/cards/ydraw/big.yaml -w 80 -H 25
