...
/**
 * GpuTextureManager manages the texture atlas for cards.
 *
 * Protocol:
 ...
 *   4. GpuMemoryManager calls uploadAtlas(queue) during flush to upload to GPU
 */
class GpuTextureManager {
public:
    using Config = GpuTextureConfig;
    using Ptr = std::shared_ptr<GpuTextureManager>;
    ...
    // Upload dirty atlas regions to GPU. Called by GpuMemoryManager::flush().
