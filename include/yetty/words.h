...
// Word lists from Docker/Moby project (Apache 2.0 License)
...
inline constexpr std::array<std::string_view, 108> kAdjectives = {{
...
// Notable scientists and hackers for name generation
inline constexpr std::array<std::string_view, 237> kNames = {{
    ...
    "keldysh", "keller", "kepler", "kilby", "kirch",
