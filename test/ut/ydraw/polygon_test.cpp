...
// Polygon Unit Tests
//
// Tests polygon primitives in YDrawBuffer and YDrawBuilder:
...
//=============================================================================
// Test Suite: YDrawBuffer polygon operations
//=============================================================================
...
//=============================================================================
// Test Suite: YDrawBuilder polygon grid placement
//=============================================================================
...
suite polygon_builder_tests = [] {
    ...
    "polygon_grid_placement_simple"_test = [] {
        ...
        auto builder = *YDrawBuilder::create(FontManager::Ptr{}, gpuAlloc, false);  // non-scrolling
    ...
    "polygon_grid_placement_scrolling_mode"_test = [] {
        auto gpuAlloc = testAllocator();
        auto builder = *YDrawBuilder::create(FontManager::Ptr{}, gpuAlloc, true);  // scrolling mode
    ...
    "multiple_polygons_different_positions"_test = [] {
        auto gpuAlloc = testAllocator();
        auto builder = *YDrawBuilder::create(FontManager::Ptr{}, gpuAlloc, false);
...
suite all_primitives_grid_tests = [] {
    ...
    "all_primitives_scrolling_mode"_test = [] {
        auto gpuAlloc = testAllocator();
        auto builder = *YDrawBuilder::create(FontManager::Ptr{}, gpuAlloc, true);  // scrolling
